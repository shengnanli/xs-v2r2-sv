// 自动生成: golden 同名 wrapper(FM impl 侧), 例化 xs_VTypeBuffer_core。
// 端口逐字取自 golden VTypeBuffer, 直连可读核。子模块(SyncDataModule/SnapshotGenerator_1/_2)
// 在核内按名例化, FM 两侧同名 → 对称黑盒 depends_on。
module VTypeBuffer(
  input        clock,
  input        reset,
