// =============================================================================
//  TLBuffer_22 —— TileLink A/D 两通道时序缓冲 (可读重写核 xs_TLBuffer_22_core)
// -----------------------------------------------------------------------------
...
//  本变体特征: 窄总线缓冲: source 3 位、size 2 位、address 48 位、data 64 位, A 带 user_memBackType_MM / user_memPageType_NC 两个 1 位标志 (MM 在前)。
// =============================================================================
module xs_TLBuffer_22_core
  import tlbuffer22_pkg::*;
(
  input clock,
  input reset,
  ...
  always_comb begin
    client_a = '{opcode: auto_in_a_bits_opcode, param: auto_in_a_bits_param,
        ...
        address: auto_in_a_bits_address, user_memBackType_MM: auto_in_a_bits_user_memBackType_MM,
        user_memPageType_NC: auto_in_a_bits_user_memPageType_NC, mask: auto_in_a_bits_mask,
  ...
  Queue2_TLBundleA_31 nodeOut_a_q (
    ...
    .io_enq_bits_user_memBackType_MM (client_a.user_memBackType_MM),
    .io_enq_bits_user_memPageType_NC (client_a.user_memPageType_NC),
