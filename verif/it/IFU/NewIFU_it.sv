// ===========================================================================
// IFU 簇 IT 顶层装配：NewIFU_it
//   顶层端口 = golden NewIFU 顶层端口（逐字相同，527 口），便于 tb 双例化逐拍比对。
//   内部例化 NewIFU_xs（verif/ut/NewIFU/variants_xs.sv 的重写适配器），
//   其包裹 rtl/frontend/NewIFU.sv 的 xs_NewIFU_core（重写 glue）。
//   xs_NewIFU_core 按名例化 xs_newifu_* 子适配器；IT 编译时这些来自
//   本目录 NewIFU_subs_it.sv（重写叶子版：RVCExpander/PreDecode/F3Predecoder 用重写核，
//   PredChecker/FrontendTrigger 工程无重写核保留 golden）。
// ===========================================================================
module NewIFU_it(
  input  clock,
  input  reset,
