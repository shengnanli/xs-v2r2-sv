...
module FpRegFilePart0_xs(
  ...
  wire [5:0] wr_wen = {io_writePorts_5_wen, io_writePorts_4_wen, io_writePorts_3_wen, io_writePorts_2_wen, io_writePorts_1_wen, io_writePorts_0_wen};
  wire [5:0][7:0] wr_addr = {io_writePorts_5_addr, io_writePorts_4_addr, io_writePorts_3_addr, io_writePorts_2_addr, io_writePorts_1_addr, io_writePorts_0_addr};
  wire [5:0][15:0] wr_data = {io_writePorts_5_data, io_writePorts_4_data, io_writePorts_3_data, io_writePorts_2_data, io_writePorts_1_data, io_writePorts_0_data};
  ...
  xs_RegFilePart_core #(
    .NUM_PREGS(192), .NUM_READ(11), .NUM_WRITE(6),
