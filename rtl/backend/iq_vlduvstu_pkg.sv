// =============================================================================
// iq_vlduvstu_pkg —— 香山 V2R2(昆明湖) 发射队列 VlduVstu 变体 公共类型/参数
// -----------------------------------------------------------------------------
...
// golden 对照:IssueQueueVlduVstu.sv / EntriesVlduVstu.sv
//             叶子:EnqEntryVecMem_2.sv(入队) / OthersEntryVecMem_14.sv(simp, 转移源)
//                  / OthersEntryVecMem_16.sv(comp, 终端)
//
// ★★ 这是「向量 load/store」发射队列 —— 向量调度 + 访存反馈的融合变体 ★★
// 它把两套样板的机制揉到一起:
...
// (V4) fuType one-hot 位:VLDU=31 / VSTU=32(VfDiv 是 22/26)。
