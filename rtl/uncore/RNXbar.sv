...
(
  ...
  for (genvar j = 0; j < NUM_HN; j++) begin : g_txreq
    FastArbiter_30 txreqArbs (
      ...
      .io_out_bits_qos (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_tgtID (txreq_arb_out[j].tgtID),
      .io_out_bits_srcID (txreq_arb_out[j].srcID),
      .io_out_bits_txnID (txreq_arb_out[j].txnID),
      .io_out_bits_returnNID (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_stashNIDValid (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_returnTxnID (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_opcode (txreq_arb_out[j].opcode),
      .io_out_bits_size (txreq_arb_out[j].size),
      .io_out_bits_addr (txreq_arb_out[j].addr),
      .io_out_bits_ns (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_likelyshared (/* unused: golden 未连, 无下游扇出 */),
      ...
      .io_out_bits_lpIDWithPadding (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_snoopMe (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_expCompAck (txreq_arb_out[j].expCompAck),
      .io_out_bits_tagOp (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_traceTag (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_mpam_perfMonGroup (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_mpam_partID (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_mpam_mpamNS (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_rsvdc (/* unused: golden 未连, 无下游扇出 */)
    );
  end
  ...
  for (genvar j = 0; j < NUM_HN; j++) begin : g_txdat
    FastArbiter_31 txdatArbs (
      ...
      .io_out_bits_qos (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_tgtID (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_srcID (txdat_arb_out[j].srcID),
      .io_out_bits_txnID (txdat_arb_out[j].txnID),
      .io_out_bits_homeNID (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_opcode (txdat_arb_out[j].opcode),
      .io_out_bits_respErr (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_resp (txdat_arb_out[j].resp),
      .io_out_bits_dataSource (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_cBusy (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_dbID (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_ccID (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_dataID (txdat_arb_out[j].dataID),
      .io_out_bits_tagOp (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_tag (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_tu (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_traceTag (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_rsvdc (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_be (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_data (txdat_arb_out[j].data),
      .io_out_bits_dataCheck (/* unused: golden 未连, 无下游扇出 */),
      .io_out_bits_poison (/* unused: golden 未连, 无下游扇出 */)
    );
  end
  // ===========================================================================
