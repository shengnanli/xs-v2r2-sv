// NewCSR hedeleg AUX wrapper (HedelegModule). Thin wrapper over the readable
// bespoke core xs_hedeleg (rtl/backend/newcsr_hedeleg.sv). FM-verified strict,
// no black box. Kunminghu V2R2 is hypervisor-capable so hedeleg is in scope.
