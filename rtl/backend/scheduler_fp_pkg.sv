...
// =============================================================================
// scheduler_fp_pkg —— 香山 V2R2 Fp Scheduler 可读重写 类型/参数包
// 设计源:src/main/scala/xiangshan/backend/issue/Scheduler.scala
//        golden:Scheduler_1.sv
// =============================================================================
package scheduler_fp_pkg;

  // ---- 维度参数(本 Fp SchdBlock 的实例化结果)----
  ...
  typedef enum logic [1:0] {
    IQ_FALU_FCVT_F2V_FMAC_FDIV = 2'd0,  // 综合 FP IQ (enq 0/1, perf full bit0)
    IQ_FALU_FMAC_FDIV    = 2'd1,  // FALU/FMAC/FDIV IQ (enq 2/3, perf full bit1)
    IQ_FALU_FMAC         = 2'd2  // FALU/FMAC IQ (enq 4/5, perf full bit2)
  } iq_id_e;
