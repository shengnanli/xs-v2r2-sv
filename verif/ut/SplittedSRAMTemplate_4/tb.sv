// SplittedSRAMTemplate_4 UT：golden vs _xs 双例化随机比对。
// 单 SRAMTemplate_45(bp_tage, 512×2×12b) 直通；struct{valid,tag[7:0],ctr[2:0]}。
`timescale 1ns/1ps
module tb;
  ...
  SplittedSRAMTemplate_4    u_g (`PORTS(g_ready,g_d0v,g_d0t,g_d0c,g_d1v,g_d1t,g_d1c,g_brd));
  SplittedSRAMTemplate_4_xs u_i (`PORTS(i_ready,i_d0v,i_d0t,i_d0c,i_d1v,i_d1t,i_d1c,i_brd));
