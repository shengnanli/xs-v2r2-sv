...
module DataModule_BackendPC_16entry_xs(
  input  clock,
...
module DataModule_FtqPC_16entry_xs(
  input  clock,
  input  [3:0] io_raddr_0,
  input  [3:0] io_raddr_1,
  input  [3:0] io_raddr_2,
...
module DataModule__64entry_16_xs(
  input  clock,
  input  [5:0] io_raddr_0,
  input  [5:0] io_raddr_1,
...
module DataModule__16entry_4_xs(
  input  clock,
  input  [3:0] io_raddr_0,
  input  [3:0] io_raddr_1,
...
module DataModule__16entry_8_xs(
  input  clock,
  input  [3:0] io_raddr_0,
  input  [3:0] io_raddr_1,
...
module DataModule__16entry_12_xs(
  input  clock,
  input  [3:0] io_raddr_0,
  input  [3:0] io_raddr_1,
  input  [3:0] io_raddr_2,
...
module DataModule__16entry_16_xs(
  input  clock,
  input  [3:0] io_raddr_0,
...
module SyncDataModuleTemplate_BackendPC_64entry_xs(
  input  clock,
  input  reset,
  input  io_ren_0,
  input  io_ren_1,
  ...
  xs_SyncDataModule #(
    ...
    .clock(clock),
    .reset(reset),
    .io_ren({io_ren_14, io_ren_13, io_ren_12, io_ren_11, io_ren_10, io_ren_9, io_ren_8, io_ren_7, io_ren_6, io_ren_5, io_ren_4, io_ren_3, io_ren_2, io_ren_1, io_ren_0}),
    .io_raddr({io_raddr_14, io_raddr_13, io_raddr_12, io_raddr_11, io_raddr_10, io_raddr_9, io_raddr_8, io_raddr_7, io_raddr_6, io_raddr_5, io_raddr_4, io_raddr_3, io_raddr_2, io_raddr_1, io_raddr_0}),
    .io_rdata(rdata_bus),
    .io_wen({io_wen_0}),
    .io_waddr({io_waddr_0}),
...
module SyncDataModuleTemplate_FtqPC_64entry_xs(
  input  clock,
  input  reset,
  input  [5:0] io_raddr_0,
  input  [5:0] io_raddr_1,
...
module SyncDataModuleTemplate__1024entry_xs(
  input  clock,
  input  reset,
  input  io_ren_0,
  input  io_ren_1,
...
module SyncDataModuleTemplate__1024entry_1_xs(
  input  clock,
  input  reset,
  input  io_ren_0,
  input  io_ren_1,
...
module SyncDataModuleTemplate__64entry_xs(
  input  clock,
  input  reset,
  input  io_ren_0,
  input  io_ren_1,
  ...
  xs_SyncDataModule #(
    ...
    .clock(clock),
    .reset(reset),
    .io_ren({io_ren_2, io_ren_1, io_ren_0}),
    .io_raddr({io_raddr_2, io_raddr_1, io_raddr_0}),
    .io_rdata(rdata_bus),
    .io_wen({io_wen_0}),
    .io_waddr({io_waddr_0}),
...
module SyncDataModuleTemplate__64entry_1_xs(
  input  clock,
  input  reset,
  input  io_ren_0,
  input  io_ren_1,
...
module SyncDataModuleTemplate__64entry_2_xs(
  input  clock,
  input  reset,
  input  io_ren_0,
  input  io_ren_1,
...
module SyncDataModuleTemplate__64entry_3_xs(
  input  clock,
  input  reset,
  input  [5:0] io_raddr_0,
  input  [5:0] io_raddr_1,
...
module SyncDataModuleTemplate__64entry_4_xs(
  input  clock,
  input  reset,
  input  io_ren_0,
  input  [5:0] io_raddr_0,
