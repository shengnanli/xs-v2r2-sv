...
module tb;
  ...
  logic [49:0] g_io_out_0_bits_pc;
  logic [49:0] i_io_out_0_bits_pc;
  logic [9:0] g_io_out_0_bits_foldpc;
  logic [9:0] i_io_out_0_bits_foldpc;
  ...
  logic g_io_out_0_bits_backendException;
  logic i_io_out_0_bits_backendException;
  logic [3:0] g_io_out_0_bits_trigger;
  logic [3:0] i_io_out_0_bits_trigger;
  logic g_io_out_0_bits_pd_isRVC;
  logic i_io_out_0_bits_pd_isRVC;
  logic [1:0] g_io_out_0_bits_pd_brType;
  logic [1:0] i_io_out_0_bits_pd_brType;
  ...
  logic g_io_out_0_bits_isLastInFtqEntry;
  logic i_io_out_0_bits_isLastInFtqEntry;
  logic g_io_out_1_valid;
  logic i_io_out_1_valid;
  logic [31:0] g_io_out_1_bits_instr;
  logic [31:0] i_io_out_1_bits_instr;
  logic [49:0] g_io_out_1_bits_pc;
  logic [49:0] i_io_out_1_bits_pc;
  logic [9:0] g_io_out_1_bits_foldpc;
  logic [9:0] i_io_out_1_bits_foldpc;
  ...
  logic g_io_out_1_bits_backendException;
  logic i_io_out_1_bits_backendException;
  logic [3:0] g_io_out_1_bits_trigger;
  logic [3:0] i_io_out_1_bits_trigger;
  logic g_io_out_1_bits_pd_isRVC;
  logic i_io_out_1_bits_pd_isRVC;
  logic [1:0] g_io_out_1_bits_pd_brType;
  logic [1:0] i_io_out_1_bits_pd_brType;
  ...
  logic g_io_out_1_bits_isLastInFtqEntry;
  logic i_io_out_1_bits_isLastInFtqEntry;
  logic g_io_out_2_valid;
  logic i_io_out_2_valid;
  logic [31:0] g_io_out_2_bits_instr;
  logic [31:0] i_io_out_2_bits_instr;
  logic [49:0] g_io_out_2_bits_pc;
  logic [49:0] i_io_out_2_bits_pc;
  logic [9:0] g_io_out_2_bits_foldpc;
  logic [9:0] i_io_out_2_bits_foldpc;
  ...
  logic g_io_out_2_bits_backendException;
  logic i_io_out_2_bits_backendException;
  logic [3:0] g_io_out_2_bits_trigger;
  logic [3:0] i_io_out_2_bits_trigger;
  logic g_io_out_2_bits_pd_isRVC;
  logic i_io_out_2_bits_pd_isRVC;
  logic [1:0] g_io_out_2_bits_pd_brType;
  logic [1:0] i_io_out_2_bits_pd_brType;
  ...
  logic g_io_out_2_bits_isLastInFtqEntry;
  logic i_io_out_2_bits_isLastInFtqEntry;
  logic g_io_out_3_valid;
  logic i_io_out_3_valid;
  logic [31:0] g_io_out_3_bits_instr;
  logic [31:0] i_io_out_3_bits_instr;
  logic [49:0] g_io_out_3_bits_pc;
  logic [49:0] i_io_out_3_bits_pc;
  logic [9:0] g_io_out_3_bits_foldpc;
  logic [9:0] i_io_out_3_bits_foldpc;
  ...
  logic g_io_out_3_bits_backendException;
  logic i_io_out_3_bits_backendException;
  logic [3:0] g_io_out_3_bits_trigger;
  logic [3:0] i_io_out_3_bits_trigger;
  logic g_io_out_3_bits_pd_isRVC;
  logic i_io_out_3_bits_pd_isRVC;
  logic [1:0] g_io_out_3_bits_pd_brType;
  logic [1:0] i_io_out_3_bits_pd_brType;
  ...
  logic g_io_out_3_bits_isLastInFtqEntry;
  logic i_io_out_3_bits_isLastInFtqEntry;
  logic g_io_out_4_valid;
  logic i_io_out_4_valid;
  logic [31:0] g_io_out_4_bits_instr;
  logic [31:0] i_io_out_4_bits_instr;
  logic [49:0] g_io_out_4_bits_pc;
  logic [49:0] i_io_out_4_bits_pc;
  logic [9:0] g_io_out_4_bits_foldpc;
  logic [9:0] i_io_out_4_bits_foldpc;
  ...
  logic g_io_out_4_bits_backendException;
  logic i_io_out_4_bits_backendException;
  logic [3:0] g_io_out_4_bits_trigger;
  logic [3:0] i_io_out_4_bits_trigger;
  logic g_io_out_4_bits_pd_isRVC;
  logic i_io_out_4_bits_pd_isRVC;
  logic [1:0] g_io_out_4_bits_pd_brType;
  logic [1:0] i_io_out_4_bits_pd_brType;
  ...
  logic g_io_out_4_bits_isLastInFtqEntry;
  logic i_io_out_4_bits_isLastInFtqEntry;
  logic g_io_out_5_valid;
  logic i_io_out_5_valid;
  logic [31:0] g_io_out_5_bits_instr;
  logic [31:0] i_io_out_5_bits_instr;
  logic [49:0] g_io_out_5_bits_pc;
  logic [49:0] i_io_out_5_bits_pc;
  logic [9:0] g_io_out_5_bits_foldpc;
  logic [9:0] i_io_out_5_bits_foldpc;
  ...
  logic g_io_out_5_bits_backendException;
  logic i_io_out_5_bits_backendException;
  logic [3:0] g_io_out_5_bits_trigger;
  logic [3:0] i_io_out_5_bits_trigger;
  logic g_io_out_5_bits_pd_isRVC;
  logic i_io_out_5_bits_pd_isRVC;
  logic [1:0] g_io_out_5_bits_pd_brType;
  logic [1:0] i_io_out_5_bits_pd_brType;
  ...
  logic g_io_out_5_bits_isLastInFtqEntry;
  logic i_io_out_5_bits_isLastInFtqEntry;
  logic [5:0] g_io_stallReason_reason_0;
  logic [5:0] i_io_stallReason_reason_0;
  logic [5:0] g_io_stallReason_reason_1;
  logic [5:0] i_io_stallReason_reason_1;
  logic [5:0] g_io_stallReason_reason_2;
  logic [5:0] i_io_stallReason_reason_2;
  logic [5:0] g_io_stallReason_reason_3;
  logic [5:0] i_io_stallReason_reason_3;
  logic [5:0] g_io_stallReason_reason_4;
  logic [5:0] i_io_stallReason_reason_4;
  logic [5:0] g_io_stallReason_reason_5;
  logic [5:0] i_io_stallReason_reason_5;
  ...
  always @(negedge clk) begin
    if (rst) begin
      ...
      io_stallReason_backReason_valid <= ($urandom_range(0,7) == 0);
  ...
  always @(negedge clk) if (!rst) begin
    ...
    if (g_io_in_ready !== i_io_in_ready) begin errors++;
      if(errors<=40) $display("[%0t] io_in_ready g=%h i=%h", $time, g_io_in_ready, i_io_in_ready); end
    if (g_io_out_0_valid !== i_io_out_0_valid) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_valid g=%h i=%h", $time, g_io_out_0_valid, i_io_out_0_valid); end
    if (g_io_out_0_bits_instr !== i_io_out_0_bits_instr) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_instr g=%h i=%h", $time, g_io_out_0_bits_instr, i_io_out_0_bits_instr); end
    if (g_io_out_0_bits_pc !== i_io_out_0_bits_pc) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_pc g=%h i=%h", $time, g_io_out_0_bits_pc, i_io_out_0_bits_pc); end
    if (g_io_out_0_bits_foldpc !== i_io_out_0_bits_foldpc) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_foldpc g=%h i=%h", $time, g_io_out_0_bits_foldpc, i_io_out_0_bits_foldpc); end
    if (g_io_out_0_bits_exceptionVec_1 !== i_io_out_0_bits_exceptionVec_1) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_exceptionVec_1 g=%h i=%h", $time, g_io_out_0_bits_exceptionVec_1, i_io_out_0_bits_exceptionVec_1); end
    if (g_io_out_0_bits_exceptionVec_2 !== i_io_out_0_bits_exceptionVec_2) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_exceptionVec_2 g=%h i=%h", $time, g_io_out_0_bits_exceptionVec_2, i_io_out_0_bits_exceptionVec_2); end
    if (g_io_out_0_bits_exceptionVec_12 !== i_io_out_0_bits_exceptionVec_12) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_exceptionVec_12 g=%h i=%h", $time, g_io_out_0_bits_exceptionVec_12, i_io_out_0_bits_exceptionVec_12); end
    if (g_io_out_0_bits_exceptionVec_20 !== i_io_out_0_bits_exceptionVec_20) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_exceptionVec_20 g=%h i=%h", $time, g_io_out_0_bits_exceptionVec_20, i_io_out_0_bits_exceptionVec_20); end
    if (g_io_out_0_bits_backendException !== i_io_out_0_bits_backendException) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_backendException g=%h i=%h", $time, g_io_out_0_bits_backendException, i_io_out_0_bits_backendException); end
    if (g_io_out_0_bits_trigger !== i_io_out_0_bits_trigger) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_trigger g=%h i=%h", $time, g_io_out_0_bits_trigger, i_io_out_0_bits_trigger); end
    if (g_io_out_0_bits_pd_isRVC !== i_io_out_0_bits_pd_isRVC) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_pd_isRVC g=%h i=%h", $time, g_io_out_0_bits_pd_isRVC, i_io_out_0_bits_pd_isRVC); end
    if (g_io_out_0_bits_pd_brType !== i_io_out_0_bits_pd_brType) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_pd_brType g=%h i=%h", $time, g_io_out_0_bits_pd_brType, i_io_out_0_bits_pd_brType); end
    if (g_io_out_0_bits_pred_taken !== i_io_out_0_bits_pred_taken) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_pred_taken g=%h i=%h", $time, g_io_out_0_bits_pred_taken, i_io_out_0_bits_pred_taken); end
    if (g_io_out_0_bits_crossPageIPFFix !== i_io_out_0_bits_crossPageIPFFix) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_crossPageIPFFix g=%h i=%h", $time, g_io_out_0_bits_crossPageIPFFix, i_io_out_0_bits_crossPageIPFFix); end
    if (g_io_out_0_bits_ftqPtr_flag !== i_io_out_0_bits_ftqPtr_flag) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_ftqPtr_flag g=%h i=%h", $time, g_io_out_0_bits_ftqPtr_flag, i_io_out_0_bits_ftqPtr_flag); end
    if (g_io_out_0_bits_ftqPtr_value !== i_io_out_0_bits_ftqPtr_value) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_ftqPtr_value g=%h i=%h", $time, g_io_out_0_bits_ftqPtr_value, i_io_out_0_bits_ftqPtr_value); end
    if (g_io_out_0_bits_ftqOffset !== i_io_out_0_bits_ftqOffset) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_ftqOffset g=%h i=%h", $time, g_io_out_0_bits_ftqOffset, i_io_out_0_bits_ftqOffset); end
    if (g_io_out_0_bits_isLastInFtqEntry !== i_io_out_0_bits_isLastInFtqEntry) begin errors++;
      if(errors<=40) $display("[%0t] io_out_0_bits_isLastInFtqEntry g=%h i=%h", $time, g_io_out_0_bits_isLastInFtqEntry, i_io_out_0_bits_isLastInFtqEntry); end
    if (g_io_out_1_valid !== i_io_out_1_valid) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_valid g=%h i=%h", $time, g_io_out_1_valid, i_io_out_1_valid); end
    if (g_io_out_1_bits_instr !== i_io_out_1_bits_instr) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_instr g=%h i=%h", $time, g_io_out_1_bits_instr, i_io_out_1_bits_instr); end
    if (g_io_out_1_bits_pc !== i_io_out_1_bits_pc) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_pc g=%h i=%h", $time, g_io_out_1_bits_pc, i_io_out_1_bits_pc); end
    if (g_io_out_1_bits_foldpc !== i_io_out_1_bits_foldpc) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_foldpc g=%h i=%h", $time, g_io_out_1_bits_foldpc, i_io_out_1_bits_foldpc); end
    if (g_io_out_1_bits_exceptionVec_1 !== i_io_out_1_bits_exceptionVec_1) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_exceptionVec_1 g=%h i=%h", $time, g_io_out_1_bits_exceptionVec_1, i_io_out_1_bits_exceptionVec_1); end
    if (g_io_out_1_bits_exceptionVec_2 !== i_io_out_1_bits_exceptionVec_2) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_exceptionVec_2 g=%h i=%h", $time, g_io_out_1_bits_exceptionVec_2, i_io_out_1_bits_exceptionVec_2); end
    if (g_io_out_1_bits_exceptionVec_12 !== i_io_out_1_bits_exceptionVec_12) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_exceptionVec_12 g=%h i=%h", $time, g_io_out_1_bits_exceptionVec_12, i_io_out_1_bits_exceptionVec_12); end
    if (g_io_out_1_bits_exceptionVec_20 !== i_io_out_1_bits_exceptionVec_20) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_exceptionVec_20 g=%h i=%h", $time, g_io_out_1_bits_exceptionVec_20, i_io_out_1_bits_exceptionVec_20); end
    if (g_io_out_1_bits_backendException !== i_io_out_1_bits_backendException) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_backendException g=%h i=%h", $time, g_io_out_1_bits_backendException, i_io_out_1_bits_backendException); end
    if (g_io_out_1_bits_trigger !== i_io_out_1_bits_trigger) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_trigger g=%h i=%h", $time, g_io_out_1_bits_trigger, i_io_out_1_bits_trigger); end
    if (g_io_out_1_bits_pd_isRVC !== i_io_out_1_bits_pd_isRVC) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_pd_isRVC g=%h i=%h", $time, g_io_out_1_bits_pd_isRVC, i_io_out_1_bits_pd_isRVC); end
    if (g_io_out_1_bits_pd_brType !== i_io_out_1_bits_pd_brType) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_pd_brType g=%h i=%h", $time, g_io_out_1_bits_pd_brType, i_io_out_1_bits_pd_brType); end
    if (g_io_out_1_bits_pred_taken !== i_io_out_1_bits_pred_taken) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_pred_taken g=%h i=%h", $time, g_io_out_1_bits_pred_taken, i_io_out_1_bits_pred_taken); end
    if (g_io_out_1_bits_crossPageIPFFix !== i_io_out_1_bits_crossPageIPFFix) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_crossPageIPFFix g=%h i=%h", $time, g_io_out_1_bits_crossPageIPFFix, i_io_out_1_bits_crossPageIPFFix); end
    if (g_io_out_1_bits_ftqPtr_flag !== i_io_out_1_bits_ftqPtr_flag) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_ftqPtr_flag g=%h i=%h", $time, g_io_out_1_bits_ftqPtr_flag, i_io_out_1_bits_ftqPtr_flag); end
    if (g_io_out_1_bits_ftqPtr_value !== i_io_out_1_bits_ftqPtr_value) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_ftqPtr_value g=%h i=%h", $time, g_io_out_1_bits_ftqPtr_value, i_io_out_1_bits_ftqPtr_value); end
    if (g_io_out_1_bits_ftqOffset !== i_io_out_1_bits_ftqOffset) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_ftqOffset g=%h i=%h", $time, g_io_out_1_bits_ftqOffset, i_io_out_1_bits_ftqOffset); end
    if (g_io_out_1_bits_isLastInFtqEntry !== i_io_out_1_bits_isLastInFtqEntry) begin errors++;
      if(errors<=40) $display("[%0t] io_out_1_bits_isLastInFtqEntry g=%h i=%h", $time, g_io_out_1_bits_isLastInFtqEntry, i_io_out_1_bits_isLastInFtqEntry); end
    if (g_io_out_2_valid !== i_io_out_2_valid) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_valid g=%h i=%h", $time, g_io_out_2_valid, i_io_out_2_valid); end
    if (g_io_out_2_bits_instr !== i_io_out_2_bits_instr) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_instr g=%h i=%h", $time, g_io_out_2_bits_instr, i_io_out_2_bits_instr); end
    if (g_io_out_2_bits_pc !== i_io_out_2_bits_pc) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_pc g=%h i=%h", $time, g_io_out_2_bits_pc, i_io_out_2_bits_pc); end
    if (g_io_out_2_bits_foldpc !== i_io_out_2_bits_foldpc) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_foldpc g=%h i=%h", $time, g_io_out_2_bits_foldpc, i_io_out_2_bits_foldpc); end
    if (g_io_out_2_bits_exceptionVec_1 !== i_io_out_2_bits_exceptionVec_1) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_exceptionVec_1 g=%h i=%h", $time, g_io_out_2_bits_exceptionVec_1, i_io_out_2_bits_exceptionVec_1); end
    if (g_io_out_2_bits_exceptionVec_2 !== i_io_out_2_bits_exceptionVec_2) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_exceptionVec_2 g=%h i=%h", $time, g_io_out_2_bits_exceptionVec_2, i_io_out_2_bits_exceptionVec_2); end
    if (g_io_out_2_bits_exceptionVec_12 !== i_io_out_2_bits_exceptionVec_12) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_exceptionVec_12 g=%h i=%h", $time, g_io_out_2_bits_exceptionVec_12, i_io_out_2_bits_exceptionVec_12); end
    if (g_io_out_2_bits_exceptionVec_20 !== i_io_out_2_bits_exceptionVec_20) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_exceptionVec_20 g=%h i=%h", $time, g_io_out_2_bits_exceptionVec_20, i_io_out_2_bits_exceptionVec_20); end
    if (g_io_out_2_bits_backendException !== i_io_out_2_bits_backendException) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_backendException g=%h i=%h", $time, g_io_out_2_bits_backendException, i_io_out_2_bits_backendException); end
    if (g_io_out_2_bits_trigger !== i_io_out_2_bits_trigger) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_trigger g=%h i=%h", $time, g_io_out_2_bits_trigger, i_io_out_2_bits_trigger); end
    if (g_io_out_2_bits_pd_isRVC !== i_io_out_2_bits_pd_isRVC) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_pd_isRVC g=%h i=%h", $time, g_io_out_2_bits_pd_isRVC, i_io_out_2_bits_pd_isRVC); end
    if (g_io_out_2_bits_pd_brType !== i_io_out_2_bits_pd_brType) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_pd_brType g=%h i=%h", $time, g_io_out_2_bits_pd_brType, i_io_out_2_bits_pd_brType); end
    if (g_io_out_2_bits_pred_taken !== i_io_out_2_bits_pred_taken) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_pred_taken g=%h i=%h", $time, g_io_out_2_bits_pred_taken, i_io_out_2_bits_pred_taken); end
    if (g_io_out_2_bits_crossPageIPFFix !== i_io_out_2_bits_crossPageIPFFix) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_crossPageIPFFix g=%h i=%h", $time, g_io_out_2_bits_crossPageIPFFix, i_io_out_2_bits_crossPageIPFFix); end
    if (g_io_out_2_bits_ftqPtr_flag !== i_io_out_2_bits_ftqPtr_flag) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_ftqPtr_flag g=%h i=%h", $time, g_io_out_2_bits_ftqPtr_flag, i_io_out_2_bits_ftqPtr_flag); end
    if (g_io_out_2_bits_ftqPtr_value !== i_io_out_2_bits_ftqPtr_value) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_ftqPtr_value g=%h i=%h", $time, g_io_out_2_bits_ftqPtr_value, i_io_out_2_bits_ftqPtr_value); end
    if (g_io_out_2_bits_ftqOffset !== i_io_out_2_bits_ftqOffset) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_ftqOffset g=%h i=%h", $time, g_io_out_2_bits_ftqOffset, i_io_out_2_bits_ftqOffset); end
    if (g_io_out_2_bits_isLastInFtqEntry !== i_io_out_2_bits_isLastInFtqEntry) begin errors++;
      if(errors<=40) $display("[%0t] io_out_2_bits_isLastInFtqEntry g=%h i=%h", $time, g_io_out_2_bits_isLastInFtqEntry, i_io_out_2_bits_isLastInFtqEntry); end
    if (g_io_out_3_valid !== i_io_out_3_valid) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_valid g=%h i=%h", $time, g_io_out_3_valid, i_io_out_3_valid); end
    if (g_io_out_3_bits_instr !== i_io_out_3_bits_instr) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_instr g=%h i=%h", $time, g_io_out_3_bits_instr, i_io_out_3_bits_instr); end
    if (g_io_out_3_bits_pc !== i_io_out_3_bits_pc) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_pc g=%h i=%h", $time, g_io_out_3_bits_pc, i_io_out_3_bits_pc); end
    if (g_io_out_3_bits_foldpc !== i_io_out_3_bits_foldpc) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_foldpc g=%h i=%h", $time, g_io_out_3_bits_foldpc, i_io_out_3_bits_foldpc); end
    if (g_io_out_3_bits_exceptionVec_1 !== i_io_out_3_bits_exceptionVec_1) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_exceptionVec_1 g=%h i=%h", $time, g_io_out_3_bits_exceptionVec_1, i_io_out_3_bits_exceptionVec_1); end
    if (g_io_out_3_bits_exceptionVec_2 !== i_io_out_3_bits_exceptionVec_2) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_exceptionVec_2 g=%h i=%h", $time, g_io_out_3_bits_exceptionVec_2, i_io_out_3_bits_exceptionVec_2); end
    if (g_io_out_3_bits_exceptionVec_12 !== i_io_out_3_bits_exceptionVec_12) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_exceptionVec_12 g=%h i=%h", $time, g_io_out_3_bits_exceptionVec_12, i_io_out_3_bits_exceptionVec_12); end
    if (g_io_out_3_bits_exceptionVec_20 !== i_io_out_3_bits_exceptionVec_20) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_exceptionVec_20 g=%h i=%h", $time, g_io_out_3_bits_exceptionVec_20, i_io_out_3_bits_exceptionVec_20); end
    if (g_io_out_3_bits_backendException !== i_io_out_3_bits_backendException) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_backendException g=%h i=%h", $time, g_io_out_3_bits_backendException, i_io_out_3_bits_backendException); end
    if (g_io_out_3_bits_trigger !== i_io_out_3_bits_trigger) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_trigger g=%h i=%h", $time, g_io_out_3_bits_trigger, i_io_out_3_bits_trigger); end
    if (g_io_out_3_bits_pd_isRVC !== i_io_out_3_bits_pd_isRVC) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_pd_isRVC g=%h i=%h", $time, g_io_out_3_bits_pd_isRVC, i_io_out_3_bits_pd_isRVC); end
    if (g_io_out_3_bits_pd_brType !== i_io_out_3_bits_pd_brType) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_pd_brType g=%h i=%h", $time, g_io_out_3_bits_pd_brType, i_io_out_3_bits_pd_brType); end
    if (g_io_out_3_bits_pred_taken !== i_io_out_3_bits_pred_taken) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_pred_taken g=%h i=%h", $time, g_io_out_3_bits_pred_taken, i_io_out_3_bits_pred_taken); end
    if (g_io_out_3_bits_crossPageIPFFix !== i_io_out_3_bits_crossPageIPFFix) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_crossPageIPFFix g=%h i=%h", $time, g_io_out_3_bits_crossPageIPFFix, i_io_out_3_bits_crossPageIPFFix); end
    if (g_io_out_3_bits_ftqPtr_flag !== i_io_out_3_bits_ftqPtr_flag) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_ftqPtr_flag g=%h i=%h", $time, g_io_out_3_bits_ftqPtr_flag, i_io_out_3_bits_ftqPtr_flag); end
    if (g_io_out_3_bits_ftqPtr_value !== i_io_out_3_bits_ftqPtr_value) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_ftqPtr_value g=%h i=%h", $time, g_io_out_3_bits_ftqPtr_value, i_io_out_3_bits_ftqPtr_value); end
    if (g_io_out_3_bits_ftqOffset !== i_io_out_3_bits_ftqOffset) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_ftqOffset g=%h i=%h", $time, g_io_out_3_bits_ftqOffset, i_io_out_3_bits_ftqOffset); end
    if (g_io_out_3_bits_isLastInFtqEntry !== i_io_out_3_bits_isLastInFtqEntry) begin errors++;
      if(errors<=40) $display("[%0t] io_out_3_bits_isLastInFtqEntry g=%h i=%h", $time, g_io_out_3_bits_isLastInFtqEntry, i_io_out_3_bits_isLastInFtqEntry); end
    if (g_io_out_4_valid !== i_io_out_4_valid) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_valid g=%h i=%h", $time, g_io_out_4_valid, i_io_out_4_valid); end
    if (g_io_out_4_bits_instr !== i_io_out_4_bits_instr) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_instr g=%h i=%h", $time, g_io_out_4_bits_instr, i_io_out_4_bits_instr); end
    if (g_io_out_4_bits_pc !== i_io_out_4_bits_pc) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_pc g=%h i=%h", $time, g_io_out_4_bits_pc, i_io_out_4_bits_pc); end
    if (g_io_out_4_bits_foldpc !== i_io_out_4_bits_foldpc) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_foldpc g=%h i=%h", $time, g_io_out_4_bits_foldpc, i_io_out_4_bits_foldpc); end
    if (g_io_out_4_bits_exceptionVec_1 !== i_io_out_4_bits_exceptionVec_1) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_exceptionVec_1 g=%h i=%h", $time, g_io_out_4_bits_exceptionVec_1, i_io_out_4_bits_exceptionVec_1); end
    if (g_io_out_4_bits_exceptionVec_2 !== i_io_out_4_bits_exceptionVec_2) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_exceptionVec_2 g=%h i=%h", $time, g_io_out_4_bits_exceptionVec_2, i_io_out_4_bits_exceptionVec_2); end
    if (g_io_out_4_bits_exceptionVec_12 !== i_io_out_4_bits_exceptionVec_12) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_exceptionVec_12 g=%h i=%h", $time, g_io_out_4_bits_exceptionVec_12, i_io_out_4_bits_exceptionVec_12); end
    if (g_io_out_4_bits_exceptionVec_20 !== i_io_out_4_bits_exceptionVec_20) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_exceptionVec_20 g=%h i=%h", $time, g_io_out_4_bits_exceptionVec_20, i_io_out_4_bits_exceptionVec_20); end
    if (g_io_out_4_bits_backendException !== i_io_out_4_bits_backendException) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_backendException g=%h i=%h", $time, g_io_out_4_bits_backendException, i_io_out_4_bits_backendException); end
    if (g_io_out_4_bits_trigger !== i_io_out_4_bits_trigger) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_trigger g=%h i=%h", $time, g_io_out_4_bits_trigger, i_io_out_4_bits_trigger); end
    if (g_io_out_4_bits_pd_isRVC !== i_io_out_4_bits_pd_isRVC) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_pd_isRVC g=%h i=%h", $time, g_io_out_4_bits_pd_isRVC, i_io_out_4_bits_pd_isRVC); end
    if (g_io_out_4_bits_pd_brType !== i_io_out_4_bits_pd_brType) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_pd_brType g=%h i=%h", $time, g_io_out_4_bits_pd_brType, i_io_out_4_bits_pd_brType); end
    if (g_io_out_4_bits_pred_taken !== i_io_out_4_bits_pred_taken) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_pred_taken g=%h i=%h", $time, g_io_out_4_bits_pred_taken, i_io_out_4_bits_pred_taken); end
    if (g_io_out_4_bits_crossPageIPFFix !== i_io_out_4_bits_crossPageIPFFix) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_crossPageIPFFix g=%h i=%h", $time, g_io_out_4_bits_crossPageIPFFix, i_io_out_4_bits_crossPageIPFFix); end
    if (g_io_out_4_bits_ftqPtr_flag !== i_io_out_4_bits_ftqPtr_flag) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_ftqPtr_flag g=%h i=%h", $time, g_io_out_4_bits_ftqPtr_flag, i_io_out_4_bits_ftqPtr_flag); end
    if (g_io_out_4_bits_ftqPtr_value !== i_io_out_4_bits_ftqPtr_value) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_ftqPtr_value g=%h i=%h", $time, g_io_out_4_bits_ftqPtr_value, i_io_out_4_bits_ftqPtr_value); end
    if (g_io_out_4_bits_ftqOffset !== i_io_out_4_bits_ftqOffset) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_ftqOffset g=%h i=%h", $time, g_io_out_4_bits_ftqOffset, i_io_out_4_bits_ftqOffset); end
    if (g_io_out_4_bits_isLastInFtqEntry !== i_io_out_4_bits_isLastInFtqEntry) begin errors++;
      if(errors<=40) $display("[%0t] io_out_4_bits_isLastInFtqEntry g=%h i=%h", $time, g_io_out_4_bits_isLastInFtqEntry, i_io_out_4_bits_isLastInFtqEntry); end
    if (g_io_out_5_valid !== i_io_out_5_valid) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_valid g=%h i=%h", $time, g_io_out_5_valid, i_io_out_5_valid); end
    if (g_io_out_5_bits_instr !== i_io_out_5_bits_instr) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_instr g=%h i=%h", $time, g_io_out_5_bits_instr, i_io_out_5_bits_instr); end
    if (g_io_out_5_bits_pc !== i_io_out_5_bits_pc) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_pc g=%h i=%h", $time, g_io_out_5_bits_pc, i_io_out_5_bits_pc); end
    if (g_io_out_5_bits_foldpc !== i_io_out_5_bits_foldpc) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_foldpc g=%h i=%h", $time, g_io_out_5_bits_foldpc, i_io_out_5_bits_foldpc); end
    if (g_io_out_5_bits_exceptionVec_1 !== i_io_out_5_bits_exceptionVec_1) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_exceptionVec_1 g=%h i=%h", $time, g_io_out_5_bits_exceptionVec_1, i_io_out_5_bits_exceptionVec_1); end
    if (g_io_out_5_bits_exceptionVec_2 !== i_io_out_5_bits_exceptionVec_2) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_exceptionVec_2 g=%h i=%h", $time, g_io_out_5_bits_exceptionVec_2, i_io_out_5_bits_exceptionVec_2); end
    if (g_io_out_5_bits_exceptionVec_12 !== i_io_out_5_bits_exceptionVec_12) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_exceptionVec_12 g=%h i=%h", $time, g_io_out_5_bits_exceptionVec_12, i_io_out_5_bits_exceptionVec_12); end
    if (g_io_out_5_bits_exceptionVec_20 !== i_io_out_5_bits_exceptionVec_20) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_exceptionVec_20 g=%h i=%h", $time, g_io_out_5_bits_exceptionVec_20, i_io_out_5_bits_exceptionVec_20); end
    if (g_io_out_5_bits_backendException !== i_io_out_5_bits_backendException) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_backendException g=%h i=%h", $time, g_io_out_5_bits_backendException, i_io_out_5_bits_backendException); end
    if (g_io_out_5_bits_trigger !== i_io_out_5_bits_trigger) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_trigger g=%h i=%h", $time, g_io_out_5_bits_trigger, i_io_out_5_bits_trigger); end
    if (g_io_out_5_bits_pd_isRVC !== i_io_out_5_bits_pd_isRVC) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_pd_isRVC g=%h i=%h", $time, g_io_out_5_bits_pd_isRVC, i_io_out_5_bits_pd_isRVC); end
    if (g_io_out_5_bits_pd_brType !== i_io_out_5_bits_pd_brType) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_pd_brType g=%h i=%h", $time, g_io_out_5_bits_pd_brType, i_io_out_5_bits_pd_brType); end
    if (g_io_out_5_bits_pred_taken !== i_io_out_5_bits_pred_taken) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_pred_taken g=%h i=%h", $time, g_io_out_5_bits_pred_taken, i_io_out_5_bits_pred_taken); end
    if (g_io_out_5_bits_crossPageIPFFix !== i_io_out_5_bits_crossPageIPFFix) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_crossPageIPFFix g=%h i=%h", $time, g_io_out_5_bits_crossPageIPFFix, i_io_out_5_bits_crossPageIPFFix); end
    if (g_io_out_5_bits_ftqPtr_flag !== i_io_out_5_bits_ftqPtr_flag) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_ftqPtr_flag g=%h i=%h", $time, g_io_out_5_bits_ftqPtr_flag, i_io_out_5_bits_ftqPtr_flag); end
    if (g_io_out_5_bits_ftqPtr_value !== i_io_out_5_bits_ftqPtr_value) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_ftqPtr_value g=%h i=%h", $time, g_io_out_5_bits_ftqPtr_value, i_io_out_5_bits_ftqPtr_value); end
    if (g_io_out_5_bits_ftqOffset !== i_io_out_5_bits_ftqOffset) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_ftqOffset g=%h i=%h", $time, g_io_out_5_bits_ftqOffset, i_io_out_5_bits_ftqOffset); end
    if (g_io_out_5_bits_isLastInFtqEntry !== i_io_out_5_bits_isLastInFtqEntry) begin errors++;
      if(errors<=40) $display("[%0t] io_out_5_bits_isLastInFtqEntry g=%h i=%h", $time, g_io_out_5_bits_isLastInFtqEntry, i_io_out_5_bits_isLastInFtqEntry); end
    if (g_io_stallReason_reason_0 !== i_io_stallReason_reason_0) begin errors++;
      if(errors<=40) $display("[%0t] io_stallReason_reason_0 g=%h i=%h", $time, g_io_stallReason_reason_0, i_io_stallReason_reason_0); end
    if (g_io_stallReason_reason_1 !== i_io_stallReason_reason_1) begin errors++;
      if(errors<=40) $display("[%0t] io_stallReason_reason_1 g=%h i=%h", $time, g_io_stallReason_reason_1, i_io_stallReason_reason_1); end
    if (g_io_stallReason_reason_2 !== i_io_stallReason_reason_2) begin errors++;
      if(errors<=40) $display("[%0t] io_stallReason_reason_2 g=%h i=%h", $time, g_io_stallReason_reason_2, i_io_stallReason_reason_2); end
    if (g_io_stallReason_reason_3 !== i_io_stallReason_reason_3) begin errors++;
      if(errors<=40) $display("[%0t] io_stallReason_reason_3 g=%h i=%h", $time, g_io_stallReason_reason_3, i_io_stallReason_reason_3); end
    if (g_io_stallReason_reason_4 !== i_io_stallReason_reason_4) begin errors++;
      if(errors<=40) $display("[%0t] io_stallReason_reason_4 g=%h i=%h", $time, g_io_stallReason_reason_4, i_io_stallReason_reason_4); end
    if (g_io_stallReason_reason_5 !== i_io_stallReason_reason_5) begin errors++;
      if(errors<=40) $display("[%0t] io_stallReason_reason_5 g=%h i=%h", $time, g_io_stallReason_reason_5, i_io_stallReason_reason_5); end
    ...
    if (g_io_perf_7_value !== i_io_perf_7_value) begin errors++;
      if(errors<=40) $display("[%0t] io_perf_7_value g=%h i=%h", $time, g_io_perf_7_value, i_io_perf_7_value); end
    if (g_io_perf_8_value !== i_io_perf_8_value) begin errors++;
      if(errors<=40) $display("[%0t] io_perf_8_value g=%h i=%h", $time, g_io_perf_8_value, i_io_perf_8_value); end
  end
