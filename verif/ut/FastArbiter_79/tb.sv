...
// FastArbiter_79 双例化逐拍比对: golden FastArbiter_79 vs 可读 FastArbiter_79_xs。
...
module tb;
  ...
  logic [7:0] io_in_1_bits_tag;
  logic [1:0] io_in_1_bits_tu;
  ...
  FastArbiter_79 u_g (
    ...
    .io_in_1_bits_tu(io_in_1_bits_tu),
  ...
  task automatic drive_random_inputs();
    ...
    io_in_1_bits_tag <= 8'({$urandom});
    io_in_1_bits_tu <= 2'({$urandom});
  ...
  initial begin
    ...
    $display("FastArbiter_79 checks=%0d errors=%0d", checks, errors);
