...
module tb;
  ...
  logic [14:0] auto_out_d_bits_source;
  ...
  wire [14:0] g_auto_out_a_bits_source;
  wire [14:0] i_auto_out_a_bits_source;
  ...
  task automatic drive_random_inputs();
    ...
    auto_out_d_bits_source <= 15'({$urandom});
  ...
  initial begin
    ...
    $display("TLBuffer_2 checks=%0d errors=%0d", checks, errors);
