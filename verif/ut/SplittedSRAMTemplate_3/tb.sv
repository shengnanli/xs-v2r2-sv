// SplittedSRAMTemplate_3 UT：golden vs _xs 双例化随机比对。
// 单 SRAMTemplate_44(bp_tage_us, 256×16×1b, extra_reset) 直通。16 way × 1bit。
`timescale 1ns/1ps
module tb;
  ...
  `define PORTS(RDY,RD,BRD) \
    ...
    .io_r_resp_data_0(RD[0]),   .io_r_resp_data_1(RD[1]),   .io_r_resp_data_2(RD[2]),   .io_r_resp_data_3(RD[3]), \
    .io_r_resp_data_4(RD[4]),   .io_r_resp_data_5(RD[5]),   .io_r_resp_data_6(RD[6]),   .io_r_resp_data_7(RD[7]), \
    .io_r_resp_data_8(RD[8]),   .io_r_resp_data_9(RD[9]),   .io_r_resp_data_10(RD[10]), .io_r_resp_data_11(RD[11]), \
    .io_r_resp_data_12(RD[12]), .io_r_resp_data_13(RD[13]), .io_r_resp_data_14(RD[14]), .io_r_resp_data_15(RD[15]), \
    .io_w_req_valid(w_valid), .io_w_req_bits_setIdx(w_setIdx), \
    .io_w_req_bits_data_0(wdata[0]),   .io_w_req_bits_data_1(wdata[1]),   .io_w_req_bits_data_2(wdata[2]),   .io_w_req_bits_data_3(wdata[3]), \
    .io_w_req_bits_data_4(wdata[4]),   .io_w_req_bits_data_5(wdata[5]),   .io_w_req_bits_data_6(wdata[6]),   .io_w_req_bits_data_7(wdata[7]), \
    .io_w_req_bits_data_8(wdata[8]),   .io_w_req_bits_data_9(wdata[9]),   .io_w_req_bits_data_10(wdata[10]), .io_w_req_bits_data_11(wdata[11]), \
    .io_w_req_bits_data_12(wdata[12]), .io_w_req_bits_data_13(wdata[13]), .io_w_req_bits_data_14(wdata[14]), .io_w_req_bits_data_15(wdata[15]), \
