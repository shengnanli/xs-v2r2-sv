...
// BPU 簇 IT：golden Predictor (u_g) vs 全重写 Predictor_it (u_i) 双例化（共用同名 golden 子模块），
...
module tb;
  ...
  int nonfunc_errors = 0;  // IT: 非功能输出（DFT bore 链 + 重写侧置零的 perf 计数器）差异，单列不计入 PASS
  int cyc = 0;
  always #5 clk = ~clk;
  ...
  always @(negedge clk) if (!rst) begin
    ...
    if (cyc > WARMUP) begin
      ...
      if (!$isunknown(g_io_perf_0_value) && g_io_perf_0_value !== i_io_perf_0_value) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] io_perf_0_value g=%h i=%h", $time, g_io_perf_0_value, i_io_perf_0_value); end
      if (!$isunknown(g_io_perf_1_value) && g_io_perf_1_value !== i_io_perf_1_value) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] io_perf_1_value g=%h i=%h", $time, g_io_perf_1_value, i_io_perf_1_value); end
      if (!$isunknown(g_io_perf_2_value) && g_io_perf_2_value !== i_io_perf_2_value) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] io_perf_2_value g=%h i=%h", $time, g_io_perf_2_value, i_io_perf_2_value); end
      if (!$isunknown(g_io_perf_3_value) && g_io_perf_3_value !== i_io_perf_3_value) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] io_perf_3_value g=%h i=%h", $time, g_io_perf_3_value, i_io_perf_3_value); end
      if (!$isunknown(g_io_perf_4_value) && g_io_perf_4_value !== i_io_perf_4_value) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] io_perf_4_value g=%h i=%h", $time, g_io_perf_4_value, i_io_perf_4_value); end
      if (!$isunknown(g_io_perf_5_value) && g_io_perf_5_value !== i_io_perf_5_value) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] io_perf_5_value g=%h i=%h", $time, g_io_perf_5_value, i_io_perf_5_value); end
      if (!$isunknown(g_io_perf_6_value) && g_io_perf_6_value !== i_io_perf_6_value) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] io_perf_6_value g=%h i=%h", $time, g_io_perf_6_value, i_io_perf_6_value); end
      if (!$isunknown(g_boreChildrenBd_bore_ack) && g_boreChildrenBd_bore_ack !== i_boreChildrenBd_bore_ack) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_ack g=%h i=%h", $time, g_boreChildrenBd_bore_ack, i_boreChildrenBd_bore_ack); end
      if (!$isunknown(g_boreChildrenBd_bore_outdata) && g_boreChildrenBd_bore_outdata !== i_boreChildrenBd_bore_outdata) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_outdata g=%h i=%h", $time, g_boreChildrenBd_bore_outdata, i_boreChildrenBd_bore_outdata); end
      if (!$isunknown(g_boreChildrenBd_bore_1_ack) && g_boreChildrenBd_bore_1_ack !== i_boreChildrenBd_bore_1_ack) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_1_ack g=%h i=%h", $time, g_boreChildrenBd_bore_1_ack, i_boreChildrenBd_bore_1_ack); end
      if (!$isunknown(g_boreChildrenBd_bore_1_outdata) && g_boreChildrenBd_bore_1_outdata !== i_boreChildrenBd_bore_1_outdata) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_1_outdata g=%h i=%h", $time, g_boreChildrenBd_bore_1_outdata, i_boreChildrenBd_bore_1_outdata); end
      if (!$isunknown(g_boreChildrenBd_bore_2_ack) && g_boreChildrenBd_bore_2_ack !== i_boreChildrenBd_bore_2_ack) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_2_ack g=%h i=%h", $time, g_boreChildrenBd_bore_2_ack, i_boreChildrenBd_bore_2_ack); end
      if (!$isunknown(g_boreChildrenBd_bore_2_outdata) && g_boreChildrenBd_bore_2_outdata !== i_boreChildrenBd_bore_2_outdata) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_2_outdata g=%h i=%h", $time, g_boreChildrenBd_bore_2_outdata, i_boreChildrenBd_bore_2_outdata); end
      if (!$isunknown(g_boreChildrenBd_bore_3_ack) && g_boreChildrenBd_bore_3_ack !== i_boreChildrenBd_bore_3_ack) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_3_ack g=%h i=%h", $time, g_boreChildrenBd_bore_3_ack, i_boreChildrenBd_bore_3_ack); end
      if (!$isunknown(g_boreChildrenBd_bore_3_outdata) && g_boreChildrenBd_bore_3_outdata !== i_boreChildrenBd_bore_3_outdata) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_3_outdata g=%h i=%h", $time, g_boreChildrenBd_bore_3_outdata, i_boreChildrenBd_bore_3_outdata); end
      if (!$isunknown(g_boreChildrenBd_bore_4_ack) && g_boreChildrenBd_bore_4_ack !== i_boreChildrenBd_bore_4_ack) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_4_ack g=%h i=%h", $time, g_boreChildrenBd_bore_4_ack, i_boreChildrenBd_bore_4_ack); end
      if (!$isunknown(g_boreChildrenBd_bore_4_outdata) && g_boreChildrenBd_bore_4_outdata !== i_boreChildrenBd_bore_4_outdata) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_4_outdata g=%h i=%h", $time, g_boreChildrenBd_bore_4_outdata, i_boreChildrenBd_bore_4_outdata); end
      if (!$isunknown(g_boreChildrenBd_bore_5_ack) && g_boreChildrenBd_bore_5_ack !== i_boreChildrenBd_bore_5_ack) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_5_ack g=%h i=%h", $time, g_boreChildrenBd_bore_5_ack, i_boreChildrenBd_bore_5_ack); end
      if (!$isunknown(g_boreChildrenBd_bore_5_outdata) && g_boreChildrenBd_bore_5_outdata !== i_boreChildrenBd_bore_5_outdata) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_5_outdata g=%h i=%h", $time, g_boreChildrenBd_bore_5_outdata, i_boreChildrenBd_bore_5_outdata); end
      if (!$isunknown(g_boreChildrenBd_bore_6_ack) && g_boreChildrenBd_bore_6_ack !== i_boreChildrenBd_bore_6_ack) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_6_ack g=%h i=%h", $time, g_boreChildrenBd_bore_6_ack, i_boreChildrenBd_bore_6_ack); end
      if (!$isunknown(g_boreChildrenBd_bore_6_outdata) && g_boreChildrenBd_bore_6_outdata !== i_boreChildrenBd_bore_6_outdata) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_6_outdata g=%h i=%h", $time, g_boreChildrenBd_bore_6_outdata, i_boreChildrenBd_bore_6_outdata); end
      if (!$isunknown(g_boreChildrenBd_bore_7_ack) && g_boreChildrenBd_bore_7_ack !== i_boreChildrenBd_bore_7_ack) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_7_ack g=%h i=%h", $time, g_boreChildrenBd_bore_7_ack, i_boreChildrenBd_bore_7_ack); end
      if (!$isunknown(g_boreChildrenBd_bore_7_outdata) && g_boreChildrenBd_bore_7_outdata !== i_boreChildrenBd_bore_7_outdata) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_7_outdata g=%h i=%h", $time, g_boreChildrenBd_bore_7_outdata, i_boreChildrenBd_bore_7_outdata); end
      if (!$isunknown(g_boreChildrenBd_bore_8_ack) && g_boreChildrenBd_bore_8_ack !== i_boreChildrenBd_bore_8_ack) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_8_ack g=%h i=%h", $time, g_boreChildrenBd_bore_8_ack, i_boreChildrenBd_bore_8_ack); end
      if (!$isunknown(g_boreChildrenBd_bore_8_outdata) && g_boreChildrenBd_bore_8_outdata !== i_boreChildrenBd_bore_8_outdata) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_8_outdata g=%h i=%h", $time, g_boreChildrenBd_bore_8_outdata, i_boreChildrenBd_bore_8_outdata); end
      if (!$isunknown(g_boreChildrenBd_bore_9_ack) && g_boreChildrenBd_bore_9_ack !== i_boreChildrenBd_bore_9_ack) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_9_ack g=%h i=%h", $time, g_boreChildrenBd_bore_9_ack, i_boreChildrenBd_bore_9_ack); end
      if (!$isunknown(g_boreChildrenBd_bore_9_outdata) && g_boreChildrenBd_bore_9_outdata !== i_boreChildrenBd_bore_9_outdata) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_9_outdata g=%h i=%h", $time, g_boreChildrenBd_bore_9_outdata, i_boreChildrenBd_bore_9_outdata); end
      if (!$isunknown(g_boreChildrenBd_bore_10_ack) && g_boreChildrenBd_bore_10_ack !== i_boreChildrenBd_bore_10_ack) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_10_ack g=%h i=%h", $time, g_boreChildrenBd_bore_10_ack, i_boreChildrenBd_bore_10_ack); end
      if (!$isunknown(g_boreChildrenBd_bore_10_outdata) && g_boreChildrenBd_bore_10_outdata !== i_boreChildrenBd_bore_10_outdata) begin nonfunc_errors++;
        if (nonfunc_errors<=8) $display("[%0t] boreChildrenBd_bore_10_outdata g=%h i=%h", $time, g_boreChildrenBd_bore_10_outdata, i_boreChildrenBd_bore_10_outdata); end
    end
  end
  ...
  initial begin
    void'($value$plusargs("NCYCLES=%d", NCYCLES));  // IT: 运行时覆盖拍数（默认 40000）
    rst = 1; repeat (16) @(posedge clk); rst = 0;
    repeat (NCYCLES) @(posedge clk);
    $display("checks=%0d errors=%0d core_checks=%0d core_errors=%0d nonfunc_errors=%0d", checks, errors, core_checks, core_errors, nonfunc_errors);
