...
`include "issuequeue_abjivvi_ports.svh"
  ...
  // ===========================================================================
  EntriesAluBrhJmpI2fVsetriwiVsetriwvfI2v_it entries (
...
// =============================================================================
// IssueQueueAluBrhJmpI2fVsetriwiVsetriwvfI2v_it —— golden 同名顶层。可读核接口已持平
// golden 扁平接口, 故为纯穿透 wrapper。
// =============================================================================
module IssueQueueAluBrhJmpI2fVsetriwiVsetriwvfI2v_it (
  input         clock,
  input         reset,
`include "issuequeue_abjivvi_ports.svh"
);
