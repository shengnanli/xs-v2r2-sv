...
// EntriesAluBrhJmpI2fVsetriwiVsetriwvfI2v_it golden 同名扁平 wrapper —— 例化可读核 xs_EntriesAluBrhJmpI2fVsetriwiVsetriwvfI2v_core。
module EntriesAluBrhJmpI2fVsetriwiVsetriwvfI2v_it import iq_abjivvi_pkg::*; (
  input  clock,
  input  reset,
