// 自动生成 gen_vsplit.py —— 勿手改。双例化 golden VSSplitImp vs VSSplitImp_xs 逐拍比对。
`timescale 1ns/1ps
module tb;
  ...
  logic [127:0] io_in_bits_uop_vpu_vmask;
  ...
  logic io_out_ready;
  logic io_vstdMisalign_storePipeEmpty;
  logic io_vstdMisalign_storeMisalignBufferEmpty;
  logic g_io_in_ready;
  logic i_io_in_ready;
  ...
  logic [127:0] g_io_toMergeBuffer_req_bits_uop_vpu_vmask;
  logic [127:0] i_io_toMergeBuffer_req_bits_uop_vpu_vmask;
  ...
  logic g_io_toMergeBuffer_req_bits_uop_lqIdx_flag;
  logic i_io_toMergeBuffer_req_bits_uop_lqIdx_flag;
  logic [6:0] g_io_toMergeBuffer_req_bits_uop_lqIdx_value;
  logic [6:0] i_io_toMergeBuffer_req_bits_uop_lqIdx_value;
  logic g_io_toMergeBuffer_req_bits_uop_sqIdx_flag;
  logic i_io_toMergeBuffer_req_bits_uop_sqIdx_flag;
  logic [5:0] g_io_toMergeBuffer_req_bits_uop_sqIdx_value;
  logic [5:0] i_io_toMergeBuffer_req_bits_uop_sqIdx_value;
  ...
  logic g_io_out_bits_uop_exceptionVec_6;
  logic i_io_out_bits_uop_exceptionVec_6;
  logic g_io_out_bits_uop_exceptionVec_7;
  logic i_io_out_bits_uop_exceptionVec_7;
  logic g_io_out_bits_uop_exceptionVec_15;
  logic i_io_out_bits_uop_exceptionVec_15;
  logic g_io_out_bits_uop_exceptionVec_19;
  logic i_io_out_bits_uop_exceptionVec_19;
  logic g_io_out_bits_uop_exceptionVec_23;
  logic i_io_out_bits_uop_exceptionVec_23;
  ...
  logic g_io_vstd_valid;
  logic i_io_vstd_valid;
  logic [8:0] g_io_vstd_bits_uop_fuOpType;
  logic [8:0] i_io_vstd_bits_uop_fuOpType;
  logic g_io_vstd_bits_uop_sqIdx_flag;
  logic i_io_vstd_bits_uop_sqIdx_flag;
  logic [5:0] g_io_vstd_bits_uop_sqIdx_value;
  logic [5:0] i_io_vstd_bits_uop_sqIdx_value;
  logic [127:0] g_io_vstd_bits_data;
  logic [127:0] i_io_vstd_bits_data;
  ...
  VSSplitImp u_g (
    ...
    .io_toMergeBuffer_req_bits_uop_vpu_vmask(g_io_toMergeBuffer_req_bits_uop_vpu_vmask),
    ...
    .io_toMergeBuffer_req_bits_uop_lqIdx_flag(g_io_toMergeBuffer_req_bits_uop_lqIdx_flag),
    .io_toMergeBuffer_req_bits_uop_lqIdx_value(g_io_toMergeBuffer_req_bits_uop_lqIdx_value),
    .io_toMergeBuffer_req_bits_uop_sqIdx_flag(g_io_toMergeBuffer_req_bits_uop_sqIdx_flag),
    .io_toMergeBuffer_req_bits_uop_sqIdx_value(g_io_toMergeBuffer_req_bits_uop_sqIdx_value),
    ...
    .io_vstd_valid(g_io_vstd_valid),
    .io_vstd_bits_uop_fuOpType(g_io_vstd_bits_uop_fuOpType),
    .io_vstd_bits_uop_sqIdx_flag(g_io_vstd_bits_uop_sqIdx_flag),
    .io_vstd_bits_uop_sqIdx_value(g_io_vstd_bits_uop_sqIdx_value),
    .io_vstd_bits_data(g_io_vstd_bits_data)
  );
  VSSplitImp_xs u_i (
    .clock(clk), .reset(rst),
    .io_redirect_valid(io_redirect_valid),
    ...
    .io_toMergeBuffer_req_bits_uop_vpu_vmask(i_io_toMergeBuffer_req_bits_uop_vpu_vmask),
    ...
    .io_toMergeBuffer_req_bits_uop_lqIdx_flag(i_io_toMergeBuffer_req_bits_uop_lqIdx_flag),
    .io_toMergeBuffer_req_bits_uop_lqIdx_value(i_io_toMergeBuffer_req_bits_uop_lqIdx_value),
    .io_toMergeBuffer_req_bits_uop_sqIdx_flag(i_io_toMergeBuffer_req_bits_uop_sqIdx_flag),
    .io_toMergeBuffer_req_bits_uop_sqIdx_value(i_io_toMergeBuffer_req_bits_uop_sqIdx_value),
    ...
    .io_vstd_valid(i_io_vstd_valid),
    .io_vstd_bits_uop_fuOpType(i_io_vstd_bits_uop_fuOpType),
    .io_vstd_bits_uop_sqIdx_flag(i_io_vstd_bits_uop_sqIdx_flag),
    .io_vstd_bits_uop_sqIdx_value(i_io_vstd_bits_uop_sqIdx_value),
    .io_vstd_bits_data(i_io_vstd_bits_data)
  );
  ...
  initial begin
    ...
    io_out_ready = 0;
    io_vstdMisalign_storePipeEmpty = 0;
    io_vstdMisalign_storeMisalignBufferEmpty = 0;
    ...
    for (cyc = 0; cyc < NCYCLES; cyc++) begin
      ...
      io_in_bits_uop_vpu_vmask <= {$random, $random, $random, $random};
      ...
      io_out_ready <= $random;
      io_vstdMisalign_storePipeEmpty <= $random;
      io_vstdMisalign_storeMisalignBufferEmpty <= $random;
      @(posedge clk);
      #1;
      if (cyc > 2) begin
        checks++;
      ...
      if (g_io_toMergeBuffer_req_bits_uop_vpu_vmask !== i_io_toMergeBuffer_req_bits_uop_vpu_vmask) begin errors++; if (errors<20) $display("MISMATCH io_toMergeBuffer_req_bits_uop_vpu_vmask @%0d g=%h i=%h", cyc, g_io_toMergeBuffer_req_bits_uop_vpu_vmask, i_io_toMergeBuffer_req_bits_uop_vpu_vmask); end
      ...
      if (g_io_toMergeBuffer_req_bits_uop_lqIdx_flag !== i_io_toMergeBuffer_req_bits_uop_lqIdx_flag) begin errors++; if (errors<20) $display("MISMATCH io_toMergeBuffer_req_bits_uop_lqIdx_flag @%0d g=%h i=%h", cyc, g_io_toMergeBuffer_req_bits_uop_lqIdx_flag, i_io_toMergeBuffer_req_bits_uop_lqIdx_flag); end
      if (g_io_toMergeBuffer_req_bits_uop_lqIdx_value !== i_io_toMergeBuffer_req_bits_uop_lqIdx_value) begin errors++; if (errors<20) $display("MISMATCH io_toMergeBuffer_req_bits_uop_lqIdx_value @%0d g=%h i=%h", cyc, g_io_toMergeBuffer_req_bits_uop_lqIdx_value, i_io_toMergeBuffer_req_bits_uop_lqIdx_value); end
      if (g_io_toMergeBuffer_req_bits_uop_sqIdx_flag !== i_io_toMergeBuffer_req_bits_uop_sqIdx_flag) begin errors++; if (errors<20) $display("MISMATCH io_toMergeBuffer_req_bits_uop_sqIdx_flag @%0d g=%h i=%h", cyc, g_io_toMergeBuffer_req_bits_uop_sqIdx_flag, i_io_toMergeBuffer_req_bits_uop_sqIdx_flag); end
      if (g_io_toMergeBuffer_req_bits_uop_sqIdx_value !== i_io_toMergeBuffer_req_bits_uop_sqIdx_value) begin errors++; if (errors<20) $display("MISMATCH io_toMergeBuffer_req_bits_uop_sqIdx_value @%0d g=%h i=%h", cyc, g_io_toMergeBuffer_req_bits_uop_sqIdx_value, i_io_toMergeBuffer_req_bits_uop_sqIdx_value); end
      ...
      if (g_io_out_bits_uop_exceptionVec_6 !== i_io_out_bits_uop_exceptionVec_6) begin errors++; if (errors<20) $display("MISMATCH io_out_bits_uop_exceptionVec_6 @%0d g=%h i=%h", cyc, g_io_out_bits_uop_exceptionVec_6, i_io_out_bits_uop_exceptionVec_6); end
      if (g_io_out_bits_uop_exceptionVec_7 !== i_io_out_bits_uop_exceptionVec_7) begin errors++; if (errors<20) $display("MISMATCH io_out_bits_uop_exceptionVec_7 @%0d g=%h i=%h", cyc, g_io_out_bits_uop_exceptionVec_7, i_io_out_bits_uop_exceptionVec_7); end
      if (g_io_out_bits_uop_exceptionVec_15 !== i_io_out_bits_uop_exceptionVec_15) begin errors++; if (errors<20) $display("MISMATCH io_out_bits_uop_exceptionVec_15 @%0d g=%h i=%h", cyc, g_io_out_bits_uop_exceptionVec_15, i_io_out_bits_uop_exceptionVec_15); end
      ...
      if (g_io_out_bits_uop_exceptionVec_23 !== i_io_out_bits_uop_exceptionVec_23) begin errors++; if (errors<20) $display("MISMATCH io_out_bits_uop_exceptionVec_23 @%0d g=%h i=%h", cyc, g_io_out_bits_uop_exceptionVec_23, i_io_out_bits_uop_exceptionVec_23); end
      ...
      if (g_io_vstd_valid !== i_io_vstd_valid) begin errors++; if (errors<20) $display("MISMATCH io_vstd_valid @%0d g=%h i=%h", cyc, g_io_vstd_valid, i_io_vstd_valid); end
      if (g_io_vstd_bits_uop_fuOpType !== i_io_vstd_bits_uop_fuOpType) begin errors++; if (errors<20) $display("MISMATCH io_vstd_bits_uop_fuOpType @%0d g=%h i=%h", cyc, g_io_vstd_bits_uop_fuOpType, i_io_vstd_bits_uop_fuOpType); end
      if (g_io_vstd_bits_uop_sqIdx_flag !== i_io_vstd_bits_uop_sqIdx_flag) begin errors++; if (errors<20) $display("MISMATCH io_vstd_bits_uop_sqIdx_flag @%0d g=%h i=%h", cyc, g_io_vstd_bits_uop_sqIdx_flag, i_io_vstd_bits_uop_sqIdx_flag); end
      if (g_io_vstd_bits_uop_sqIdx_value !== i_io_vstd_bits_uop_sqIdx_value) begin errors++; if (errors<20) $display("MISMATCH io_vstd_bits_uop_sqIdx_value @%0d g=%h i=%h", cyc, g_io_vstd_bits_uop_sqIdx_value, i_io_vstd_bits_uop_sqIdx_value); end
      if (g_io_vstd_bits_data !== i_io_vstd_bits_data) begin errors++; if (errors<20) $display("MISMATCH io_vstd_bits_data @%0d g=%h i=%h", cyc, g_io_vstd_bits_data, i_io_vstd_bits_data); end
      end
    end
