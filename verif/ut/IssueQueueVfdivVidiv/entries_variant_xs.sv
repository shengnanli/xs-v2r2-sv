// 自动生成:scripts/gen_iq_vfdiv.py —— 勿手改
// EntriesVfdivVidiv golden 同名扁平 wrapper —— 例化可读核 xs_EntriesVfdivVidiv_core。
module EntriesVfdivVidiv_xs import iq_vfdiv_pkg::*; (
  input  clock,
  input  reset,
  ...
  always_comb begin
    ...
    c_enq_bits[0].status.fu_type_vfdiv = io_enq_0_bits_status_fuType_22;
    c_enq_bits[0].status.fu_type_vidiv = io_enq_0_bits_status_fuType_26;
    ...
    c_enq_bits[1].status.fu_type_vfdiv = io_enq_1_bits_status_fuType_22;
    c_enq_bits[1].status.fu_type_vidiv = io_enq_1_bits_status_fuType_26;
  ...
  assign io_deqEntry_0_bits_status_fuType_22 = c_deq_entry.status.fu_type_vfdiv;
  assign io_deqEntry_0_bits_status_fuType_26 = c_deq_entry.status.fu_type_vidiv;
  ...
  assign io_deqEntry_0_bits_payload_vpu_isExt = c_deq_entry.payload.vpu.is_ext;
  assign io_deqEntry_0_bits_payload_vpu_isNarrow = c_deq_entry.payload.vpu.is_narrow;
  assign io_deqEntry_0_bits_payload_vpu_isDstMask = c_deq_entry.payload.vpu.is_dst_mask;
  assign io_deqEntry_0_bits_payload_vpu_isOpMask = c_deq_entry.payload.vpu.is_op_mask;
  ...
  xs_EntriesVfdivVidiv_core u_core (
