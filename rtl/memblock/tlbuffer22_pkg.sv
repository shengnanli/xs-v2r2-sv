// =============================================================================
//  tlbuffer22_pkg —— TLBuffer_22 (TileLink A/D 两通道 skid 缓冲) 类型包
// -----------------------------------------------------------------------------
//  TLBuffer_22 是叶子级时序缓冲: A 请求 (client->manager)、D 应答 (manager->client)
...
package tlbuffer22_pkg;
  ...
  typedef struct packed {
    ...
    logic [2:0] source;
    logic [47:0] address;
    logic user_memBackType_MM;
    logic user_memPageType_NC;
    logic [7:0] mask;
    logic [63:0] data;
    logic corrupt;
  } tl_a_bundle_t;
