// =============================================================================
//  TLBuffer_8 —— TileLink A/D 两通道时序缓冲 (可读重写核 xs_TLBuffer_8_core)
// -----------------------------------------------------------------------------
...
//  本变体特征: 窄总线缓冲: source/size 2 位、address 48 位、data 64 位, A 带 user_memPageType_NC / user_memBackType_MM 两个 1 位标志 (NC 在前)。
// =============================================================================
module xs_TLBuffer_8_core
  import tlbuffer8_pkg::*;
(
  input clock,
  input reset,
  ...
  always_comb begin
    client_a = '{opcode: auto_in_a_bits_opcode, param: auto_in_a_bits_param,
        ...
        address: auto_in_a_bits_address, user_memPageType_NC: auto_in_a_bits_user_memPageType_NC,
        user_memBackType_MM: auto_in_a_bits_user_memBackType_MM, mask: auto_in_a_bits_mask,
