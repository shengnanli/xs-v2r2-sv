...
// ============================================================================
module xs_ExeUnit_4_core
  import exeunit_4_pkg::*;
(
  input  clock,
  input  reset,
  `include "exeunit_4_ports.svh"
);

  `include "exeunit_4_decls.svh"    // 子模块输出网 + 流水/门控状态声明
  `include "exeunit_4_logic.svh"    // §1 inPipe / §2 时钟门控使能(可读重写)
  `include "exeunit_4_connect.svh"  // FU/Dispatcher/ClockGate 黑盒例化 + §3 仲裁
