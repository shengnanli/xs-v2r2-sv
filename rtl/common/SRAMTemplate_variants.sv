// =============================================================================
// SRAMTemplate 变体包装层（golden 同名，FM/ST 用）
//
// 每个变体例化 xs_SRAMTemplate_core（功能逻辑）+ 对应的厂商 SRAM 宏黑盒，按 golden
// 端口逐一连接。SRAM 宏与 ClockGate/array_ext 作为两侧共用黑盒（FM）或行为级
// 仿真模型（UT，build/rtl/array*_ext.v）。
//
// 已覆盖变体：
//   SRAMTemplate : 128set × 2way × 37b，宏 sram_array_1p128x74m37s1h0l1b_icsh_tag
// =============================================================================
