// hideleg UT variant (_xs): instantiate the readable bespoke core xs_hideleg.
module HidelegModule_xs(
  input clock, input reset, input w_wen, input [63:0] w_wdata,
  output [63:0] rdata,
  output regOut_SSI, output regOut_VSSI, output regOut_MSI,
  output regOut_STI, output regOut_VSTI, output regOut_MTI,
  output regOut_SEI, output regOut_VSEI, output regOut_MEI,
  output regOut_SGEI, output regOut_LCOFI,
  input mideleg_SSI, input mideleg_STI, input mideleg_SEI, input mideleg_LCOFI
);
  xs_hideleg u_core (
