// =============================================================================
// Bku_xs —— UT 用的 impl 侧适配模块（与 Bku_wrapper 同体，仅模块名不同）
//
// UT 中 golden 顶层名为 Bku，impl 不能重名，故这里命名为 Bku_xs，端口与 golden
// 完全一致，内部接可读核 xs_Bku_core。tb 同时例化 Bku 与 Bku_xs 逐拍比对。
// =============================================================================
module Bku_xs (
  input         clock,
  input         reset,
