// =============================================================================
// xs_iq_entry_vlduvstuseg —— 香山 V2R2(昆明湖) 发射队列「单条目」可读重写
//                            (VlduVstuVseglduVsegstu 变体:向量/段 load/store)
// ★ 与 IqEntryVlduVstu 的唯一差异:status 多 fu_type_vsegldu(33)/fu_type_vsegstu(34)
//   两位 FU one-hot,在 entry_update 与 o_fu_type 里随条目透传,行为与 vldu/vstu 逐字一致 ★
// -----------------------------------------------------------------------------
...
// =============================================================================
module xs_iq_entry_vlduvstuseg import iq_vlduvstuseg_pkg::*; #(
  ...
  // fuType 输出(仅本变体功能位:vldu/vstu/vsegldu/vsegstu)
  always_comb begin
    o_fu_type = '0;
