// =============================================================================
// IntToFP_3 (wrapper) —— golden 同名顶层, 端口与 golden/chisel-rtl/IntToFP_3.sv 一致。
// 机械端口适配: 全部交给可读核 xs_IntToFP_3_core u_core。
// (core 内例化 golden IntToFPDataModule; FM impl hierarchy 即 u_core/dataModule/...)
// =============================================================================
module IntToFP_3(
  input         clock,
  input         reset,
