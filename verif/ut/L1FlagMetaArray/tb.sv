...
module tb;
  ...
  L1FlagMetaArray u_g_ (.clock(clock), .reset(reset), .io_read_0_valid(io_read_0_valid), .io_read_0_bits_idx(io_read_0_bits_idx), .io_read_1_valid(io_read_1_valid), .io_read_1_bits_idx(io_read_1_bits_idx), .io_read_2_valid(io_read_2_valid), .io_read_2_bits_idx(io_read_2_bits_idx), .io_read_3_valid(io_read_3_valid), .io_read_3_bits_idx(io_read_3_bits_idx), .io_write_0_valid(io_write_0_valid), .io_write_0_bits_idx(io_write_0_bits_idx), .io_write_0_bits_way_en(io_write_0_bits_way_en), .io_write_0_bits_flag(io_write_0_bits_flag), .io_resp_0_0(g_io_resp_0_0), .io_resp_0_1(g_io_resp_0_1), .io_resp_0_2(g_io_resp_0_2), .io_resp_0_3(g_io_resp_0_3), .io_resp_1_0(g_io_resp_1_0), .io_resp_1_1(g_io_resp_1_1), .io_resp_1_2(g_io_resp_1_2), .io_resp_1_3(g_io_resp_1_3), .io_resp_2_0(g_io_resp_2_0), .io_resp_2_1(g_io_resp_2_1), .io_resp_2_2(g_io_resp_2_2), .io_resp_2_3(g_io_resp_2_3), .io_resp_3_0(g_io_resp_3_0), .io_resp_3_1(g_io_resp_3_1), .io_resp_3_2(g_io_resp_3_2), .io_resp_3_3(g_io_resp_3_3));
  L1FlagMetaArray_xs u_i_ (.clock(clock), .reset(reset), .io_read_0_valid(io_read_0_valid), .io_read_0_bits_idx(io_read_0_bits_idx), .io_read_1_valid(io_read_1_valid), .io_read_1_bits_idx(io_read_1_bits_idx), .io_read_2_valid(io_read_2_valid), .io_read_2_bits_idx(io_read_2_bits_idx), .io_read_3_valid(io_read_3_valid), .io_read_3_bits_idx(io_read_3_bits_idx), .io_write_0_valid(io_write_0_valid), .io_write_0_bits_idx(io_write_0_bits_idx), .io_write_0_bits_way_en(io_write_0_bits_way_en), .io_write_0_bits_flag(io_write_0_bits_flag), .io_resp_0_0(i_io_resp_0_0), .io_resp_0_1(i_io_resp_0_1), .io_resp_0_2(i_io_resp_0_2), .io_resp_0_3(i_io_resp_0_3), .io_resp_1_0(i_io_resp_1_0), .io_resp_1_1(i_io_resp_1_1), .io_resp_1_2(i_io_resp_1_2), .io_resp_1_3(i_io_resp_1_3), .io_resp_2_0(i_io_resp_2_0), .io_resp_2_1(i_io_resp_2_1), .io_resp_2_2(i_io_resp_2_2), .io_resp_2_3(i_io_resp_2_3), .io_resp_3_0(i_io_resp_3_0), .io_resp_3_1(i_io_resp_3_1), .io_resp_3_2(i_io_resp_3_2), .io_resp_3_3(i_io_resp_3_3));
  ...
  task automatic drive_random();
    ...
    io_write_0_bits_flag = $urandom_range(0,1);
  endtask
  initial begin
    reset = 1;
