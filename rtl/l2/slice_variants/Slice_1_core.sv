// 变体核 xs_Slice_1_core —— 由 scripts/gen_slice_variants.py 从绿基线
// xs_Slice_core 机械派生(sliceId=1, 子模块 Directory_1/DataStorage_1/
// L2Slice_1, MBIST array-id 位宽按 golden Slice_1 收窄/加宽)。勿手改。
...
module xs_Slice_1_core (
  input clock,
  input reset,
`include "slice_1_ports.svh"
);
