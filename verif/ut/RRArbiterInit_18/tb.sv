...
// RRArbiterInit_18 双例化逐拍比对: golden RRArbiterInit_18 vs 可读 RRArbiterInit_18_xs。
...
module tb;
  ...
  logic [10:0] io_in_1_bits_returnNID;
  logic io_in_1_bits_stashNIDValid;
  logic [11:0] io_in_1_bits_returnTxnID;
  ...
  logic [7:0] io_in_1_bits_lpIDWithPadding;
  logic io_in_1_bits_snoopMe;
  ...
  logic [3:0] io_in_1_bits_rsvdc;
  logic io_in_2_valid;
  logic [3:0] io_in_2_bits_qos;
  logic [11:0] io_in_2_bits_txnID;
  logic [10:0] io_in_2_bits_returnNID;
  logic io_in_2_bits_stashNIDValid;
  logic [11:0] io_in_2_bits_returnTxnID;
  logic [6:0] io_in_2_bits_opcode;
  logic [47:0] io_in_2_bits_addr;
  logic io_in_2_bits_ns;
  ...
  logic [7:0] io_in_2_bits_lpIDWithPadding;
  logic io_in_2_bits_snoopMe;
  logic io_in_2_bits_expCompAck;
  logic [1:0] io_in_2_bits_tagOp;
  logic io_in_2_bits_traceTag;
  logic io_in_2_bits_mpam_perfMonGroup;
  logic [8:0] io_in_2_bits_mpam_partID;
  logic io_in_2_bits_mpam_mpamNS;
  logic [3:0] io_in_2_bits_rsvdc;
  logic io_in_3_valid;
  logic [3:0] io_in_3_bits_qos;
  logic [11:0] io_in_3_bits_txnID;
  logic [10:0] io_in_3_bits_returnNID;
  logic io_in_3_bits_stashNIDValid;
  logic [11:0] io_in_3_bits_returnTxnID;
  logic [6:0] io_in_3_bits_opcode;
  logic [47:0] io_in_3_bits_addr;
  logic io_in_3_bits_ns;
  ...
  logic [7:0] io_in_3_bits_lpIDWithPadding;
  logic io_in_3_bits_snoopMe;
  logic io_in_3_bits_expCompAck;
  logic [1:0] io_in_3_bits_tagOp;
  logic io_in_3_bits_traceTag;
  logic io_in_3_bits_mpam_perfMonGroup;
  logic [8:0] io_in_3_bits_mpam_partID;
  logic io_in_3_bits_mpam_mpamNS;
  logic [3:0] io_in_3_bits_rsvdc;
  logic io_in_4_valid;
  logic [3:0] io_in_4_bits_qos;
  logic [10:0] io_in_4_bits_tgtID;
  logic [11:0] io_in_4_bits_txnID;
  logic [10:0] io_in_4_bits_returnNID;
  logic io_in_4_bits_stashNIDValid;
  logic [11:0] io_in_4_bits_returnTxnID;
  logic [6:0] io_in_4_bits_opcode;
  logic [2:0] io_in_4_bits_size;
  logic [47:0] io_in_4_bits_addr;
  logic io_in_4_bits_ns;
  ...
  logic io_in_4_bits_snpAttr;
  logic [7:0] io_in_4_bits_lpIDWithPadding;
  logic io_in_4_bits_snoopMe;
  logic io_in_4_bits_expCompAck;
  logic [1:0] io_in_4_bits_tagOp;
  logic io_in_4_bits_traceTag;
  logic io_in_4_bits_mpam_perfMonGroup;
  logic [8:0] io_in_4_bits_mpam_partID;
  logic io_in_4_bits_mpam_mpamNS;
  ...
  wire [2:0] g_io_chosen;
  wire [2:0] i_io_chosen;

  RRArbiterInit_18 u_g (
    .clock(clock),
    .reset(reset),
  ...
  task automatic drive_random_inputs();
    ...
    io_in_1_bits_returnNID <= 11'({$urandom});
    io_in_1_bits_stashNIDValid <= $urandom_range(0, 1);
    io_in_1_bits_returnTxnID <= 12'({$urandom});
    ...
    io_in_1_bits_lpIDWithPadding <= 8'({$urandom});
    io_in_1_bits_snoopMe <= $urandom_range(0, 1);
    ...
    io_in_1_bits_rsvdc <= 4'({$urandom});
    io_in_2_valid <= $urandom_range(0, 1);
    io_in_2_bits_qos <= 4'({$urandom});
    io_in_2_bits_txnID <= 12'({$urandom});
    io_in_2_bits_returnNID <= 11'({$urandom});
    io_in_2_bits_stashNIDValid <= $urandom_range(0, 1);
    io_in_2_bits_returnTxnID <= 12'({$urandom});
    io_in_2_bits_opcode <= 7'({$urandom});
    io_in_2_bits_addr <= 48'({$urandom, $urandom});
    io_in_2_bits_ns <= $urandom_range(0, 1);
    ...
    io_in_2_bits_lpIDWithPadding <= 8'({$urandom});
    io_in_2_bits_snoopMe <= $urandom_range(0, 1);
    io_in_2_bits_expCompAck <= $urandom_range(0, 1);
    io_in_2_bits_tagOp <= 2'({$urandom});
    io_in_2_bits_traceTag <= $urandom_range(0, 1);
    io_in_2_bits_mpam_perfMonGroup <= $urandom_range(0, 1);
    io_in_2_bits_mpam_partID <= 9'({$urandom});
    io_in_2_bits_mpam_mpamNS <= $urandom_range(0, 1);
    io_in_2_bits_rsvdc <= 4'({$urandom});
    io_in_3_valid <= $urandom_range(0, 1);
    io_in_3_bits_qos <= 4'({$urandom});
    io_in_3_bits_txnID <= 12'({$urandom});
    io_in_3_bits_returnNID <= 11'({$urandom});
    io_in_3_bits_stashNIDValid <= $urandom_range(0, 1);
    io_in_3_bits_returnTxnID <= 12'({$urandom});
    io_in_3_bits_opcode <= 7'({$urandom});
    io_in_3_bits_addr <= 48'({$urandom, $urandom});
    io_in_3_bits_ns <= $urandom_range(0, 1);
    ...
    io_in_3_bits_lpIDWithPadding <= 8'({$urandom});
    io_in_3_bits_snoopMe <= $urandom_range(0, 1);
    io_in_3_bits_expCompAck <= $urandom_range(0, 1);
    io_in_3_bits_tagOp <= 2'({$urandom});
    io_in_3_bits_traceTag <= $urandom_range(0, 1);
    io_in_3_bits_mpam_perfMonGroup <= $urandom_range(0, 1);
    io_in_3_bits_mpam_partID <= 9'({$urandom});
    io_in_3_bits_mpam_mpamNS <= $urandom_range(0, 1);
    io_in_3_bits_rsvdc <= 4'({$urandom});
    io_in_4_valid <= $urandom_range(0, 1);
    io_in_4_bits_qos <= 4'({$urandom});
    io_in_4_bits_tgtID <= 11'({$urandom});
    io_in_4_bits_txnID <= 12'({$urandom});
    io_in_4_bits_returnNID <= 11'({$urandom});
    io_in_4_bits_stashNIDValid <= $urandom_range(0, 1);
    io_in_4_bits_returnTxnID <= 12'({$urandom});
    io_in_4_bits_opcode <= 7'({$urandom});
    io_in_4_bits_size <= 3'({$urandom});
    io_in_4_bits_addr <= 48'({$urandom, $urandom});
    io_in_4_bits_ns <= $urandom_range(0, 1);
    ...
    io_in_4_bits_snpAttr <= $urandom_range(0, 1);
    io_in_4_bits_lpIDWithPadding <= 8'({$urandom});
    io_in_4_bits_snoopMe <= $urandom_range(0, 1);
    io_in_4_bits_expCompAck <= $urandom_range(0, 1);
    io_in_4_bits_tagOp <= 2'({$urandom});
    io_in_4_bits_traceTag <= $urandom_range(0, 1);
    io_in_4_bits_mpam_perfMonGroup <= $urandom_range(0, 1);
    io_in_4_bits_mpam_partID <= 9'({$urandom});
    io_in_4_bits_mpam_mpamNS <= $urandom_range(0, 1);
  ...
  initial begin
    ...
    io_in_1_bits_returnNID = '0;
    io_in_1_bits_stashNIDValid = '0;
    io_in_1_bits_returnTxnID = '0;
    ...
    io_in_1_bits_lpIDWithPadding = '0;
    io_in_1_bits_snoopMe = '0;
    ...
    io_in_1_bits_rsvdc = '0;
    io_in_2_valid = '0;
    io_in_2_bits_qos = '0;
    io_in_2_bits_txnID = '0;
    io_in_2_bits_returnNID = '0;
    io_in_2_bits_stashNIDValid = '0;
    io_in_2_bits_returnTxnID = '0;
    ...
    io_in_2_bits_lpIDWithPadding = '0;
    io_in_2_bits_snoopMe = '0;
    io_in_2_bits_expCompAck = '0;
    io_in_2_bits_tagOp = '0;
    io_in_2_bits_traceTag = '0;
    io_in_2_bits_mpam_perfMonGroup = '0;
    io_in_2_bits_mpam_partID = '0;
    io_in_2_bits_mpam_mpamNS = '0;
    io_in_2_bits_rsvdc = '0;
    io_in_3_valid = '0;
    io_in_3_bits_qos = '0;
    io_in_3_bits_txnID = '0;
    io_in_3_bits_returnNID = '0;
    io_in_3_bits_stashNIDValid = '0;
    io_in_3_bits_returnTxnID = '0;
    ...
    io_in_3_bits_lpIDWithPadding = '0;
    io_in_3_bits_snoopMe = '0;
    io_in_3_bits_expCompAck = '0;
    io_in_3_bits_tagOp = '0;
    io_in_3_bits_traceTag = '0;
    io_in_3_bits_mpam_perfMonGroup = '0;
    io_in_3_bits_mpam_partID = '0;
    io_in_3_bits_mpam_mpamNS = '0;
    io_in_3_bits_rsvdc = '0;
    io_in_4_valid = '0;
    io_in_4_bits_qos = '0;
    io_in_4_bits_tgtID = '0;
    io_in_4_bits_txnID = '0;
    io_in_4_bits_returnNID = '0;
    io_in_4_bits_stashNIDValid = '0;
    io_in_4_bits_returnTxnID = '0;
    ...
    io_in_4_bits_snpAttr = '0;
    io_in_4_bits_lpIDWithPadding = '0;
    io_in_4_bits_snoopMe = '0;
    io_in_4_bits_expCompAck = '0;
    io_in_4_bits_tagOp = '0;
    io_in_4_bits_traceTag = '0;
    io_in_4_bits_mpam_perfMonGroup = '0;
    io_in_4_bits_mpam_partID = '0;
    io_in_4_bits_mpam_mpamNS = '0;
    ...
    $display("RRArbiterInit_18 checks=%0d errors=%0d", checks, errors);
