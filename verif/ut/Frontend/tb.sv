// 自动生成：scripts/gen_frontend.py —— 勿手改
`timescale 1ns/1ps
module tb;
  ...
  always @(negedge clk) if (!rst) begin
    ...
    if (!$isunknown(g_auto_inner_icache_ctrlUnitOpt_in_a_ready) && (g_auto_inner_icache_ctrlUnitOpt_in_a_ready !== i_auto_inner_icache_ctrlUnitOpt_in_a_ready)) begin errors++;
      if(errors<=60) $display("[%0t] auto_inner_icache_ctrlUnitOpt_in_a_ready g=%h i=%h", $time, g_auto_inner_icache_ctrlUnitOpt_in_a_ready, i_auto_inner_icache_ctrlUnitOpt_in_a_ready); end
    if (!$isunknown(g_auto_inner_icache_ctrlUnitOpt_in_d_valid) && (g_auto_inner_icache_ctrlUnitOpt_in_d_valid !== i_auto_inner_icache_ctrlUnitOpt_in_d_valid)) begin errors++;
      if(errors<=60) $display("[%0t] auto_inner_icache_ctrlUnitOpt_in_d_valid g=%h i=%h", $time, g_auto_inner_icache_ctrlUnitOpt_in_d_valid, i_auto_inner_icache_ctrlUnitOpt_in_d_valid); end
    if (!$isunknown(g_auto_inner_icache_ctrlUnitOpt_in_d_bits_opcode) && (g_auto_inner_icache_ctrlUnitOpt_in_d_bits_opcode !== i_auto_inner_icache_ctrlUnitOpt_in_d_bits_opcode)) begin errors++;
      if(errors<=60) $display("[%0t] auto_inner_icache_ctrlUnitOpt_in_d_bits_opcode g=%h i=%h", $time, g_auto_inner_icache_ctrlUnitOpt_in_d_bits_opcode, i_auto_inner_icache_ctrlUnitOpt_in_d_bits_opcode); end
    if (!$isunknown(g_auto_inner_icache_ctrlUnitOpt_in_d_bits_size) && (g_auto_inner_icache_ctrlUnitOpt_in_d_bits_size !== i_auto_inner_icache_ctrlUnitOpt_in_d_bits_size)) begin errors++;
      if(errors<=60) $display("[%0t] auto_inner_icache_ctrlUnitOpt_in_d_bits_size g=%h i=%h", $time, g_auto_inner_icache_ctrlUnitOpt_in_d_bits_size, i_auto_inner_icache_ctrlUnitOpt_in_d_bits_size); end
    if (!$isunknown(g_auto_inner_icache_ctrlUnitOpt_in_d_bits_source) && (g_auto_inner_icache_ctrlUnitOpt_in_d_bits_source !== i_auto_inner_icache_ctrlUnitOpt_in_d_bits_source)) begin errors++;
      if(errors<=60) $display("[%0t] auto_inner_icache_ctrlUnitOpt_in_d_bits_source g=%h i=%h", $time, g_auto_inner_icache_ctrlUnitOpt_in_d_bits_source, i_auto_inner_icache_ctrlUnitOpt_in_d_bits_source); end
    if (!$isunknown(g_auto_inner_icache_ctrlUnitOpt_in_d_bits_data) && (g_auto_inner_icache_ctrlUnitOpt_in_d_bits_data !== i_auto_inner_icache_ctrlUnitOpt_in_d_bits_data)) begin errors++;
      if(errors<=60) $display("[%0t] auto_inner_icache_ctrlUnitOpt_in_d_bits_data g=%h i=%h", $time, g_auto_inner_icache_ctrlUnitOpt_in_d_bits_data, i_auto_inner_icache_ctrlUnitOpt_in_d_bits_data); end
    if (!$isunknown(g_auto_inner_icache_client_out_a_valid) && (g_auto_inner_icache_client_out_a_valid !== i_auto_inner_icache_client_out_a_valid)) begin errors++;
      if(errors<=60) $display("[%0t] auto_inner_icache_client_out_a_valid g=%h i=%h", $time, g_auto_inner_icache_client_out_a_valid, i_auto_inner_icache_client_out_a_valid); end
    if (!$isunknown(g_auto_inner_icache_client_out_a_bits_source) && (g_auto_inner_icache_client_out_a_bits_source !== i_auto_inner_icache_client_out_a_bits_source)) begin errors++;
      if(errors<=60) $display("[%0t] auto_inner_icache_client_out_a_bits_source g=%h i=%h", $time, g_auto_inner_icache_client_out_a_bits_source, i_auto_inner_icache_client_out_a_bits_source); end
    if (!$isunknown(g_auto_inner_icache_client_out_a_bits_address) && (g_auto_inner_icache_client_out_a_bits_address !== i_auto_inner_icache_client_out_a_bits_address)) begin errors++;
      if(errors<=60) $display("[%0t] auto_inner_icache_client_out_a_bits_address g=%h i=%h", $time, g_auto_inner_icache_client_out_a_bits_address, i_auto_inner_icache_client_out_a_bits_address); end
    if (!$isunknown(g_auto_inner_instrUncache_client_out_a_valid) && (g_auto_inner_instrUncache_client_out_a_valid !== i_auto_inner_instrUncache_client_out_a_valid)) begin errors++;
      if(errors<=60) $display("[%0t] auto_inner_instrUncache_client_out_a_valid g=%h i=%h", $time, g_auto_inner_instrUncache_client_out_a_valid, i_auto_inner_instrUncache_client_out_a_valid); end
    if (!$isunknown(g_auto_inner_instrUncache_client_out_a_bits_address) && (g_auto_inner_instrUncache_client_out_a_bits_address !== i_auto_inner_instrUncache_client_out_a_bits_address)) begin errors++;
      if(errors<=60) $display("[%0t] auto_inner_instrUncache_client_out_a_bits_address g=%h i=%h", $time, g_auto_inner_instrUncache_client_out_a_bits_address, i_auto_inner_instrUncache_client_out_a_bits_address); end
    if (!$isunknown(g_io_ptw_req_0_valid) && (g_io_ptw_req_0_valid !== i_io_ptw_req_0_valid)) begin errors++;
      if(errors<=60) $display("[%0t] io_ptw_req_0_valid g=%h i=%h", $time, g_io_ptw_req_0_valid, i_io_ptw_req_0_valid); end
    if (!$isunknown(g_io_ptw_req_0_bits_vpn) && (g_io_ptw_req_0_bits_vpn !== i_io_ptw_req_0_bits_vpn)) begin errors++;
      if(errors<=60) $display("[%0t] io_ptw_req_0_bits_vpn g=%h i=%h", $time, g_io_ptw_req_0_bits_vpn, i_io_ptw_req_0_bits_vpn); end
    if (!$isunknown(g_io_ptw_req_0_bits_s2xlate) && (g_io_ptw_req_0_bits_s2xlate !== i_io_ptw_req_0_bits_s2xlate)) begin errors++;
      if(errors<=60) $display("[%0t] io_ptw_req_0_bits_s2xlate g=%h i=%h", $time, g_io_ptw_req_0_bits_s2xlate, i_io_ptw_req_0_bits_s2xlate); end
    if (!$isunknown(g_io_ptw_resp_ready) && (g_io_ptw_resp_ready !== i_io_ptw_resp_ready)) begin errors++;
      if(errors<=60) $display("[%0t] io_ptw_resp_ready g=%h i=%h", $time, g_io_ptw_resp_ready, i_io_ptw_resp_ready); end
    if (!$isunknown(g_io_backend_cfVec_0_valid) && (g_io_backend_cfVec_0_valid !== i_io_backend_cfVec_0_valid)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_valid g=%h i=%h", $time, g_io_backend_cfVec_0_valid, i_io_backend_cfVec_0_valid); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_instr) && (g_io_backend_cfVec_0_bits_instr !== i_io_backend_cfVec_0_bits_instr)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_instr g=%h i=%h", $time, g_io_backend_cfVec_0_bits_instr, i_io_backend_cfVec_0_bits_instr); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_foldpc) && (g_io_backend_cfVec_0_bits_foldpc !== i_io_backend_cfVec_0_bits_foldpc)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_foldpc g=%h i=%h", $time, g_io_backend_cfVec_0_bits_foldpc, i_io_backend_cfVec_0_bits_foldpc); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_exceptionVec_1) && (g_io_backend_cfVec_0_bits_exceptionVec_1 !== i_io_backend_cfVec_0_bits_exceptionVec_1)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_exceptionVec_1 g=%h i=%h", $time, g_io_backend_cfVec_0_bits_exceptionVec_1, i_io_backend_cfVec_0_bits_exceptionVec_1); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_exceptionVec_2) && (g_io_backend_cfVec_0_bits_exceptionVec_2 !== i_io_backend_cfVec_0_bits_exceptionVec_2)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_exceptionVec_2 g=%h i=%h", $time, g_io_backend_cfVec_0_bits_exceptionVec_2, i_io_backend_cfVec_0_bits_exceptionVec_2); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_exceptionVec_12) && (g_io_backend_cfVec_0_bits_exceptionVec_12 !== i_io_backend_cfVec_0_bits_exceptionVec_12)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_exceptionVec_12 g=%h i=%h", $time, g_io_backend_cfVec_0_bits_exceptionVec_12, i_io_backend_cfVec_0_bits_exceptionVec_12); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_exceptionVec_20) && (g_io_backend_cfVec_0_bits_exceptionVec_20 !== i_io_backend_cfVec_0_bits_exceptionVec_20)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_exceptionVec_20 g=%h i=%h", $time, g_io_backend_cfVec_0_bits_exceptionVec_20, i_io_backend_cfVec_0_bits_exceptionVec_20); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_backendException) && (g_io_backend_cfVec_0_bits_backendException !== i_io_backend_cfVec_0_bits_backendException)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_backendException g=%h i=%h", $time, g_io_backend_cfVec_0_bits_backendException, i_io_backend_cfVec_0_bits_backendException); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_trigger) && (g_io_backend_cfVec_0_bits_trigger !== i_io_backend_cfVec_0_bits_trigger)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_trigger g=%h i=%h", $time, g_io_backend_cfVec_0_bits_trigger, i_io_backend_cfVec_0_bits_trigger); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_pd_isRVC) && (g_io_backend_cfVec_0_bits_pd_isRVC !== i_io_backend_cfVec_0_bits_pd_isRVC)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_pd_isRVC g=%h i=%h", $time, g_io_backend_cfVec_0_bits_pd_isRVC, i_io_backend_cfVec_0_bits_pd_isRVC); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_pd_brType) && (g_io_backend_cfVec_0_bits_pd_brType !== i_io_backend_cfVec_0_bits_pd_brType)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_pd_brType g=%h i=%h", $time, g_io_backend_cfVec_0_bits_pd_brType, i_io_backend_cfVec_0_bits_pd_brType); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_pred_taken) && (g_io_backend_cfVec_0_bits_pred_taken !== i_io_backend_cfVec_0_bits_pred_taken)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_pred_taken g=%h i=%h", $time, g_io_backend_cfVec_0_bits_pred_taken, i_io_backend_cfVec_0_bits_pred_taken); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_crossPageIPFFix) && (g_io_backend_cfVec_0_bits_crossPageIPFFix !== i_io_backend_cfVec_0_bits_crossPageIPFFix)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_crossPageIPFFix g=%h i=%h", $time, g_io_backend_cfVec_0_bits_crossPageIPFFix, i_io_backend_cfVec_0_bits_crossPageIPFFix); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_ftqPtr_flag) && (g_io_backend_cfVec_0_bits_ftqPtr_flag !== i_io_backend_cfVec_0_bits_ftqPtr_flag)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_ftqPtr_flag g=%h i=%h", $time, g_io_backend_cfVec_0_bits_ftqPtr_flag, i_io_backend_cfVec_0_bits_ftqPtr_flag); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_ftqPtr_value) && (g_io_backend_cfVec_0_bits_ftqPtr_value !== i_io_backend_cfVec_0_bits_ftqPtr_value)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_ftqPtr_value g=%h i=%h", $time, g_io_backend_cfVec_0_bits_ftqPtr_value, i_io_backend_cfVec_0_bits_ftqPtr_value); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_ftqOffset) && (g_io_backend_cfVec_0_bits_ftqOffset !== i_io_backend_cfVec_0_bits_ftqOffset)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_ftqOffset g=%h i=%h", $time, g_io_backend_cfVec_0_bits_ftqOffset, i_io_backend_cfVec_0_bits_ftqOffset); end
    if (!$isunknown(g_io_backend_cfVec_0_bits_isLastInFtqEntry) && (g_io_backend_cfVec_0_bits_isLastInFtqEntry !== i_io_backend_cfVec_0_bits_isLastInFtqEntry)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_0_bits_isLastInFtqEntry g=%h i=%h", $time, g_io_backend_cfVec_0_bits_isLastInFtqEntry, i_io_backend_cfVec_0_bits_isLastInFtqEntry); end
    if (!$isunknown(g_io_backend_cfVec_1_valid) && (g_io_backend_cfVec_1_valid !== i_io_backend_cfVec_1_valid)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_valid g=%h i=%h", $time, g_io_backend_cfVec_1_valid, i_io_backend_cfVec_1_valid); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_instr) && (g_io_backend_cfVec_1_bits_instr !== i_io_backend_cfVec_1_bits_instr)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_instr g=%h i=%h", $time, g_io_backend_cfVec_1_bits_instr, i_io_backend_cfVec_1_bits_instr); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_foldpc) && (g_io_backend_cfVec_1_bits_foldpc !== i_io_backend_cfVec_1_bits_foldpc)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_foldpc g=%h i=%h", $time, g_io_backend_cfVec_1_bits_foldpc, i_io_backend_cfVec_1_bits_foldpc); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_exceptionVec_1) && (g_io_backend_cfVec_1_bits_exceptionVec_1 !== i_io_backend_cfVec_1_bits_exceptionVec_1)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_exceptionVec_1 g=%h i=%h", $time, g_io_backend_cfVec_1_bits_exceptionVec_1, i_io_backend_cfVec_1_bits_exceptionVec_1); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_exceptionVec_2) && (g_io_backend_cfVec_1_bits_exceptionVec_2 !== i_io_backend_cfVec_1_bits_exceptionVec_2)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_exceptionVec_2 g=%h i=%h", $time, g_io_backend_cfVec_1_bits_exceptionVec_2, i_io_backend_cfVec_1_bits_exceptionVec_2); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_exceptionVec_12) && (g_io_backend_cfVec_1_bits_exceptionVec_12 !== i_io_backend_cfVec_1_bits_exceptionVec_12)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_exceptionVec_12 g=%h i=%h", $time, g_io_backend_cfVec_1_bits_exceptionVec_12, i_io_backend_cfVec_1_bits_exceptionVec_12); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_exceptionVec_20) && (g_io_backend_cfVec_1_bits_exceptionVec_20 !== i_io_backend_cfVec_1_bits_exceptionVec_20)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_exceptionVec_20 g=%h i=%h", $time, g_io_backend_cfVec_1_bits_exceptionVec_20, i_io_backend_cfVec_1_bits_exceptionVec_20); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_backendException) && (g_io_backend_cfVec_1_bits_backendException !== i_io_backend_cfVec_1_bits_backendException)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_backendException g=%h i=%h", $time, g_io_backend_cfVec_1_bits_backendException, i_io_backend_cfVec_1_bits_backendException); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_trigger) && (g_io_backend_cfVec_1_bits_trigger !== i_io_backend_cfVec_1_bits_trigger)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_trigger g=%h i=%h", $time, g_io_backend_cfVec_1_bits_trigger, i_io_backend_cfVec_1_bits_trigger); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_pd_isRVC) && (g_io_backend_cfVec_1_bits_pd_isRVC !== i_io_backend_cfVec_1_bits_pd_isRVC)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_pd_isRVC g=%h i=%h", $time, g_io_backend_cfVec_1_bits_pd_isRVC, i_io_backend_cfVec_1_bits_pd_isRVC); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_pd_brType) && (g_io_backend_cfVec_1_bits_pd_brType !== i_io_backend_cfVec_1_bits_pd_brType)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_pd_brType g=%h i=%h", $time, g_io_backend_cfVec_1_bits_pd_brType, i_io_backend_cfVec_1_bits_pd_brType); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_pred_taken) && (g_io_backend_cfVec_1_bits_pred_taken !== i_io_backend_cfVec_1_bits_pred_taken)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_pred_taken g=%h i=%h", $time, g_io_backend_cfVec_1_bits_pred_taken, i_io_backend_cfVec_1_bits_pred_taken); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_crossPageIPFFix) && (g_io_backend_cfVec_1_bits_crossPageIPFFix !== i_io_backend_cfVec_1_bits_crossPageIPFFix)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_crossPageIPFFix g=%h i=%h", $time, g_io_backend_cfVec_1_bits_crossPageIPFFix, i_io_backend_cfVec_1_bits_crossPageIPFFix); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_ftqPtr_flag) && (g_io_backend_cfVec_1_bits_ftqPtr_flag !== i_io_backend_cfVec_1_bits_ftqPtr_flag)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_ftqPtr_flag g=%h i=%h", $time, g_io_backend_cfVec_1_bits_ftqPtr_flag, i_io_backend_cfVec_1_bits_ftqPtr_flag); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_ftqPtr_value) && (g_io_backend_cfVec_1_bits_ftqPtr_value !== i_io_backend_cfVec_1_bits_ftqPtr_value)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_ftqPtr_value g=%h i=%h", $time, g_io_backend_cfVec_1_bits_ftqPtr_value, i_io_backend_cfVec_1_bits_ftqPtr_value); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_ftqOffset) && (g_io_backend_cfVec_1_bits_ftqOffset !== i_io_backend_cfVec_1_bits_ftqOffset)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_ftqOffset g=%h i=%h", $time, g_io_backend_cfVec_1_bits_ftqOffset, i_io_backend_cfVec_1_bits_ftqOffset); end
    if (!$isunknown(g_io_backend_cfVec_1_bits_isLastInFtqEntry) && (g_io_backend_cfVec_1_bits_isLastInFtqEntry !== i_io_backend_cfVec_1_bits_isLastInFtqEntry)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_1_bits_isLastInFtqEntry g=%h i=%h", $time, g_io_backend_cfVec_1_bits_isLastInFtqEntry, i_io_backend_cfVec_1_bits_isLastInFtqEntry); end
    if (!$isunknown(g_io_backend_cfVec_2_valid) && (g_io_backend_cfVec_2_valid !== i_io_backend_cfVec_2_valid)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_valid g=%h i=%h", $time, g_io_backend_cfVec_2_valid, i_io_backend_cfVec_2_valid); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_instr) && (g_io_backend_cfVec_2_bits_instr !== i_io_backend_cfVec_2_bits_instr)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_instr g=%h i=%h", $time, g_io_backend_cfVec_2_bits_instr, i_io_backend_cfVec_2_bits_instr); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_foldpc) && (g_io_backend_cfVec_2_bits_foldpc !== i_io_backend_cfVec_2_bits_foldpc)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_foldpc g=%h i=%h", $time, g_io_backend_cfVec_2_bits_foldpc, i_io_backend_cfVec_2_bits_foldpc); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_exceptionVec_1) && (g_io_backend_cfVec_2_bits_exceptionVec_1 !== i_io_backend_cfVec_2_bits_exceptionVec_1)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_exceptionVec_1 g=%h i=%h", $time, g_io_backend_cfVec_2_bits_exceptionVec_1, i_io_backend_cfVec_2_bits_exceptionVec_1); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_exceptionVec_2) && (g_io_backend_cfVec_2_bits_exceptionVec_2 !== i_io_backend_cfVec_2_bits_exceptionVec_2)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_exceptionVec_2 g=%h i=%h", $time, g_io_backend_cfVec_2_bits_exceptionVec_2, i_io_backend_cfVec_2_bits_exceptionVec_2); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_exceptionVec_12) && (g_io_backend_cfVec_2_bits_exceptionVec_12 !== i_io_backend_cfVec_2_bits_exceptionVec_12)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_exceptionVec_12 g=%h i=%h", $time, g_io_backend_cfVec_2_bits_exceptionVec_12, i_io_backend_cfVec_2_bits_exceptionVec_12); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_exceptionVec_20) && (g_io_backend_cfVec_2_bits_exceptionVec_20 !== i_io_backend_cfVec_2_bits_exceptionVec_20)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_exceptionVec_20 g=%h i=%h", $time, g_io_backend_cfVec_2_bits_exceptionVec_20, i_io_backend_cfVec_2_bits_exceptionVec_20); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_backendException) && (g_io_backend_cfVec_2_bits_backendException !== i_io_backend_cfVec_2_bits_backendException)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_backendException g=%h i=%h", $time, g_io_backend_cfVec_2_bits_backendException, i_io_backend_cfVec_2_bits_backendException); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_trigger) && (g_io_backend_cfVec_2_bits_trigger !== i_io_backend_cfVec_2_bits_trigger)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_trigger g=%h i=%h", $time, g_io_backend_cfVec_2_bits_trigger, i_io_backend_cfVec_2_bits_trigger); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_pd_isRVC) && (g_io_backend_cfVec_2_bits_pd_isRVC !== i_io_backend_cfVec_2_bits_pd_isRVC)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_pd_isRVC g=%h i=%h", $time, g_io_backend_cfVec_2_bits_pd_isRVC, i_io_backend_cfVec_2_bits_pd_isRVC); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_pd_brType) && (g_io_backend_cfVec_2_bits_pd_brType !== i_io_backend_cfVec_2_bits_pd_brType)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_pd_brType g=%h i=%h", $time, g_io_backend_cfVec_2_bits_pd_brType, i_io_backend_cfVec_2_bits_pd_brType); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_pred_taken) && (g_io_backend_cfVec_2_bits_pred_taken !== i_io_backend_cfVec_2_bits_pred_taken)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_pred_taken g=%h i=%h", $time, g_io_backend_cfVec_2_bits_pred_taken, i_io_backend_cfVec_2_bits_pred_taken); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_crossPageIPFFix) && (g_io_backend_cfVec_2_bits_crossPageIPFFix !== i_io_backend_cfVec_2_bits_crossPageIPFFix)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_crossPageIPFFix g=%h i=%h", $time, g_io_backend_cfVec_2_bits_crossPageIPFFix, i_io_backend_cfVec_2_bits_crossPageIPFFix); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_ftqPtr_flag) && (g_io_backend_cfVec_2_bits_ftqPtr_flag !== i_io_backend_cfVec_2_bits_ftqPtr_flag)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_ftqPtr_flag g=%h i=%h", $time, g_io_backend_cfVec_2_bits_ftqPtr_flag, i_io_backend_cfVec_2_bits_ftqPtr_flag); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_ftqPtr_value) && (g_io_backend_cfVec_2_bits_ftqPtr_value !== i_io_backend_cfVec_2_bits_ftqPtr_value)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_ftqPtr_value g=%h i=%h", $time, g_io_backend_cfVec_2_bits_ftqPtr_value, i_io_backend_cfVec_2_bits_ftqPtr_value); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_ftqOffset) && (g_io_backend_cfVec_2_bits_ftqOffset !== i_io_backend_cfVec_2_bits_ftqOffset)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_ftqOffset g=%h i=%h", $time, g_io_backend_cfVec_2_bits_ftqOffset, i_io_backend_cfVec_2_bits_ftqOffset); end
    if (!$isunknown(g_io_backend_cfVec_2_bits_isLastInFtqEntry) && (g_io_backend_cfVec_2_bits_isLastInFtqEntry !== i_io_backend_cfVec_2_bits_isLastInFtqEntry)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_2_bits_isLastInFtqEntry g=%h i=%h", $time, g_io_backend_cfVec_2_bits_isLastInFtqEntry, i_io_backend_cfVec_2_bits_isLastInFtqEntry); end
    if (!$isunknown(g_io_backend_cfVec_3_valid) && (g_io_backend_cfVec_3_valid !== i_io_backend_cfVec_3_valid)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_valid g=%h i=%h", $time, g_io_backend_cfVec_3_valid, i_io_backend_cfVec_3_valid); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_instr) && (g_io_backend_cfVec_3_bits_instr !== i_io_backend_cfVec_3_bits_instr)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_instr g=%h i=%h", $time, g_io_backend_cfVec_3_bits_instr, i_io_backend_cfVec_3_bits_instr); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_foldpc) && (g_io_backend_cfVec_3_bits_foldpc !== i_io_backend_cfVec_3_bits_foldpc)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_foldpc g=%h i=%h", $time, g_io_backend_cfVec_3_bits_foldpc, i_io_backend_cfVec_3_bits_foldpc); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_exceptionVec_1) && (g_io_backend_cfVec_3_bits_exceptionVec_1 !== i_io_backend_cfVec_3_bits_exceptionVec_1)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_exceptionVec_1 g=%h i=%h", $time, g_io_backend_cfVec_3_bits_exceptionVec_1, i_io_backend_cfVec_3_bits_exceptionVec_1); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_exceptionVec_2) && (g_io_backend_cfVec_3_bits_exceptionVec_2 !== i_io_backend_cfVec_3_bits_exceptionVec_2)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_exceptionVec_2 g=%h i=%h", $time, g_io_backend_cfVec_3_bits_exceptionVec_2, i_io_backend_cfVec_3_bits_exceptionVec_2); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_exceptionVec_12) && (g_io_backend_cfVec_3_bits_exceptionVec_12 !== i_io_backend_cfVec_3_bits_exceptionVec_12)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_exceptionVec_12 g=%h i=%h", $time, g_io_backend_cfVec_3_bits_exceptionVec_12, i_io_backend_cfVec_3_bits_exceptionVec_12); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_exceptionVec_20) && (g_io_backend_cfVec_3_bits_exceptionVec_20 !== i_io_backend_cfVec_3_bits_exceptionVec_20)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_exceptionVec_20 g=%h i=%h", $time, g_io_backend_cfVec_3_bits_exceptionVec_20, i_io_backend_cfVec_3_bits_exceptionVec_20); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_backendException) && (g_io_backend_cfVec_3_bits_backendException !== i_io_backend_cfVec_3_bits_backendException)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_backendException g=%h i=%h", $time, g_io_backend_cfVec_3_bits_backendException, i_io_backend_cfVec_3_bits_backendException); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_trigger) && (g_io_backend_cfVec_3_bits_trigger !== i_io_backend_cfVec_3_bits_trigger)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_trigger g=%h i=%h", $time, g_io_backend_cfVec_3_bits_trigger, i_io_backend_cfVec_3_bits_trigger); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_pd_isRVC) && (g_io_backend_cfVec_3_bits_pd_isRVC !== i_io_backend_cfVec_3_bits_pd_isRVC)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_pd_isRVC g=%h i=%h", $time, g_io_backend_cfVec_3_bits_pd_isRVC, i_io_backend_cfVec_3_bits_pd_isRVC); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_pd_brType) && (g_io_backend_cfVec_3_bits_pd_brType !== i_io_backend_cfVec_3_bits_pd_brType)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_pd_brType g=%h i=%h", $time, g_io_backend_cfVec_3_bits_pd_brType, i_io_backend_cfVec_3_bits_pd_brType); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_pred_taken) && (g_io_backend_cfVec_3_bits_pred_taken !== i_io_backend_cfVec_3_bits_pred_taken)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_pred_taken g=%h i=%h", $time, g_io_backend_cfVec_3_bits_pred_taken, i_io_backend_cfVec_3_bits_pred_taken); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_crossPageIPFFix) && (g_io_backend_cfVec_3_bits_crossPageIPFFix !== i_io_backend_cfVec_3_bits_crossPageIPFFix)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_crossPageIPFFix g=%h i=%h", $time, g_io_backend_cfVec_3_bits_crossPageIPFFix, i_io_backend_cfVec_3_bits_crossPageIPFFix); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_ftqPtr_flag) && (g_io_backend_cfVec_3_bits_ftqPtr_flag !== i_io_backend_cfVec_3_bits_ftqPtr_flag)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_ftqPtr_flag g=%h i=%h", $time, g_io_backend_cfVec_3_bits_ftqPtr_flag, i_io_backend_cfVec_3_bits_ftqPtr_flag); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_ftqPtr_value) && (g_io_backend_cfVec_3_bits_ftqPtr_value !== i_io_backend_cfVec_3_bits_ftqPtr_value)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_ftqPtr_value g=%h i=%h", $time, g_io_backend_cfVec_3_bits_ftqPtr_value, i_io_backend_cfVec_3_bits_ftqPtr_value); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_ftqOffset) && (g_io_backend_cfVec_3_bits_ftqOffset !== i_io_backend_cfVec_3_bits_ftqOffset)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_ftqOffset g=%h i=%h", $time, g_io_backend_cfVec_3_bits_ftqOffset, i_io_backend_cfVec_3_bits_ftqOffset); end
    if (!$isunknown(g_io_backend_cfVec_3_bits_isLastInFtqEntry) && (g_io_backend_cfVec_3_bits_isLastInFtqEntry !== i_io_backend_cfVec_3_bits_isLastInFtqEntry)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_3_bits_isLastInFtqEntry g=%h i=%h", $time, g_io_backend_cfVec_3_bits_isLastInFtqEntry, i_io_backend_cfVec_3_bits_isLastInFtqEntry); end
    if (!$isunknown(g_io_backend_cfVec_4_valid) && (g_io_backend_cfVec_4_valid !== i_io_backend_cfVec_4_valid)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_valid g=%h i=%h", $time, g_io_backend_cfVec_4_valid, i_io_backend_cfVec_4_valid); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_instr) && (g_io_backend_cfVec_4_bits_instr !== i_io_backend_cfVec_4_bits_instr)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_instr g=%h i=%h", $time, g_io_backend_cfVec_4_bits_instr, i_io_backend_cfVec_4_bits_instr); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_foldpc) && (g_io_backend_cfVec_4_bits_foldpc !== i_io_backend_cfVec_4_bits_foldpc)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_foldpc g=%h i=%h", $time, g_io_backend_cfVec_4_bits_foldpc, i_io_backend_cfVec_4_bits_foldpc); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_exceptionVec_1) && (g_io_backend_cfVec_4_bits_exceptionVec_1 !== i_io_backend_cfVec_4_bits_exceptionVec_1)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_exceptionVec_1 g=%h i=%h", $time, g_io_backend_cfVec_4_bits_exceptionVec_1, i_io_backend_cfVec_4_bits_exceptionVec_1); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_exceptionVec_2) && (g_io_backend_cfVec_4_bits_exceptionVec_2 !== i_io_backend_cfVec_4_bits_exceptionVec_2)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_exceptionVec_2 g=%h i=%h", $time, g_io_backend_cfVec_4_bits_exceptionVec_2, i_io_backend_cfVec_4_bits_exceptionVec_2); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_exceptionVec_12) && (g_io_backend_cfVec_4_bits_exceptionVec_12 !== i_io_backend_cfVec_4_bits_exceptionVec_12)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_exceptionVec_12 g=%h i=%h", $time, g_io_backend_cfVec_4_bits_exceptionVec_12, i_io_backend_cfVec_4_bits_exceptionVec_12); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_exceptionVec_20) && (g_io_backend_cfVec_4_bits_exceptionVec_20 !== i_io_backend_cfVec_4_bits_exceptionVec_20)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_exceptionVec_20 g=%h i=%h", $time, g_io_backend_cfVec_4_bits_exceptionVec_20, i_io_backend_cfVec_4_bits_exceptionVec_20); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_backendException) && (g_io_backend_cfVec_4_bits_backendException !== i_io_backend_cfVec_4_bits_backendException)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_backendException g=%h i=%h", $time, g_io_backend_cfVec_4_bits_backendException, i_io_backend_cfVec_4_bits_backendException); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_trigger) && (g_io_backend_cfVec_4_bits_trigger !== i_io_backend_cfVec_4_bits_trigger)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_trigger g=%h i=%h", $time, g_io_backend_cfVec_4_bits_trigger, i_io_backend_cfVec_4_bits_trigger); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_pd_isRVC) && (g_io_backend_cfVec_4_bits_pd_isRVC !== i_io_backend_cfVec_4_bits_pd_isRVC)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_pd_isRVC g=%h i=%h", $time, g_io_backend_cfVec_4_bits_pd_isRVC, i_io_backend_cfVec_4_bits_pd_isRVC); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_pd_brType) && (g_io_backend_cfVec_4_bits_pd_brType !== i_io_backend_cfVec_4_bits_pd_brType)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_pd_brType g=%h i=%h", $time, g_io_backend_cfVec_4_bits_pd_brType, i_io_backend_cfVec_4_bits_pd_brType); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_pred_taken) && (g_io_backend_cfVec_4_bits_pred_taken !== i_io_backend_cfVec_4_bits_pred_taken)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_pred_taken g=%h i=%h", $time, g_io_backend_cfVec_4_bits_pred_taken, i_io_backend_cfVec_4_bits_pred_taken); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_crossPageIPFFix) && (g_io_backend_cfVec_4_bits_crossPageIPFFix !== i_io_backend_cfVec_4_bits_crossPageIPFFix)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_crossPageIPFFix g=%h i=%h", $time, g_io_backend_cfVec_4_bits_crossPageIPFFix, i_io_backend_cfVec_4_bits_crossPageIPFFix); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_ftqPtr_flag) && (g_io_backend_cfVec_4_bits_ftqPtr_flag !== i_io_backend_cfVec_4_bits_ftqPtr_flag)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_ftqPtr_flag g=%h i=%h", $time, g_io_backend_cfVec_4_bits_ftqPtr_flag, i_io_backend_cfVec_4_bits_ftqPtr_flag); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_ftqPtr_value) && (g_io_backend_cfVec_4_bits_ftqPtr_value !== i_io_backend_cfVec_4_bits_ftqPtr_value)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_ftqPtr_value g=%h i=%h", $time, g_io_backend_cfVec_4_bits_ftqPtr_value, i_io_backend_cfVec_4_bits_ftqPtr_value); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_ftqOffset) && (g_io_backend_cfVec_4_bits_ftqOffset !== i_io_backend_cfVec_4_bits_ftqOffset)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_ftqOffset g=%h i=%h", $time, g_io_backend_cfVec_4_bits_ftqOffset, i_io_backend_cfVec_4_bits_ftqOffset); end
    if (!$isunknown(g_io_backend_cfVec_4_bits_isLastInFtqEntry) && (g_io_backend_cfVec_4_bits_isLastInFtqEntry !== i_io_backend_cfVec_4_bits_isLastInFtqEntry)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_4_bits_isLastInFtqEntry g=%h i=%h", $time, g_io_backend_cfVec_4_bits_isLastInFtqEntry, i_io_backend_cfVec_4_bits_isLastInFtqEntry); end
    if (!$isunknown(g_io_backend_cfVec_5_valid) && (g_io_backend_cfVec_5_valid !== i_io_backend_cfVec_5_valid)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_valid g=%h i=%h", $time, g_io_backend_cfVec_5_valid, i_io_backend_cfVec_5_valid); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_instr) && (g_io_backend_cfVec_5_bits_instr !== i_io_backend_cfVec_5_bits_instr)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_instr g=%h i=%h", $time, g_io_backend_cfVec_5_bits_instr, i_io_backend_cfVec_5_bits_instr); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_foldpc) && (g_io_backend_cfVec_5_bits_foldpc !== i_io_backend_cfVec_5_bits_foldpc)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_foldpc g=%h i=%h", $time, g_io_backend_cfVec_5_bits_foldpc, i_io_backend_cfVec_5_bits_foldpc); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_exceptionVec_1) && (g_io_backend_cfVec_5_bits_exceptionVec_1 !== i_io_backend_cfVec_5_bits_exceptionVec_1)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_exceptionVec_1 g=%h i=%h", $time, g_io_backend_cfVec_5_bits_exceptionVec_1, i_io_backend_cfVec_5_bits_exceptionVec_1); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_exceptionVec_2) && (g_io_backend_cfVec_5_bits_exceptionVec_2 !== i_io_backend_cfVec_5_bits_exceptionVec_2)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_exceptionVec_2 g=%h i=%h", $time, g_io_backend_cfVec_5_bits_exceptionVec_2, i_io_backend_cfVec_5_bits_exceptionVec_2); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_exceptionVec_12) && (g_io_backend_cfVec_5_bits_exceptionVec_12 !== i_io_backend_cfVec_5_bits_exceptionVec_12)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_exceptionVec_12 g=%h i=%h", $time, g_io_backend_cfVec_5_bits_exceptionVec_12, i_io_backend_cfVec_5_bits_exceptionVec_12); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_exceptionVec_20) && (g_io_backend_cfVec_5_bits_exceptionVec_20 !== i_io_backend_cfVec_5_bits_exceptionVec_20)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_exceptionVec_20 g=%h i=%h", $time, g_io_backend_cfVec_5_bits_exceptionVec_20, i_io_backend_cfVec_5_bits_exceptionVec_20); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_backendException) && (g_io_backend_cfVec_5_bits_backendException !== i_io_backend_cfVec_5_bits_backendException)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_backendException g=%h i=%h", $time, g_io_backend_cfVec_5_bits_backendException, i_io_backend_cfVec_5_bits_backendException); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_trigger) && (g_io_backend_cfVec_5_bits_trigger !== i_io_backend_cfVec_5_bits_trigger)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_trigger g=%h i=%h", $time, g_io_backend_cfVec_5_bits_trigger, i_io_backend_cfVec_5_bits_trigger); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_pd_isRVC) && (g_io_backend_cfVec_5_bits_pd_isRVC !== i_io_backend_cfVec_5_bits_pd_isRVC)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_pd_isRVC g=%h i=%h", $time, g_io_backend_cfVec_5_bits_pd_isRVC, i_io_backend_cfVec_5_bits_pd_isRVC); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_pd_brType) && (g_io_backend_cfVec_5_bits_pd_brType !== i_io_backend_cfVec_5_bits_pd_brType)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_pd_brType g=%h i=%h", $time, g_io_backend_cfVec_5_bits_pd_brType, i_io_backend_cfVec_5_bits_pd_brType); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_pred_taken) && (g_io_backend_cfVec_5_bits_pred_taken !== i_io_backend_cfVec_5_bits_pred_taken)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_pred_taken g=%h i=%h", $time, g_io_backend_cfVec_5_bits_pred_taken, i_io_backend_cfVec_5_bits_pred_taken); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_crossPageIPFFix) && (g_io_backend_cfVec_5_bits_crossPageIPFFix !== i_io_backend_cfVec_5_bits_crossPageIPFFix)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_crossPageIPFFix g=%h i=%h", $time, g_io_backend_cfVec_5_bits_crossPageIPFFix, i_io_backend_cfVec_5_bits_crossPageIPFFix); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_ftqPtr_flag) && (g_io_backend_cfVec_5_bits_ftqPtr_flag !== i_io_backend_cfVec_5_bits_ftqPtr_flag)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_ftqPtr_flag g=%h i=%h", $time, g_io_backend_cfVec_5_bits_ftqPtr_flag, i_io_backend_cfVec_5_bits_ftqPtr_flag); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_ftqPtr_value) && (g_io_backend_cfVec_5_bits_ftqPtr_value !== i_io_backend_cfVec_5_bits_ftqPtr_value)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_ftqPtr_value g=%h i=%h", $time, g_io_backend_cfVec_5_bits_ftqPtr_value, i_io_backend_cfVec_5_bits_ftqPtr_value); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_ftqOffset) && (g_io_backend_cfVec_5_bits_ftqOffset !== i_io_backend_cfVec_5_bits_ftqOffset)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_ftqOffset g=%h i=%h", $time, g_io_backend_cfVec_5_bits_ftqOffset, i_io_backend_cfVec_5_bits_ftqOffset); end
    if (!$isunknown(g_io_backend_cfVec_5_bits_isLastInFtqEntry) && (g_io_backend_cfVec_5_bits_isLastInFtqEntry !== i_io_backend_cfVec_5_bits_isLastInFtqEntry)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_cfVec_5_bits_isLastInFtqEntry g=%h i=%h", $time, g_io_backend_cfVec_5_bits_isLastInFtqEntry, i_io_backend_cfVec_5_bits_isLastInFtqEntry); end
    if (!$isunknown(g_io_backend_stallReason_reason_0) && (g_io_backend_stallReason_reason_0 !== i_io_backend_stallReason_reason_0)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_stallReason_reason_0 g=%h i=%h", $time, g_io_backend_stallReason_reason_0, i_io_backend_stallReason_reason_0); end
    if (!$isunknown(g_io_backend_stallReason_reason_1) && (g_io_backend_stallReason_reason_1 !== i_io_backend_stallReason_reason_1)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_stallReason_reason_1 g=%h i=%h", $time, g_io_backend_stallReason_reason_1, i_io_backend_stallReason_reason_1); end
    if (!$isunknown(g_io_backend_stallReason_reason_2) && (g_io_backend_stallReason_reason_2 !== i_io_backend_stallReason_reason_2)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_stallReason_reason_2 g=%h i=%h", $time, g_io_backend_stallReason_reason_2, i_io_backend_stallReason_reason_2); end
    if (!$isunknown(g_io_backend_stallReason_reason_3) && (g_io_backend_stallReason_reason_3 !== i_io_backend_stallReason_reason_3)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_stallReason_reason_3 g=%h i=%h", $time, g_io_backend_stallReason_reason_3, i_io_backend_stallReason_reason_3); end
    if (!$isunknown(g_io_backend_stallReason_reason_4) && (g_io_backend_stallReason_reason_4 !== i_io_backend_stallReason_reason_4)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_stallReason_reason_4 g=%h i=%h", $time, g_io_backend_stallReason_reason_4, i_io_backend_stallReason_reason_4); end
    if (!$isunknown(g_io_backend_stallReason_reason_5) && (g_io_backend_stallReason_reason_5 !== i_io_backend_stallReason_reason_5)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_stallReason_reason_5 g=%h i=%h", $time, g_io_backend_stallReason_reason_5, i_io_backend_stallReason_reason_5); end
    if (!$isunknown(g_io_backend_fromFtq_pc_mem_wen) && (g_io_backend_fromFtq_pc_mem_wen !== i_io_backend_fromFtq_pc_mem_wen)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_fromFtq_pc_mem_wen g=%h i=%h", $time, g_io_backend_fromFtq_pc_mem_wen, i_io_backend_fromFtq_pc_mem_wen); end
    if (!$isunknown(g_io_backend_fromFtq_pc_mem_waddr) && (g_io_backend_fromFtq_pc_mem_waddr !== i_io_backend_fromFtq_pc_mem_waddr)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_fromFtq_pc_mem_waddr g=%h i=%h", $time, g_io_backend_fromFtq_pc_mem_waddr, i_io_backend_fromFtq_pc_mem_waddr); end
    if (!$isunknown(g_io_backend_fromFtq_pc_mem_wdata_startAddr) && (g_io_backend_fromFtq_pc_mem_wdata_startAddr !== i_io_backend_fromFtq_pc_mem_wdata_startAddr)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_fromFtq_pc_mem_wdata_startAddr g=%h i=%h", $time, g_io_backend_fromFtq_pc_mem_wdata_startAddr, i_io_backend_fromFtq_pc_mem_wdata_startAddr); end
    if (!$isunknown(g_io_backend_fromFtq_newest_entry_en) && (g_io_backend_fromFtq_newest_entry_en !== i_io_backend_fromFtq_newest_entry_en)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_fromFtq_newest_entry_en g=%h i=%h", $time, g_io_backend_fromFtq_newest_entry_en, i_io_backend_fromFtq_newest_entry_en); end
    if (!$isunknown(g_io_backend_fromFtq_newest_entry_target) && (g_io_backend_fromFtq_newest_entry_target !== i_io_backend_fromFtq_newest_entry_target)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_fromFtq_newest_entry_target g=%h i=%h", $time, g_io_backend_fromFtq_newest_entry_target, i_io_backend_fromFtq_newest_entry_target); end
    if (!$isunknown(g_io_backend_fromFtq_newest_entry_ptr_value) && (g_io_backend_fromFtq_newest_entry_ptr_value !== i_io_backend_fromFtq_newest_entry_ptr_value)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_fromFtq_newest_entry_ptr_value g=%h i=%h", $time, g_io_backend_fromFtq_newest_entry_ptr_value, i_io_backend_fromFtq_newest_entry_ptr_value); end
    if (!$isunknown(g_io_backend_fromIfu_gpaddrMem_wen) && (g_io_backend_fromIfu_gpaddrMem_wen !== i_io_backend_fromIfu_gpaddrMem_wen)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_fromIfu_gpaddrMem_wen g=%h i=%h", $time, g_io_backend_fromIfu_gpaddrMem_wen, i_io_backend_fromIfu_gpaddrMem_wen); end
    if (!$isunknown(g_io_backend_fromIfu_gpaddrMem_waddr) && (g_io_backend_fromIfu_gpaddrMem_waddr !== i_io_backend_fromIfu_gpaddrMem_waddr)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_fromIfu_gpaddrMem_waddr g=%h i=%h", $time, g_io_backend_fromIfu_gpaddrMem_waddr, i_io_backend_fromIfu_gpaddrMem_waddr); end
    if (!$isunknown(g_io_backend_fromIfu_gpaddrMem_wdata_gpaddr) && (g_io_backend_fromIfu_gpaddrMem_wdata_gpaddr !== i_io_backend_fromIfu_gpaddrMem_wdata_gpaddr)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_fromIfu_gpaddrMem_wdata_gpaddr g=%h i=%h", $time, g_io_backend_fromIfu_gpaddrMem_wdata_gpaddr, i_io_backend_fromIfu_gpaddrMem_wdata_gpaddr); end
    if (!$isunknown(g_io_backend_fromIfu_gpaddrMem_wdata_isForVSnonLeafPTE) && (g_io_backend_fromIfu_gpaddrMem_wdata_isForVSnonLeafPTE !== i_io_backend_fromIfu_gpaddrMem_wdata_isForVSnonLeafPTE)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_fromIfu_gpaddrMem_wdata_isForVSnonLeafPTE g=%h i=%h", $time, g_io_backend_fromIfu_gpaddrMem_wdata_isForVSnonLeafPTE, i_io_backend_fromIfu_gpaddrMem_wdata_isForVSnonLeafPTE); end
    if (!$isunknown(g_io_backend_wfi_wfiSafe) && (g_io_backend_wfi_wfiSafe !== i_io_backend_wfi_wfiSafe)) begin errors++;
      if(errors<=60) $display("[%0t] io_backend_wfi_wfiSafe g=%h i=%h", $time, g_io_backend_wfi_wfiSafe, i_io_backend_wfi_wfiSafe); end
    ...
    if (!$isunknown(g_io_resetInFrontend) && (g_io_resetInFrontend !== i_io_resetInFrontend)) begin errors++;
      if(errors<=60) $display("[%0t] io_resetInFrontend g=%h i=%h", $time, g_io_resetInFrontend, i_io_resetInFrontend); end
    ...
    if (!$isunknown(u_g.inner_needFlush) && (u_g.inner_needFlush !== xs_dbg_flush)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE flush g=%h core=%h", $time, u_g.inner_needFlush, xs_dbg_flush); end
    if (!$isunknown(u_g.inner_FlushControlRedirect) && (u_g.inner_FlushControlRedirect !== xs_dbg_flush_ctrl)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE flush_ctrl g=%h core=%h", $time, u_g.inner_FlushControlRedirect, xs_dbg_flush_ctrl); end
    if (!$isunknown(u_g.inner_FlushMemVioRedirect) && (u_g.inner_FlushMemVioRedirect !== xs_dbg_flush_memvio)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE flush_memvio g=%h core=%h", $time, u_g.inner_FlushMemVioRedirect, xs_dbg_flush_memvio); end
    if (!$isunknown(u_g.inner_sfence_valid) && (u_g.inner_sfence_valid !== xs_dbg_sfence_q_valid)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE sfence_q_valid g=%h core=%h", $time, u_g.inner_sfence_valid, xs_dbg_sfence_q_valid); end
    if (!$isunknown(u_g.inner_sfence_bits_rs1) && (u_g.inner_sfence_bits_rs1 !== xs_dbg_sfence_q_rs1)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE sfence_q_rs1 g=%h core=%h", $time, u_g.inner_sfence_bits_rs1, xs_dbg_sfence_q_rs1); end
    if (!$isunknown(u_g.inner_sfence_bits_rs2) && (u_g.inner_sfence_bits_rs2 !== xs_dbg_sfence_q_rs2)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE sfence_q_rs2 g=%h core=%h", $time, u_g.inner_sfence_bits_rs2, xs_dbg_sfence_q_rs2); end
    if (!$isunknown(u_g.inner_sfence_bits_addr) && (u_g.inner_sfence_bits_addr !== xs_dbg_sfence_q_addr)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE sfence_q_addr g=%h core=%h", $time, u_g.inner_sfence_bits_addr, xs_dbg_sfence_q_addr); end
    if (!$isunknown(u_g.inner_sfence_bits_id) && (u_g.inner_sfence_bits_id !== xs_dbg_sfence_q_id)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE sfence_q_id g=%h core=%h", $time, u_g.inner_sfence_bits_id, xs_dbg_sfence_q_id); end
    if (!$isunknown(u_g.inner_sfence_bits_flushPipe) && (u_g.inner_sfence_bits_flushPipe !== xs_dbg_sfence_q_flushPipe)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE sfence_q_flushPipe g=%h core=%h", $time, u_g.inner_sfence_bits_flushPipe, xs_dbg_sfence_q_flushPipe); end
    if (!$isunknown(u_g.inner_sfence_bits_hv) && (u_g.inner_sfence_bits_hv !== xs_dbg_sfence_q_hv)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE sfence_q_hv g=%h core=%h", $time, u_g.inner_sfence_bits_hv, xs_dbg_sfence_q_hv); end
    if (!$isunknown(u_g.inner_sfence_bits_hg) && (u_g.inner_sfence_bits_hg !== xs_dbg_sfence_q_hg)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE sfence_q_hg g=%h core=%h", $time, u_g.inner_sfence_bits_hg, xs_dbg_sfence_q_hg); end
    if (!$isunknown(u_g.inner_icache_io_fencei_REG) && (u_g.inner_icache_io_fencei_REG !== xs_dbg_icache_fencei_q)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE icache_fencei_q g=%h core=%h", $time, u_g.inner_icache_io_fencei_REG, xs_dbg_icache_fencei_q); end
    if (!$isunknown(u_g.inner_icache_io_csr_pf_enable_REG) && (u_g.inner_icache_io_csr_pf_enable_REG !== xs_dbg_icache_pf_enable_q)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE icache_pf_enable_q g=%h core=%h", $time, u_g.inner_icache_io_csr_pf_enable_REG, xs_dbg_icache_pf_enable_q); end
    if (!$isunknown(u_g.io_error_valid) && (u_g.io_error_valid !== xs_dbg_error_valid_q)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE error_valid_q g=%h core=%h", $time, u_g.io_error_valid, xs_dbg_error_valid_q); end
    if (!$isunknown(u_g.io_error_bits_paddr) && (u_g.io_error_bits_paddr !== xs_dbg_error_paddr_q)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE error_paddr_q g=%h core=%h", $time, u_g.io_error_bits_paddr, xs_dbg_error_paddr_q); end
    if (!$isunknown(u_g.io_error_bits_report_to_beu) && (u_g.io_error_bits_report_to_beu !== xs_dbg_error_to_beu_q)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE error_to_beu_q g=%h core=%h", $time, u_g.io_error_bits_report_to_beu, xs_dbg_error_to_beu_q); end
    if (!$isunknown(u_g.io_perf_0_value) && (u_g.io_perf_0_value !== xs_dbg_perf_q_0)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE perf_q_0 g=%h core=%h", $time, u_g.io_perf_0_value, xs_dbg_perf_q_0); end
    if (!$isunknown(u_g.io_perf_1_value) && (u_g.io_perf_1_value !== xs_dbg_perf_q_1)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE perf_q_1 g=%h core=%h", $time, u_g.io_perf_1_value, xs_dbg_perf_q_1); end
    if (!$isunknown(u_g.io_perf_2_value) && (u_g.io_perf_2_value !== xs_dbg_perf_q_2)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE perf_q_2 g=%h core=%h", $time, u_g.io_perf_2_value, xs_dbg_perf_q_2); end
    if (!$isunknown(u_g.io_perf_3_value) && (u_g.io_perf_3_value !== xs_dbg_perf_q_3)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE perf_q_3 g=%h core=%h", $time, u_g.io_perf_3_value, xs_dbg_perf_q_3); end
    if (!$isunknown(u_g.io_perf_4_value) && (u_g.io_perf_4_value !== xs_dbg_perf_q_4)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE perf_q_4 g=%h core=%h", $time, u_g.io_perf_4_value, xs_dbg_perf_q_4); end
    if (!$isunknown(u_g.io_perf_5_value) && (u_g.io_perf_5_value !== xs_dbg_perf_q_5)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE perf_q_5 g=%h core=%h", $time, u_g.io_perf_5_value, xs_dbg_perf_q_5); end
    if (!$isunknown(u_g.io_perf_6_value) && (u_g.io_perf_6_value !== xs_dbg_perf_q_6)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE perf_q_6 g=%h core=%h", $time, u_g.io_perf_6_value, xs_dbg_perf_q_6); end
    if (!$isunknown(u_g.io_perf_7_value) && (u_g.io_perf_7_value !== xs_dbg_perf_q_7)) begin core_errors++;
      if(core_errors<=60) $display("[%0t] CORE perf_q_7 g=%h core=%h", $time, u_g.io_perf_7_value, xs_dbg_perf_q_7); end
  end
  initial begin
