// 自动生成:scripts/gen_iq_vlduvstuseg.py(entries tb)—— 勿手改
`timescale 1ns/1ps
module tb;
  ...
  logic io_enq_0_bits_status_fuType_33;
  logic io_enq_0_bits_status_fuType_34;
  ...
  logic io_enq_1_bits_status_fuType_33;
  logic io_enq_1_bits_status_fuType_34;
  ...
  wire g_io_deqEntry_0_bits_status_fuType_33;
  wire i_io_deqEntry_0_bits_status_fuType_33;
  wire g_io_deqEntry_0_bits_status_fuType_34;
  wire i_io_deqEntry_0_bits_status_fuType_34;
  ...
  EntriesVlduVstuVseglduVsegstu u_g (
    .clock(clk), .reset(rst),
    ...
    .io_enq_0_bits_status_fuType_33(io_enq_0_bits_status_fuType_33),
    .io_enq_0_bits_status_fuType_34(io_enq_0_bits_status_fuType_34),
    ...
    .io_enq_1_bits_status_fuType_33(io_enq_1_bits_status_fuType_33),
    .io_enq_1_bits_status_fuType_34(io_enq_1_bits_status_fuType_34),
    ...
    .io_deqEntry_0_bits_status_fuType_33(g_io_deqEntry_0_bits_status_fuType_33),
    .io_deqEntry_0_bits_status_fuType_34(g_io_deqEntry_0_bits_status_fuType_34),
  ...
  EntriesVlduVstuVseglduVsegstu_xs u_i (
    .clock(clk), .reset(rst),
    .io_flush_valid(io_flush_valid),
    .io_flush_bits_robIdx_flag(io_flush_bits_robIdx_flag),
    .io_flush_bits_robIdx_value(io_flush_bits_robIdx_value),
    ...
    .io_deqEntry_0_bits_status_fuType_33(i_io_deqEntry_0_bits_status_fuType_33),
    .io_deqEntry_0_bits_status_fuType_34(i_io_deqEntry_0_bits_status_fuType_34),
  ...
  task drive_rand();
    ...
    io_enq_0_bits_status_fuType_33 = $urandom;
    io_enq_0_bits_status_fuType_34 = $urandom;
    ...
    io_enq_1_bits_status_fuType_33 = $urandom;
    io_enq_1_bits_status_fuType_34 = $urandom;
  ...
  task check();
    ...
    if (!$isunknown(g_io_deqEntry_0_bits_status_fuType_33) && g_io_deqEntry_0_bits_status_fuType_33 !== i_io_deqEntry_0_bits_status_fuType_33) begin errors++;
      if(errors<=120) $display("[%0t] io_deqEntry_0_bits_status_fuType_33 g=%h i=%h", $time, g_io_deqEntry_0_bits_status_fuType_33, i_io_deqEntry_0_bits_status_fuType_33); end
    if (!$isunknown(g_io_deqEntry_0_bits_status_fuType_34) && g_io_deqEntry_0_bits_status_fuType_34 !== i_io_deqEntry_0_bits_status_fuType_34) begin errors++;
      if(errors<=120) $display("[%0t] io_deqEntry_0_bits_status_fuType_34 g=%h i=%h", $time, g_io_deqEntry_0_bits_status_fuType_34, i_io_deqEntry_0_bits_status_fuType_34); end
