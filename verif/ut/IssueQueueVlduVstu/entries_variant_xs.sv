// 自动生成:scripts/gen_iq_vlduvstu.py —— 勿手改
// EntriesVlduVstu golden 同名扁平 wrapper —— 例化可读核 xs_EntriesVlduVstu_core。
module EntriesVlduVstu_xs import iq_vlduvstu_pkg::*; (
  input  clock,
  input  reset,
  ...
  xs_EntriesVlduVstu_core u_core (
