// xs_VSSplitImp_core —— 向量 store split 装配壳(纯组合 glue)。
// 手写可读重写, 结构 bug-for-bug 对齐 golden VSSplitImp.sv。
// 例化 3 个 golden 子模块(两侧同 elaborate 黑盒, FM 只验本层 glue):
//   splitPipeline(VSSplitPipelineImp) → VSSplitSkidBuffer(skidBufferConnect)
//   → splitBuffer(VSSplitBufferImp)
// 顶层 glue: io_in_ready(直连 pipeline.ready) /
//   io_out_valid(splitBuffer.out.valid) / skidBuffer.io_flush(流动 uop robIdx 判重定向)。
module xs_VSSplitImp_core
  import xs_vssplitimp_pkg::*;
(
  input           clock,
  input           reset,
  ...
  wire         _VSSplitSkidBuffer_io_out_bits_uop_exceptionVec_7;
  wire         _VSSplitSkidBuffer_io_out_bits_uop_exceptionVec_15;
  wire         _VSSplitSkidBuffer_io_out_bits_uop_exceptionVec_19;
  wire         _VSSplitSkidBuffer_io_out_bits_uop_exceptionVec_23;
  ...
  VSSplitBufferImp splitBuffer (
    ...
    .io_in_bits_uop_exceptionVec_7
      (_VSSplitSkidBuffer_io_out_bits_uop_exceptionVec_7),
    .io_in_bits_uop_exceptionVec_15
      (_VSSplitSkidBuffer_io_out_bits_uop_exceptionVec_15),
    .io_in_bits_uop_exceptionVec_19
      (_VSSplitSkidBuffer_io_out_bits_uop_exceptionVec_19),
    .io_in_bits_uop_exceptionVec_23
      (_VSSplitSkidBuffer_io_out_bits_uop_exceptionVec_23),
