...
// Family: LSQ/deep entry data (io_lsq_*/io_diffCommits_*/io_readGPAMemAddr_*/io_toDecode_*/io_error_0)
// Exposes 2064 of 2343 Rob outputs; all other Rob outputs off-surface (floating).
