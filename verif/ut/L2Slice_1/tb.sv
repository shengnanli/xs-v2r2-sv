...
// L2Slice_1 双例化逐拍比对：golden L2Slice_1 vs 可读重写 L2Slice_1_xs。
`timescale 1ns/1ps
...
module tb;
  ...
  wire [4:0] g_toNextPipeline_0_array;
  wire [4:0] i_toNextPipeline_0_array;
  ...
  initial begin
    ...
    $display("L2Slice_1 checks=%0d errors=%0d", checks, errors);
    if (errors == 0) begin
      $display("TEST PASSED");
      $finish;
    end
