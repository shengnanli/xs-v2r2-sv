// 手写：L2Slice_1 FM impl 侧顶层, 例化参数化核 xs_L2SliceN_core (BASE=0x11)
// golden L2Slice_1: mbist_array 5b / child0 array 5b / child1 array 5b
module L2Slice_1(
  input clock,
  input reset,
  ...
  xs_L2SliceN_core #(
    .ARRAY_W(5), .CH0_ARRAY_W(5), .CH1_ARRAY_W(5), .BASE('h11)
  ) u_core (
    .clock(clock),
    .reset(reset),
