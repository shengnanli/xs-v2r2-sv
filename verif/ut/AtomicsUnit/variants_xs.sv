// AtomicsUnit_xs —— UT 用变体(与 AtomicsUnit_wrapper 同, 仅模块名改为 AtomicsUnit_xs)。
// 供 UT 与 golden AtomicsUnit 双例化对拍。内部 DummyDPICWrapper_50 两侧共用 golden 定义。
module AtomicsUnit_xs(
  input clock,
  input reset,
  input [5:0] io_hartId,
  output io_in_ready,
