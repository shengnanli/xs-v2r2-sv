...
module tb;
  ...
  wire g_auto_in_d_bits_source;
  wire i_auto_in_d_bits_source;
  ...
  wire g_auto_out_a_bits_source;
  wire i_auto_out_a_bits_source;
  ...
  task automatic drive_random_inputs();
    ...
    auto_in_a_bits_source <= $urandom_range(0, 1);
    ...
    auto_out_d_bits_source <= $urandom_range(0, 1);
  ...
  initial begin
    ...
    $display("TLBuffer_15 checks=%0d errors=%0d", checks, errors);
