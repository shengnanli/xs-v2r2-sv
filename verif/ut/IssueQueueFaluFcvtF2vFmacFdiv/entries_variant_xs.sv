// 自动生成:scripts/gen_iq_ffcfmacfdiv.py —— 勿手改
// EntriesFaluFcvtF2vFmacFdiv golden 同名扁平 wrapper —— 例化可读核 xs_EntriesFaluFcvtF2vFmacFdiv_core。
module EntriesFaluFcvtF2vFmacFdiv_xs import iq_ffcfmacfdiv_pkg::*; (
  input  clock,
  input  reset,
  ...
  xs_EntriesFaluFcvtF2vFmacFdiv_core u_core (
