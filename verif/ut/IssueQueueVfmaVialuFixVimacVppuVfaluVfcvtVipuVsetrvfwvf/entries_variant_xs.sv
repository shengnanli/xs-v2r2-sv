// 自动生成:scripts/gen_iq_vfmavialufixvimacvppuvfaluvfcvtvipuvsetrvfwvf.py —— 勿手改
// EntriesVfmaVialuFixVimacVppuVfaluVfcvtVipuVsetrvfwvf golden 同名扁平 wrapper —— 例化可读核 xs_EntriesVfmaVialuFixVimacVppuVfaluVfcvtVipuVsetrvfwvf_core。
module EntriesVfmaVialuFixVimacVppuVfaluVfcvtVipuVsetrvfwvf_xs import iq_vfmavialufixvimacvppuvfaluvfcvtvipuvsetrvfwvf_pkg::*; (
  input  clock,
  input  reset,
  ...
  always_comb begin
    ...
    c_enq_bits[0].status.fu_type_vipu = io_enq_0_bits_status_fuType_18;
    c_enq_bits[0].status.fu_type_vialuf = io_enq_0_bits_status_fuType_19;
    c_enq_bits[0].status.fu_type_vppu = io_enq_0_bits_status_fuType_20;
    c_enq_bits[0].status.fu_type_vimac = io_enq_0_bits_status_fuType_21;
    ...
    c_enq_bits[0].status.fu_type_vfcvt = io_enq_0_bits_status_fuType_27;
    c_enq_bits[0].status.fu_type_vsetfwf = io_enq_0_bits_status_fuType_30;
    ...
    c_enq_bits[1].status.fu_type_vipu = io_enq_1_bits_status_fuType_18;
    c_enq_bits[1].status.fu_type_vialuf = io_enq_1_bits_status_fuType_19;
    c_enq_bits[1].status.fu_type_vppu = io_enq_1_bits_status_fuType_20;
    c_enq_bits[1].status.fu_type_vimac = io_enq_1_bits_status_fuType_21;
    ...
    c_enq_bits[1].status.fu_type_vfcvt = io_enq_1_bits_status_fuType_27;
    c_enq_bits[1].status.fu_type_vsetfwf = io_enq_1_bits_status_fuType_30;
  ...
  assign io_deqEntry_0_bits_status_fuType_18 = c_deq_entry[0].status.fu_type_vipu;
  assign io_deqEntry_0_bits_status_fuType_19 = c_deq_entry[0].status.fu_type_vialuf;
  assign io_deqEntry_0_bits_status_fuType_20 = c_deq_entry[0].status.fu_type_vppu;
  assign io_deqEntry_0_bits_status_fuType_21 = c_deq_entry[0].status.fu_type_vimac;
  ...
  assign io_deqEntry_0_bits_status_fuType_27 = c_deq_entry[0].status.fu_type_vfcvt;
  assign io_deqEntry_0_bits_status_fuType_30 = c_deq_entry[0].status.fu_type_vsetfwf;
  ...
  assign io_deqEntry_1_bits_status_fuType_18 = c_deq_entry[1].status.fu_type_vipu;
  assign io_deqEntry_1_bits_status_fuType_19 = c_deq_entry[1].status.fu_type_vialuf;
  assign io_deqEntry_1_bits_status_fuType_20 = c_deq_entry[1].status.fu_type_vppu;
  assign io_deqEntry_1_bits_status_fuType_21 = c_deq_entry[1].status.fu_type_vimac;
  ...
  assign io_deqEntry_1_bits_status_fuType_27 = c_deq_entry[1].status.fu_type_vfcvt;
  assign io_deqEntry_1_bits_status_fuType_30 = c_deq_entry[1].status.fu_type_vsetfwf;
  ...
  xs_EntriesVfmaVialuFixVimacVppuVfaluVfcvtVipuVsetrvfwvf_core u_core (
