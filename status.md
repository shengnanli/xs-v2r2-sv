...
| **L2/L3 缓存** | 装配3 + 子块8 | - | 🔨 **进行中**(装配层 L2Top/TL2CHICoupledL2/OpenLLC 全齐;子块 MSHR/MSHRCtl/Directory/SinkA/SinkC/SourceB/SubDirectory×2/MSHRSelector/L2-MBIST×4 做透,均 UT+FM;余 MainPipe/Slice/GrantBuffer/RequestArb 等深层子块) |
