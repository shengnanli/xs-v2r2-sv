// 变体核 xs_Slice_2_core —— 由 scripts/gen_slice_variants.py 从绿基线
// xs_Slice_core 机械派生(sliceId=2, 子模块 Directory_2/DataStorage_2/
// L2Slice_2, MBIST array-id 位宽按 golden Slice_2 收窄/加宽)。勿手改。
...
module xs_Slice_2_core (
  input clock,
  input reset,
`include "slice_2_ports.svh"
);
