...
//
// 发射队列把条目阵列(EntriesAluCsrFenceDiv_bt)包起来, 负责:
...
module xs_IssueQueueAluCsrFenceDiv_core import iq_acfd_pkg::*; (
  ...
  // ===========================================================================
  EntriesAluCsrFenceDiv_bt entries (
...
// =============================================================================
// IssueQueueAluCsrFenceDiv_bt —— golden 同名顶层。本变体 IQ 顶层端口与可读核完全一致
// (核已直接持平 golden 扁平接口), 故这里是纯穿透 wrapper, 仅做命名对齐。
// =============================================================================
module IssueQueueAluCsrFenceDiv_bt (
  input         clock,
  input         reset,
