// =============================================================================
// CSR_xs (wrapper) —— golden 同名顶层, 端口与 golden CSR.sv 完全一致。
// 机械端口适配: 全部交给可读核 xs_CSR_core u_core。scripts/gen_csr.py 生成。
// =============================================================================
module CSR_xs(
  input         clock,
  input         reset,
  ...
  xs_CSR_core u_core (
    ...
    .io_out_bits_ctrl_exceptionVec_2(io_out_bits_ctrl_exceptionVec_2),
    .io_out_bits_ctrl_exceptionVec_3(io_out_bits_ctrl_exceptionVec_3),
    .io_out_bits_ctrl_exceptionVec_8(io_out_bits_ctrl_exceptionVec_8),
    .io_out_bits_ctrl_exceptionVec_9(io_out_bits_ctrl_exceptionVec_9),
    .io_out_bits_ctrl_exceptionVec_10(io_out_bits_ctrl_exceptionVec_10),
    .io_out_bits_ctrl_exceptionVec_11(io_out_bits_ctrl_exceptionVec_11),
    .io_out_bits_ctrl_exceptionVec_22(io_out_bits_ctrl_exceptionVec_22),
    .io_out_bits_ctrl_flushPipe(io_out_bits_ctrl_flushPipe),
    .io_out_bits_res_data(io_out_bits_res_data),
    .io_out_bits_res_redirect_valid(io_out_bits_res_redirect_valid),
    .io_out_bits_res_redirect_bits_isRVC(io_out_bits_res_redirect_bits_isRVC),
    ...
    .io_out_bits_res_redirect_bits_level(io_out_bits_res_redirect_bits_level),
    .io_out_bits_res_redirect_bits_interrupt(io_out_bits_res_redirect_bits_interrupt),
    .io_out_bits_res_redirect_bits_cfiUpdate_pc(io_out_bits_res_redirect_bits_cfiUpdate_pc),
    .io_out_bits_res_redirect_bits_cfiUpdate_pd_valid(io_out_bits_res_redirect_bits_cfiUpdate_pd_valid),
    .io_out_bits_res_redirect_bits_cfiUpdate_pd_isRVC(io_out_bits_res_redirect_bits_cfiUpdate_pd_isRVC),
    .io_out_bits_res_redirect_bits_cfiUpdate_pd_brType(io_out_bits_res_redirect_bits_cfiUpdate_pd_brType),
    .io_out_bits_res_redirect_bits_cfiUpdate_pd_isCall(io_out_bits_res_redirect_bits_cfiUpdate_pd_isCall),
    .io_out_bits_res_redirect_bits_cfiUpdate_pd_isRet(io_out_bits_res_redirect_bits_cfiUpdate_pd_isRet),
    .io_out_bits_res_redirect_bits_cfiUpdate_ssp(io_out_bits_res_redirect_bits_cfiUpdate_ssp),
    .io_out_bits_res_redirect_bits_cfiUpdate_sctr(io_out_bits_res_redirect_bits_cfiUpdate_sctr),
    .io_out_bits_res_redirect_bits_cfiUpdate_TOSW_flag(io_out_bits_res_redirect_bits_cfiUpdate_TOSW_flag),
    .io_out_bits_res_redirect_bits_cfiUpdate_TOSW_value(io_out_bits_res_redirect_bits_cfiUpdate_TOSW_value),
    .io_out_bits_res_redirect_bits_cfiUpdate_TOSR_flag(io_out_bits_res_redirect_bits_cfiUpdate_TOSR_flag),
    .io_out_bits_res_redirect_bits_cfiUpdate_TOSR_value(io_out_bits_res_redirect_bits_cfiUpdate_TOSR_value),
    .io_out_bits_res_redirect_bits_cfiUpdate_NOS_flag(io_out_bits_res_redirect_bits_cfiUpdate_NOS_flag),
    .io_out_bits_res_redirect_bits_cfiUpdate_NOS_value(io_out_bits_res_redirect_bits_cfiUpdate_NOS_value),
    .io_out_bits_res_redirect_bits_cfiUpdate_topAddr(io_out_bits_res_redirect_bits_cfiUpdate_topAddr),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_17_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_17_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_16_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_16_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_15_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_15_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_14_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_14_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_13_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_13_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_12_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_12_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_11_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_11_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_10_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_10_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_9_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_9_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_8_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_8_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_7_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_7_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_6_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_6_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_5_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_5_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_4_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_4_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_3_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_3_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_2_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_2_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_1_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_1_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_0_folded_hist(io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_0_folded_hist),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_5_bits_0(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_5_bits_0),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_5_bits_1(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_5_bits_1),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_5_bits_2(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_5_bits_2),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_5_bits_3(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_5_bits_3),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_4_bits_0(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_4_bits_0),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_4_bits_1(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_4_bits_1),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_4_bits_2(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_4_bits_2),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_4_bits_3(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_4_bits_3),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_3_bits_0(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_3_bits_0),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_3_bits_1(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_3_bits_1),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_3_bits_2(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_3_bits_2),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_3_bits_3(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_3_bits_3),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_2_bits_0(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_2_bits_0),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_2_bits_1(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_2_bits_1),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_2_bits_2(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_2_bits_2),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_2_bits_3(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_2_bits_3),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_1_bits_0(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_1_bits_0),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_1_bits_1(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_1_bits_1),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_1_bits_2(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_1_bits_2),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_1_bits_3(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_1_bits_3),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_0_bits_0(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_0_bits_0),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_0_bits_1(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_0_bits_1),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_0_bits_2(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_0_bits_2),
    .io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_0_bits_3(io_out_bits_res_redirect_bits_cfiUpdate_afhob_afhob_0_bits_3),
    .io_out_bits_res_redirect_bits_cfiUpdate_lastBrNumOH(io_out_bits_res_redirect_bits_cfiUpdate_lastBrNumOH),
    .io_out_bits_res_redirect_bits_cfiUpdate_ghr(io_out_bits_res_redirect_bits_cfiUpdate_ghr),
    .io_out_bits_res_redirect_bits_cfiUpdate_histPtr_flag(io_out_bits_res_redirect_bits_cfiUpdate_histPtr_flag),
    .io_out_bits_res_redirect_bits_cfiUpdate_histPtr_value(io_out_bits_res_redirect_bits_cfiUpdate_histPtr_value),
    .io_out_bits_res_redirect_bits_cfiUpdate_specCnt_0(io_out_bits_res_redirect_bits_cfiUpdate_specCnt_0),
    .io_out_bits_res_redirect_bits_cfiUpdate_specCnt_1(io_out_bits_res_redirect_bits_cfiUpdate_specCnt_1),
    .io_out_bits_res_redirect_bits_cfiUpdate_br_hit(io_out_bits_res_redirect_bits_cfiUpdate_br_hit),
    .io_out_bits_res_redirect_bits_cfiUpdate_jr_hit(io_out_bits_res_redirect_bits_cfiUpdate_jr_hit),
    .io_out_bits_res_redirect_bits_cfiUpdate_sc_hit(io_out_bits_res_redirect_bits_cfiUpdate_sc_hit),
    ...
    .io_out_bits_res_redirect_bits_cfiUpdate_shift(io_out_bits_res_redirect_bits_cfiUpdate_shift),
    .io_out_bits_res_redirect_bits_cfiUpdate_addIntoHist(io_out_bits_res_redirect_bits_cfiUpdate_addIntoHist),
    ...
    .io_out_bits_res_redirect_bits_stFtqIdx_flag(io_out_bits_res_redirect_bits_stFtqIdx_flag),
    .io_out_bits_res_redirect_bits_stFtqIdx_value(io_out_bits_res_redirect_bits_stFtqIdx_value),
    .io_out_bits_res_redirect_bits_stFtqOffset(io_out_bits_res_redirect_bits_stFtqOffset),
    .io_out_bits_res_redirect_bits_debug_runahead_checkpoint_id(io_out_bits_res_redirect_bits_debug_runahead_checkpoint_id),
    .io_out_bits_res_redirect_bits_debugIsCtrl(io_out_bits_res_redirect_bits_debugIsCtrl),
    .io_out_bits_res_redirect_bits_debugIsMemVio(io_out_bits_res_redirect_bits_debugIsMemVio),
    ...
    .io_csrio_isPerfCnt(io_csrio_isPerfCnt),
