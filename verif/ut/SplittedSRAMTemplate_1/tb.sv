// SplittedSRAMTemplate_1 UT：golden vs _xs 双例化随机比对。
// waySplit=2 → 2×SRAMTemplate_2(icsh_tag)。结构同 base，bore_array 为 [1:0]。
`timescale 1ns/1ps
module tb;
  ...
  logic [1:0]  b0_wmask, b1_wmask, b0_array, b1_array;
  ...
  SplittedSRAMTemplate_1    u_g (`PORTS(g_ready,g_d0t,g_d0c,g_d1t,g_d1c,g_d2t,g_d2c,g_d3t,g_d3c,g_b0rd,g_b1rd));
  SplittedSRAMTemplate_1_xs u_i (`PORTS(i_ready,i_d0t,i_d0c,i_d1t,i_d1c,i_d2t,i_d2c,i_d3t,i_d3c,i_b0rd,i_b1rd));
  ...
  always @(negedge clk) begin
    if (rst) begin
      ...
      b0_array<=2'($urandom); b1_array<=2'($urandom);
    end
  end
