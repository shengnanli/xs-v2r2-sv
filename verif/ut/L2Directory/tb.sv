...
// L2Directory 双例化逐拍比对：golden L2Directory vs 可读重写 L2Directory_xs。
...
module tb;
  ...
  wire [1:0] g_toSRAM_0_array;
  wire [1:0] i_toSRAM_0_array;
  ...
  wire [1:0] g_toSRAM_1_array;
  wire [1:0] i_toSRAM_1_array;
  ...
  wire [2:0] g_toSRAM_2_array;
  wire [2:0] i_toSRAM_2_array;
  ...
  wire [2:0] g_toSRAM_3_array;
  wire [2:0] i_toSRAM_3_array;
  ...
  wire [2:0] g_toSRAM_4_array;
  wire [2:0] i_toSRAM_4_array;
  ...
  wire [2:0] g_toSRAM_5_array;
  wire [2:0] i_toSRAM_5_array;
  ...
  function automatic logic [3:0] pick_array();
    case ($urandom_range(0, 7))
      ...
      5: return 4'h7;
      6: return 4'h8;
      default: return 4'($urandom);  // 全随机：覆盖未命中路径
    endcase
  endfunction
  ...
  initial begin
    ...
    $display("L2Directory checks=%0d errors=%0d", checks, errors);
    if (errors == 0) begin
      $display("TEST PASSED");
      $finish;
    end
