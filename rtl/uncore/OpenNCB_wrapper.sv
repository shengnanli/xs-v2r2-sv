...
// FM impl-side wrapper: golden-name module OpenNCB with golden flat ports,
// delegating everything to xs_OpenNCB_core (u_core). The single child NCB200
// is a SYMMETRIC unresolved_blackbox (compiled into NEITHER ref nor impl),
// so the assembly proof exercises exactly the OpenNCB glue (slice/repack/
// passthrough). NCB200 is independently AUX-signed-off (depends_on aux PASS).
