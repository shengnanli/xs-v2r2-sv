// 自动生成：scripts/gen_tlbnonblock1.py —— 勿手改
`timescale 1ns/1ps
module tb;
  ...
  wire g_io_requestor_1_resp_bits_excp_0_gpf_st;
  wire i_io_requestor_1_resp_bits_excp_0_gpf_st;
  wire g_io_requestor_1_resp_bits_excp_0_pf_ld;
  wire i_io_requestor_1_resp_bits_excp_0_pf_ld;
  wire g_io_requestor_1_resp_bits_excp_0_pf_st;
  wire i_io_requestor_1_resp_bits_excp_0_pf_st;
  wire g_io_requestor_1_resp_bits_excp_0_af_ld;
  wire i_io_requestor_1_resp_bits_excp_0_af_ld;
  wire g_io_requestor_1_resp_bits_excp_0_af_st;
  wire i_io_requestor_1_resp_bits_excp_0_af_st;
  ...
  always @(negedge clk) if (!rst) begin
    ...
    if (!$isunknown(g_io_requestor_1_resp_bits_excp_0_gpf_st) && g_io_requestor_1_resp_bits_excp_0_gpf_st !== i_io_requestor_1_resp_bits_excp_0_gpf_st) begin errors++;
      if(errors<=80) $display("[%0t] io_requestor_1_resp_bits_excp_0_gpf_st g=%h i=%h", $time, g_io_requestor_1_resp_bits_excp_0_gpf_st, i_io_requestor_1_resp_bits_excp_0_gpf_st); end
    ...
    if (!$isunknown(g_io_requestor_1_resp_bits_excp_0_pf_st) && g_io_requestor_1_resp_bits_excp_0_pf_st !== i_io_requestor_1_resp_bits_excp_0_pf_st) begin errors++;
      if(errors<=80) $display("[%0t] io_requestor_1_resp_bits_excp_0_pf_st g=%h i=%h", $time, g_io_requestor_1_resp_bits_excp_0_pf_st, i_io_requestor_1_resp_bits_excp_0_pf_st); end
    ...
    if (!$isunknown(g_io_requestor_1_resp_bits_excp_0_af_st) && g_io_requestor_1_resp_bits_excp_0_af_st !== i_io_requestor_1_resp_bits_excp_0_af_st) begin errors++;
      if(errors<=80) $display("[%0t] io_requestor_1_resp_bits_excp_0_af_st g=%h i=%h", $time, g_io_requestor_1_resp_bits_excp_0_af_st, i_io_requestor_1_resp_bits_excp_0_af_st); end
