...
module tb;
  ...
  logic [1:0] auto_in_1_a_bits_size;
  logic [1:0] auto_in_1_a_bits_source;
  logic [47:0] auto_in_1_a_bits_address;
  logic auto_in_1_a_bits_user_memBackType_MM;
  logic auto_in_1_a_bits_user_memPageType_NC;
  ...
  logic [1:0] auto_in_0_a_bits_size;
  logic auto_in_0_a_bits_source;
  ...
  logic [2:0] auto_out_2_d_bits_source;
  ...
  logic [2:0] auto_out_1_d_bits_source;
  logic auto_out_1_d_bits_sink;
  ...
  logic [2:0] auto_out_0_d_bits_source;
  logic auto_out_0_d_bits_sink;
  ...
  wire [1:0] g_auto_in_1_d_bits_size;
  wire [1:0] i_auto_in_1_d_bits_size;
  wire [1:0] g_auto_in_1_d_bits_source;
  wire [1:0] i_auto_in_1_d_bits_source;
  ...
  wire [1:0] g_auto_in_0_d_bits_size;
  wire [1:0] i_auto_in_0_d_bits_size;
  ...
  wire [2:0] g_auto_out_2_a_bits_source;
  wire [2:0] i_auto_out_2_a_bits_source;
  wire [47:0] g_auto_out_2_a_bits_address;
  wire [47:0] i_auto_out_2_a_bits_address;
  wire g_auto_out_2_a_bits_user_memBackType_MM;
  wire i_auto_out_2_a_bits_user_memBackType_MM;
  wire g_auto_out_2_a_bits_user_memPageType_NC;
  wire i_auto_out_2_a_bits_user_memPageType_NC;
  ...
  wire [2:0] g_auto_out_1_a_bits_source;
  wire [2:0] i_auto_out_1_a_bits_source;
  ...
  wire [2:0] g_auto_out_0_a_bits_source;
  wire [2:0] i_auto_out_0_a_bits_source;
  ...
  TLXbar_6 u_g (
    ...
    .auto_out_2_a_bits_user_memBackType_MM(g_auto_out_2_a_bits_user_memBackType_MM),
    .auto_out_2_a_bits_user_memPageType_NC(g_auto_out_2_a_bits_user_memPageType_NC),
  ...
  TLXbar_6_xs u_i (
    ...
    .auto_out_2_a_bits_user_memBackType_MM(i_auto_out_2_a_bits_user_memBackType_MM),
    .auto_out_2_a_bits_user_memPageType_NC(i_auto_out_2_a_bits_user_memPageType_NC),
  ...
  task automatic drive_random_inputs();
    ...
    auto_in_1_a_bits_size <= 2'({$urandom});
    auto_in_1_a_bits_source <= 2'({$urandom});
    sel = $urandom_range(0, 2);
    if (sel == 0) auto_in_1_a_bits_address <= 48'h38010000 + $urandom_range(0, 4095);
    else if (sel == 1) auto_in_1_a_bits_address <= 48'h38022000 + $urandom_range(0, 255);
    else auto_in_1_a_bits_address <= 48'({$urandom, $urandom});
    auto_in_1_a_bits_user_memBackType_MM <= $urandom_range(0, 1);
    auto_in_1_a_bits_user_memPageType_NC <= $urandom_range(0, 1);
    ...
    auto_in_0_a_bits_size <= 2'({$urandom});
    auto_in_0_a_bits_source <= $urandom_range(0, 1);
    sel = $urandom_range(0, 2);
    if (sel == 0) auto_in_0_a_bits_address <= 48'h38010000 + $urandom_range(0, 4095);
    else if (sel == 1) auto_in_0_a_bits_address <= 48'h38022000 + $urandom_range(0, 255);
    else auto_in_0_a_bits_address <= 48'({$urandom, $urandom});
    ...
    auto_out_2_d_bits_source <= 3'($urandom_range(0, 5));
    ...
    auto_out_1_d_bits_source <= 3'($urandom_range(0, 5));
    auto_out_1_d_bits_sink <= $urandom_range(0, 1);
    ...
    auto_out_0_d_bits_source <= 3'($urandom_range(0, 5));
    auto_out_0_d_bits_sink <= $urandom_range(0, 1);
  ...
  task automatic check_outputs();
    ...
    `CHECK(auto_out_2_a_bits_user_memBackType_MM)
    `CHECK(auto_out_2_a_bits_user_memPageType_NC)
  ...
  initial begin
    ...
    auto_in_1_a_bits_user_memBackType_MM = '0;
    auto_in_1_a_bits_user_memPageType_NC = '0;
    ...
    $display("TLXbar_6 checks=%0d errors=%0d", checks, errors);
