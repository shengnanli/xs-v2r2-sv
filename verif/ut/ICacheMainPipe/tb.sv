// 自动生成（手写生成脚本）—— ICacheMainPipe golden vs xs 双例化随机比对
`timescale 1ns/1ps
module tb;
  ...
  always @(negedge clk) begin
    if (rst) begin
      ...
      io_dataArray_toIData_3_ready <= ($urandom_range(0,4)!=0);
      io_dataArray_fromIData_datas_0 <= {$urandom(),$urandom()};
      io_dataArray_fromIData_datas_1 <= {$urandom(),$urandom()};
      io_dataArray_fromIData_datas_2 <= {$urandom(),$urandom()};
      io_dataArray_fromIData_datas_3 <= {$urandom(),$urandom()};
      io_dataArray_fromIData_datas_4 <= {$urandom(),$urandom()};
      io_dataArray_fromIData_datas_5 <= {$urandom(),$urandom()};
      io_dataArray_fromIData_datas_6 <= {$urandom(),$urandom()};
      io_dataArray_fromIData_datas_7 <= {$urandom(),$urandom()};
      ...
      io_wayLookupRead_bits_entry_vSetIdx_0 <= 8'($urandom_range(0,3));
      io_wayLookupRead_bits_entry_vSetIdx_1 <= 8'($urandom_range(0,3));
      io_wayLookupRead_bits_entry_waymask_0 <= 4'($urandom_range(0,5));
      io_wayLookupRead_bits_entry_waymask_1 <= 4'($urandom_range(0,5));
      ...
      io_wayLookupRead_bits_entry_itlb_pbmt_0 <= 2'($urandom_range(0,2));
      io_wayLookupRead_bits_entry_itlb_pbmt_1 <= 2'($urandom_range(0,2));
      ...
      io_mshr_req_ready <= ($urandom_range(0,3)!=0);
      ...
      io_mshr_resp_bits_data <= {$urandom(),$urandom(),$urandom(),$urandom(),$urandom(),$urandom(),$urandom(),$urandom(),$urandom(),$urandom(),$urandom(),$urandom(),$urandom(),$urandom(),$urandom(),$urandom()};
      io_mshr_resp_bits_corrupt <= ($urandom_range(0,7)==0);
      io_ecc_enable <= ($urandom_range(0,3)!=0);
      io_fetch_req_valid <= ($urandom_range(0,3)!=0);
      io_fetch_req_bits_pcMemRead_0_startAddr <= {36'($urandom_range(0,7)), 8'($urandom_range(0,3)), 6'($urandom)};
      io_fetch_req_bits_pcMemRead_0_nextlineStart <= {36'($urandom_range(0,7)), 8'($urandom_range(0,3)), 6'($urandom)};
      io_fetch_req_bits_pcMemRead_1_startAddr <= {36'($urandom_range(0,7)), 8'($urandom_range(0,3)), 6'($urandom)};
      io_fetch_req_bits_pcMemRead_1_nextlineStart <= {36'($urandom_range(0,7)), 8'($urandom_range(0,3)), 6'($urandom)};
      io_fetch_req_bits_pcMemRead_2_startAddr <= {36'($urandom_range(0,7)), 8'($urandom_range(0,3)), 6'($urandom)};
      io_fetch_req_bits_pcMemRead_2_nextlineStart <= {36'($urandom_range(0,7)), 8'($urandom_range(0,3)), 6'($urandom)};
      io_fetch_req_bits_pcMemRead_3_startAddr <= {36'($urandom_range(0,7)), 8'($urandom_range(0,3)), 6'($urandom)};
      io_fetch_req_bits_pcMemRead_3_nextlineStart <= {36'($urandom_range(0,7)), 8'($urandom_range(0,3)), 6'($urandom)};
      io_fetch_req_bits_pcMemRead_4_startAddr <= {36'($urandom_range(0,7)), 8'($urandom_range(0,3)), 6'($urandom)};
      io_fetch_req_bits_pcMemRead_4_nextlineStart <= {36'($urandom_range(0,7)), 8'($urandom_range(0,3)), 6'($urandom)};
      io_fetch_req_bits_readValid_0 <= ($urandom_range(0,4)!=0);
      io_fetch_req_bits_readValid_1 <= ($urandom_range(0,4)!=0);
      io_fetch_req_bits_readValid_2 <= ($urandom_range(0,4)!=0);
      io_fetch_req_bits_readValid_3 <= ($urandom_range(0,4)!=0);
      io_fetch_req_bits_readValid_4 <= ($urandom_range(0,4)!=0);
      io_fetch_req_bits_backendException <= 1'($urandom);
      io_flush <= ($urandom_range(0,31)==0);
      io_pmp_0_resp_instr <= ($urandom_range(0,9)==0);
      io_pmp_0_resp_mmio <= ($urandom_range(0,9)==0);
      io_pmp_1_resp_instr <= ($urandom_range(0,9)==0);
      io_pmp_1_resp_mmio <= ($urandom_range(0,9)==0);
