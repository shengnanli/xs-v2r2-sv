// 自动生成：scripts/gen_fdivsqrt.py —— 勿手改
`timescale 1ns/1ps
module tb;
  ...
  FDivSqrt    u_g (.clock(clk), .reset(rst), .io_flush_valid(io_flush_valid), .io_flush_bits_robIdx_flag(io_flush_bits_robIdx_flag), .io_flush_bits_robIdx_value(io_flush_bits_robIdx_value), .io_flush_bits_level(io_flush_bits_level), .io_in_valid(io_in_valid), .io_in_bits_ctrl_fuOpType(io_in_bits_ctrl_fuOpType), .io_in_bits_ctrl_robIdx_flag(io_in_bits_ctrl_robIdx_flag), .io_in_bits_ctrl_robIdx_value(io_in_bits_ctrl_robIdx_value), .io_in_bits_ctrl_pdest(io_in_bits_ctrl_pdest), .io_in_bits_ctrl_fpWen(io_in_bits_ctrl_fpWen), .io_in_bits_ctrl_fpu_wflags(io_in_bits_ctrl_fpu_wflags), .io_in_bits_ctrl_fpu_fmt(io_in_bits_ctrl_fpu_fmt), .io_in_bits_ctrl_fpu_rm(io_in_bits_ctrl_fpu_rm), .io_in_bits_data_src_1(io_in_bits_data_src_1), .io_in_bits_data_src_0(io_in_bits_data_src_0), .io_in_bits_perfDebugInfo_enqRsTime(io_in_bits_perfDebugInfo_enqRsTime), .io_in_bits_perfDebugInfo_selectTime(io_in_bits_perfDebugInfo_selectTime), .io_in_bits_perfDebugInfo_issueTime(io_in_bits_perfDebugInfo_issueTime), .io_out_ready(io_out_ready), .io_frm(io_frm), .io_in_ready(g_io_in_ready), .io_out_valid(g_io_out_valid), .io_out_bits_ctrl_robIdx_flag(g_io_out_bits_ctrl_robIdx_flag), .io_out_bits_ctrl_robIdx_value(g_io_out_bits_ctrl_robIdx_value), .io_out_bits_ctrl_pdest(g_io_out_bits_ctrl_pdest), .io_out_bits_ctrl_fpWen(g_io_out_bits_ctrl_fpWen), .io_out_bits_ctrl_fpu_wflags(g_io_out_bits_ctrl_fpu_wflags), .io_out_bits_res_data(g_io_out_bits_res_data), .io_out_bits_res_fflags(g_io_out_bits_res_fflags), .io_out_bits_perfDebugInfo_enqRsTime(g_io_out_bits_perfDebugInfo_enqRsTime), .io_out_bits_perfDebugInfo_selectTime(g_io_out_bits_perfDebugInfo_selectTime), .io_out_bits_perfDebugInfo_issueTime(g_io_out_bits_perfDebugInfo_issueTime));
  FDivSqrt_xs u_i (.clock(clk), .reset(rst), .io_flush_valid(io_flush_valid), .io_flush_bits_robIdx_flag(io_flush_bits_robIdx_flag), .io_flush_bits_robIdx_value(io_flush_bits_robIdx_value), .io_flush_bits_level(io_flush_bits_level), .io_in_valid(io_in_valid), .io_in_bits_ctrl_fuOpType(io_in_bits_ctrl_fuOpType), .io_in_bits_ctrl_robIdx_flag(io_in_bits_ctrl_robIdx_flag), .io_in_bits_ctrl_robIdx_value(io_in_bits_ctrl_robIdx_value), .io_in_bits_ctrl_pdest(io_in_bits_ctrl_pdest), .io_in_bits_ctrl_fpWen(io_in_bits_ctrl_fpWen), .io_in_bits_ctrl_fpu_wflags(io_in_bits_ctrl_fpu_wflags), .io_in_bits_ctrl_fpu_fmt(io_in_bits_ctrl_fpu_fmt), .io_in_bits_ctrl_fpu_rm(io_in_bits_ctrl_fpu_rm), .io_in_bits_data_src_1(io_in_bits_data_src_1), .io_in_bits_data_src_0(io_in_bits_data_src_0), .io_in_bits_perfDebugInfo_enqRsTime(io_in_bits_perfDebugInfo_enqRsTime), .io_in_bits_perfDebugInfo_selectTime(io_in_bits_perfDebugInfo_selectTime), .io_in_bits_perfDebugInfo_issueTime(io_in_bits_perfDebugInfo_issueTime), .io_out_ready(io_out_ready), .io_frm(io_frm), .io_in_ready(i_io_in_ready), .io_out_valid(i_io_out_valid), .io_out_bits_ctrl_robIdx_flag(i_io_out_bits_ctrl_robIdx_flag), .io_out_bits_ctrl_robIdx_value(i_io_out_bits_ctrl_robIdx_value), .io_out_bits_ctrl_pdest(i_io_out_bits_ctrl_pdest), .io_out_bits_ctrl_fpWen(i_io_out_bits_ctrl_fpWen), .io_out_bits_ctrl_fpu_wflags(i_io_out_bits_ctrl_fpu_wflags), .io_out_bits_res_data(i_io_out_bits_res_data), .io_out_bits_res_fflags(i_io_out_bits_res_fflags), .io_out_bits_perfDebugInfo_enqRsTime(i_io_out_bits_perfDebugInfo_enqRsTime), .io_out_bits_perfDebugInfo_selectTime(i_io_out_bits_perfDebugInfo_selectTime), .io_out_bits_perfDebugInfo_issueTime(i_io_out_bits_perfDebugInfo_issueTime));
  // 合法 fuOpType 集合（覆盖各 opType）
  logic [8:0] fops [0:1] = '{9'h00, 9'h01};
  always @(negedge clk) begin
    if (rst) begin
      ...
      io_flush_valid <= ($urandom_range(0,15) == 0); // 偶发重定向冲刷
      ...
      io_in_bits_ctrl_fuOpType <= fops[$urandom_range(0,1)];
      io_in_bits_ctrl_robIdx_flag <= $urandom_range(0,1);
      io_in_bits_ctrl_robIdx_value <= 8'($urandom);
      io_in_bits_ctrl_pdest <= 8'($urandom);
      io_in_bits_ctrl_fpWen <= $urandom_range(0,1);
      io_in_bits_ctrl_fpu_wflags <= $urandom_range(0,1);
      ...
      io_out_ready <= ($urandom_range(0,3) != 0);  // 多数拍可写回
      io_frm <= 3'($urandom);
    end
  end
