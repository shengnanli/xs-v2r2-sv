// =============================================================================
//  TLBuffer_6 —— TileLink A/D 两通道时序缓冲 (可读重写核 xs_TLBuffer_6_core)
// -----------------------------------------------------------------------------
...
// =============================================================================
module xs_TLBuffer_6_core
  import tlbuffer6_pkg::*;
(
  input clock,
  input reset,
  ...
  always_comb begin
    client_a = '{opcode: auto_in_a_bits_opcode, param: auto_in_a_bits_param,
        ...
        address: auto_in_a_bits_address, user_reqSource: auto_in_a_bits_user_reqSource,
        mask: auto_in_a_bits_mask, data: auto_in_a_bits_data,
        corrupt: auto_in_a_bits_corrupt};
  ...
  Queue2_TLBundleA_6 nodeOut_a_q (
    ...
    .io_enq_bits_user_reqSource (client_a.user_reqSource),
