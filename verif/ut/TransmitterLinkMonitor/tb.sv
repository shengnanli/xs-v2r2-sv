...
// TransmitterLinkMonitor 双例化逐拍比对: golden TransmitterLinkMonitor vs 可读 TransmitterLinkMonitor_xs(经 wrapper)。
...
module tb;
  ...
  logic [10:0] io_in_tx_req_bits_srcID;
  ...
  logic [10:0] io_in_tx_rsp_bits_srcID;
  ...
  logic [10:0] io_in_tx_dat_bits_srcID;
  ...
  TransmitterLinkMonitor u_g (
    ...
    .io_in_tx_req_bits_srcID(io_in_tx_req_bits_srcID),
    ...
    .io_in_tx_rsp_bits_srcID(io_in_tx_rsp_bits_srcID),
    ...
    .io_in_tx_dat_bits_srcID(io_in_tx_dat_bits_srcID),
  ...
  task automatic drive_random_inputs();
    ...
    io_in_tx_req_bits_srcID <= 11'({$urandom});
    ...
    io_in_tx_rsp_bits_srcID <= 11'({$urandom});
    ...
    io_in_tx_dat_bits_srcID <= 11'({$urandom});
  ...
  initial begin
    ...
    $display("TransmitterLinkMonitor checks=%0d errors=%0d", checks, errors);
