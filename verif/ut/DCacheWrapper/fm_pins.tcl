# DCacheWrapper FM 钉点(FM 审计 2026-07)
# 32 路 perf 2 级打拍:golden io_perf_<n>_value_REG(第1拍)/REG_1(第2拍) ↔
# 手写核 perf_pipe[n].stage[0]/stage[1](FM 展平名 perf_pipe_reg[n]\[stage][s][b])。
# 驱动型 stub 实验证实 384 failing = 配对错位(通道/拍被 Func 配对交叉),按名逐位钉死。
set _n 0
...
puts "DCACHEWRAPPER_PINS: perf $_n points pinned"
