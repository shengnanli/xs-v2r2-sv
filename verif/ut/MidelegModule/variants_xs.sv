// mideleg UT variant (_xs): instantiate the readable bespoke core xs_mideleg.
module MidelegModule_xs(
  input clock, input reset, input w_wen, input [63:0] w_wdata,
  output [63:0] rdata,
  output regOut_SSI, output regOut_STI, output regOut_SEI, output regOut_LCOFI
);
  xs_mideleg u_core (
