...
module tb;
  ...
  logic [8:0] io_in_bits_ctrlPipe_2_fuOpType;
  ...
  always @(negedge clk) begin
    if (rst) begin
      ...
      io_in_bits_ctrl_fuOpType <= fops[$urandom_range(0,13)];
      io_in_bits_ctrl_fpu_fmt <= 2'($urandom);
      io_in_bits_ctrl_fpu_rm <= 3'($urandom);
      io_in_bits_ctrlPipe_2_fuOpType <= fops[$urandom_range(0,13)];
      ...
      io_in_bits_ctrlPipe_2_fpWen <= $urandom_range(0,1);
      io_in_bits_ctrlPipe_2_fpu_wflags <= $urandom_range(0,1);
