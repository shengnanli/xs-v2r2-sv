...
// Decoupled2LCredit_1 双例化逐拍比对: golden Decoupled2LCredit_1 vs 可读重写 Decoupled2LCredit_1_xs。
`timescale 1ns/1ps
...
module tb;
  ...
  wire g_io_out_flitv;
  wire i_io_out_flitv;
  wire [72:0] g_io_out_flit;
  wire [72:0] i_io_out_flit;

  Decoupled2LCredit_1 u_g (
    .clock(clock),
    .reset(reset),
  ...
  initial begin
    ...
    $display("Decoupled2LCredit_1 checks=%0d errors=%0d", checks, errors);
