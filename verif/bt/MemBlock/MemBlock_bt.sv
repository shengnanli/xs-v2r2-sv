...
(
  ...
  // ==========================================================================
  `include "memblock_inst_bt.svh"

endmodule


// 自动生成: verif/bt/MemBlock/gen_memblock_bt.py —— 勿手改
// MemBlock_bt: 全 golden 端口顶层, 例化重写互联核 xs_MemBlock_core_bt
//   (核里 clean-swap-set 子模块实例已换成重写件 _bt/_xs, 其余子模块保留 golden)。
module MemBlock_bt(
  input clock,
  input reset,
