// 自动生成: scripts/gen_iq_ambb.py(iq tb)—— 勿手改
`timescale 1ns/1ps
module tb;
  ...
  logic io_wbBusyTableRead_1_intWbBusyTable;
  logic [2:0] io_wbBusyTableRead_0_intWbBusyTable;
  ...
  wire [2:0] g_io_wbBusyTableWrite_0_intWbBusyTable;
  wire [2:0] i_io_wbBusyTableWrite_0_intWbBusyTable;
  ...
  wire g_io_wakeupToIQ_0_bits_is0Lat;
  wire i_io_wakeupToIQ_0_bits_is0Lat;
  ...
  IssueQueueAluMulBkuBrhJmp u_g (
    ...
    .io_wbBusyTableWrite_0_intWbBusyTable(g_io_wbBusyTableWrite_0_intWbBusyTable),
    ...
    .io_wakeupToIQ_0_bits_is0Lat(g_io_wakeupToIQ_0_bits_is0Lat),
  ...
  IssueQueueAluMulBkuBrhJmp_xs u_i (
    .clock(clk), .reset(rst),
    .io_flush_valid(io_flush_valid),
    .io_flush_bits_robIdx_flag(io_flush_bits_robIdx_flag),
    .io_flush_bits_robIdx_value(io_flush_bits_robIdx_value),
    ...
    .io_wbBusyTableWrite_0_intWbBusyTable(i_io_wbBusyTableWrite_0_intWbBusyTable),
    ...
    .io_wakeupToIQ_0_bits_is0Lat(i_io_wakeupToIQ_0_bits_is0Lat),
  ...
  task drive_rand();
    ...
    io_wbBusyTableRead_1_intWbBusyTable = $urandom;
  ...
  task check();
    ...
    if (!$isunknown(g_io_wbBusyTableWrite_0_intWbBusyTable) && g_io_wbBusyTableWrite_0_intWbBusyTable !== i_io_wbBusyTableWrite_0_intWbBusyTable) begin errors++;
      if(errors<=120) $display("[%0t] io_wbBusyTableWrite_0_intWbBusyTable g=%h i=%h", $time, g_io_wbBusyTableWrite_0_intWbBusyTable, i_io_wbBusyTableWrite_0_intWbBusyTable); end
    ...
    if (!$isunknown(g_io_wakeupToIQ_0_bits_is0Lat) && g_io_wakeupToIQ_0_bits_is0Lat !== i_io_wakeupToIQ_0_bits_is0Lat) begin errors++;
      if(errors<=120) $display("[%0t] io_wakeupToIQ_0_bits_is0Lat g=%h i=%h", $time, g_io_wakeupToIQ_0_bits_is0Lat, i_io_wakeupToIQ_0_bits_is0Lat); end
