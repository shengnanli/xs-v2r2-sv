...
module TLLogger(
  ...
  xs_TLLogger_core u_core (
    ...
    .auto_in_b_bits_size(auto_in_b_bits_size),
    .auto_in_b_bits_source(auto_in_b_bits_source),
    .auto_in_b_bits_address(auto_in_b_bits_address),
    .auto_in_b_bits_mask(auto_in_b_bits_mask),
    .auto_in_b_bits_data(auto_in_b_bits_data),
    .auto_in_b_bits_corrupt(auto_in_b_bits_corrupt),
