...
// LCredit2Decoupled_10 双例化逐拍比对: golden LCredit2Decoupled_10 vs 可读重写 LCredit2Decoupled_10_xs。
`timescale 1ns/1ps
...
module tb;
  ...
  task automatic drive_random();
    io_in_flitv = $urandom;
    io_in_flit = {$urandom, $urandom, $urandom, $urandom, $urandom, $urandom, $urandom, $urandom, $urandom, $urandom, $urandom, $urandom, $urandom, $urandom};
  ...
  initial begin
    ...
    $display("LCredit2Decoupled_10 checks=%0d errors=%0d", checks, errors);
