...
module BankedDataArray import bankeddata_pkg::*; (
  input clock,
  input reset,
  ...
  // mbistPl 的 per-通道 ack 输出（golden _mbistPl_toSRAM_N_ack）→ 核心 pseudo 注错门控
  wire mb_ack [8][4];
  // 核心 readline 输出级 {ecc,raw} → mbistPl toSRAM_{4b..4b+3}_rdata（golden 接 r_8_b）
  wire [71:0] mb_rl [8];
  xs_BankedDataArray_core u_core (
    ...
    .mbist_chan_ack(mb_ack), .mbist_rl_rdata(mb_rl)
  );
  ...
  wire cb_re [32];
  wire cb_we [32];
  wire [71:0] cb_rdata [32];   // bank bore rdata 输出：golden 顶层同为悬空网（childBd_N_rdata）
  wire cb_ack [32];            // bank bore ack **输入**：golden childBd_N_ack = mbistPl toSRAM_N_ack
  ...
  // golden: childBd_N_ack = _mbistPl_toSRAM_N_ack（bank 的 bore_ack 是输入，须由 mbistPl 驱动）
  for (genvar n = 0; n < 32; n++) begin : g_cback
    assign cb_ack[n] = mb_ack[n/4][n%4];
  end
  ...
  MbistPipeDCacheData mbistPl (
    ...
    .toSRAM_0_addr(cb_addr[0]), .toSRAM_0_addr_rd(cb_addr_rd[0]), .toSRAM_0_wdata(cb_wdata[0]), .toSRAM_0_wmask(cb_wmask[0]), .toSRAM_0_re(cb_re[0]), .toSRAM_0_we(cb_we[0]), .toSRAM_0_rdata(mb_rl[0]), .toSRAM_0_ack(mb_ack[0][0]), .toSRAM_0_selectedOH(cb_selectedOH[0]), .toSRAM_0_array(cb_array_0),
    .toSRAM_1_addr(cb_addr[1]), .toSRAM_1_addr_rd(cb_addr_rd[1]), .toSRAM_1_wdata(cb_wdata[1]), .toSRAM_1_wmask(cb_wmask[1]), .toSRAM_1_re(cb_re[1]), .toSRAM_1_we(cb_we[1]), .toSRAM_1_rdata(mb_rl[0]), .toSRAM_1_ack(mb_ack[0][1]), .toSRAM_1_selectedOH(cb_selectedOH[1]), .toSRAM_1_array(cb_array_1),
    .toSRAM_2_addr(cb_addr[2]), .toSRAM_2_addr_rd(cb_addr_rd[2]), .toSRAM_2_wdata(cb_wdata[2]), .toSRAM_2_wmask(cb_wmask[2]), .toSRAM_2_re(cb_re[2]), .toSRAM_2_we(cb_we[2]), .toSRAM_2_rdata(mb_rl[0]), .toSRAM_2_ack(mb_ack[0][2]), .toSRAM_2_selectedOH(cb_selectedOH[2]), .toSRAM_2_array(cb_array_2),
    .toSRAM_3_addr(cb_addr[3]), .toSRAM_3_addr_rd(cb_addr_rd[3]), .toSRAM_3_wdata(cb_wdata[3]), .toSRAM_3_wmask(cb_wmask[3]), .toSRAM_3_re(cb_re[3]), .toSRAM_3_we(cb_we[3]), .toSRAM_3_rdata(mb_rl[0]), .toSRAM_3_ack(mb_ack[0][3]), .toSRAM_3_selectedOH(cb_selectedOH[3]), .toSRAM_3_array(cb_array_3),
    .toSRAM_4_addr(cb_addr[4]), .toSRAM_4_addr_rd(cb_addr_rd[4]), .toSRAM_4_wdata(cb_wdata[4]), .toSRAM_4_wmask(cb_wmask[4]), .toSRAM_4_re(cb_re[4]), .toSRAM_4_we(cb_we[4]), .toSRAM_4_rdata(mb_rl[1]), .toSRAM_4_ack(mb_ack[1][0]), .toSRAM_4_selectedOH(cb_selectedOH[4]), .toSRAM_4_array(cb_array_4),
    .toSRAM_5_addr(cb_addr[5]), .toSRAM_5_addr_rd(cb_addr_rd[5]), .toSRAM_5_wdata(cb_wdata[5]), .toSRAM_5_wmask(cb_wmask[5]), .toSRAM_5_re(cb_re[5]), .toSRAM_5_we(cb_we[5]), .toSRAM_5_rdata(mb_rl[1]), .toSRAM_5_ack(mb_ack[1][1]), .toSRAM_5_selectedOH(cb_selectedOH[5]), .toSRAM_5_array(cb_array_5),
    .toSRAM_6_addr(cb_addr[6]), .toSRAM_6_addr_rd(cb_addr_rd[6]), .toSRAM_6_wdata(cb_wdata[6]), .toSRAM_6_wmask(cb_wmask[6]), .toSRAM_6_re(cb_re[6]), .toSRAM_6_we(cb_we[6]), .toSRAM_6_rdata(mb_rl[1]), .toSRAM_6_ack(mb_ack[1][2]), .toSRAM_6_selectedOH(cb_selectedOH[6]), .toSRAM_6_array(cb_array_6),
    .toSRAM_7_addr(cb_addr[7]), .toSRAM_7_addr_rd(cb_addr_rd[7]), .toSRAM_7_wdata(cb_wdata[7]), .toSRAM_7_wmask(cb_wmask[7]), .toSRAM_7_re(cb_re[7]), .toSRAM_7_we(cb_we[7]), .toSRAM_7_rdata(mb_rl[1]), .toSRAM_7_ack(mb_ack[1][3]), .toSRAM_7_selectedOH(cb_selectedOH[7]), .toSRAM_7_array(cb_array_7),
    .toSRAM_8_addr(cb_addr[8]), .toSRAM_8_addr_rd(cb_addr_rd[8]), .toSRAM_8_wdata(cb_wdata[8]), .toSRAM_8_wmask(cb_wmask[8]), .toSRAM_8_re(cb_re[8]), .toSRAM_8_we(cb_we[8]), .toSRAM_8_rdata(mb_rl[2]), .toSRAM_8_ack(mb_ack[2][0]), .toSRAM_8_selectedOH(cb_selectedOH[8]), .toSRAM_8_array(cb_array_8),
    .toSRAM_9_addr(cb_addr[9]), .toSRAM_9_addr_rd(cb_addr_rd[9]), .toSRAM_9_wdata(cb_wdata[9]), .toSRAM_9_wmask(cb_wmask[9]), .toSRAM_9_re(cb_re[9]), .toSRAM_9_we(cb_we[9]), .toSRAM_9_rdata(mb_rl[2]), .toSRAM_9_ack(mb_ack[2][1]), .toSRAM_9_selectedOH(cb_selectedOH[9]), .toSRAM_9_array(cb_array_9),
    .toSRAM_10_addr(cb_addr[10]), .toSRAM_10_addr_rd(cb_addr_rd[10]), .toSRAM_10_wdata(cb_wdata[10]), .toSRAM_10_wmask(cb_wmask[10]), .toSRAM_10_re(cb_re[10]), .toSRAM_10_we(cb_we[10]), .toSRAM_10_rdata(mb_rl[2]), .toSRAM_10_ack(mb_ack[2][2]), .toSRAM_10_selectedOH(cb_selectedOH[10]), .toSRAM_10_array(cb_array_10),
    .toSRAM_11_addr(cb_addr[11]), .toSRAM_11_addr_rd(cb_addr_rd[11]), .toSRAM_11_wdata(cb_wdata[11]), .toSRAM_11_wmask(cb_wmask[11]), .toSRAM_11_re(cb_re[11]), .toSRAM_11_we(cb_we[11]), .toSRAM_11_rdata(mb_rl[2]), .toSRAM_11_ack(mb_ack[2][3]), .toSRAM_11_selectedOH(cb_selectedOH[11]), .toSRAM_11_array(cb_array_11),
    .toSRAM_12_addr(cb_addr[12]), .toSRAM_12_addr_rd(cb_addr_rd[12]), .toSRAM_12_wdata(cb_wdata[12]), .toSRAM_12_wmask(cb_wmask[12]), .toSRAM_12_re(cb_re[12]), .toSRAM_12_we(cb_we[12]), .toSRAM_12_rdata(mb_rl[3]), .toSRAM_12_ack(mb_ack[3][0]), .toSRAM_12_selectedOH(cb_selectedOH[12]), .toSRAM_12_array(cb_array_12),
    .toSRAM_13_addr(cb_addr[13]), .toSRAM_13_addr_rd(cb_addr_rd[13]), .toSRAM_13_wdata(cb_wdata[13]), .toSRAM_13_wmask(cb_wmask[13]), .toSRAM_13_re(cb_re[13]), .toSRAM_13_we(cb_we[13]), .toSRAM_13_rdata(mb_rl[3]), .toSRAM_13_ack(mb_ack[3][1]), .toSRAM_13_selectedOH(cb_selectedOH[13]), .toSRAM_13_array(cb_array_13),
    .toSRAM_14_addr(cb_addr[14]), .toSRAM_14_addr_rd(cb_addr_rd[14]), .toSRAM_14_wdata(cb_wdata[14]), .toSRAM_14_wmask(cb_wmask[14]), .toSRAM_14_re(cb_re[14]), .toSRAM_14_we(cb_we[14]), .toSRAM_14_rdata(mb_rl[3]), .toSRAM_14_ack(mb_ack[3][2]), .toSRAM_14_selectedOH(cb_selectedOH[14]), .toSRAM_14_array(cb_array_14),
    .toSRAM_15_addr(cb_addr[15]), .toSRAM_15_addr_rd(cb_addr_rd[15]), .toSRAM_15_wdata(cb_wdata[15]), .toSRAM_15_wmask(cb_wmask[15]), .toSRAM_15_re(cb_re[15]), .toSRAM_15_we(cb_we[15]), .toSRAM_15_rdata(mb_rl[3]), .toSRAM_15_ack(mb_ack[3][3]), .toSRAM_15_selectedOH(cb_selectedOH[15]), .toSRAM_15_array(cb_array_15),
    .toSRAM_16_addr(cb_addr[16]), .toSRAM_16_addr_rd(cb_addr_rd[16]), .toSRAM_16_wdata(cb_wdata[16]), .toSRAM_16_wmask(cb_wmask[16]), .toSRAM_16_re(cb_re[16]), .toSRAM_16_we(cb_we[16]), .toSRAM_16_rdata(mb_rl[4]), .toSRAM_16_ack(mb_ack[4][0]), .toSRAM_16_selectedOH(cb_selectedOH[16]), .toSRAM_16_array(cb_array_16),
    .toSRAM_17_addr(cb_addr[17]), .toSRAM_17_addr_rd(cb_addr_rd[17]), .toSRAM_17_wdata(cb_wdata[17]), .toSRAM_17_wmask(cb_wmask[17]), .toSRAM_17_re(cb_re[17]), .toSRAM_17_we(cb_we[17]), .toSRAM_17_rdata(mb_rl[4]), .toSRAM_17_ack(mb_ack[4][1]), .toSRAM_17_selectedOH(cb_selectedOH[17]), .toSRAM_17_array(cb_array_17),
    .toSRAM_18_addr(cb_addr[18]), .toSRAM_18_addr_rd(cb_addr_rd[18]), .toSRAM_18_wdata(cb_wdata[18]), .toSRAM_18_wmask(cb_wmask[18]), .toSRAM_18_re(cb_re[18]), .toSRAM_18_we(cb_we[18]), .toSRAM_18_rdata(mb_rl[4]), .toSRAM_18_ack(mb_ack[4][2]), .toSRAM_18_selectedOH(cb_selectedOH[18]), .toSRAM_18_array(cb_array_18),
    .toSRAM_19_addr(cb_addr[19]), .toSRAM_19_addr_rd(cb_addr_rd[19]), .toSRAM_19_wdata(cb_wdata[19]), .toSRAM_19_wmask(cb_wmask[19]), .toSRAM_19_re(cb_re[19]), .toSRAM_19_we(cb_we[19]), .toSRAM_19_rdata(mb_rl[4]), .toSRAM_19_ack(mb_ack[4][3]), .toSRAM_19_selectedOH(cb_selectedOH[19]), .toSRAM_19_array(cb_array_19),
    .toSRAM_20_addr(cb_addr[20]), .toSRAM_20_addr_rd(cb_addr_rd[20]), .toSRAM_20_wdata(cb_wdata[20]), .toSRAM_20_wmask(cb_wmask[20]), .toSRAM_20_re(cb_re[20]), .toSRAM_20_we(cb_we[20]), .toSRAM_20_rdata(mb_rl[5]), .toSRAM_20_ack(mb_ack[5][0]), .toSRAM_20_selectedOH(cb_selectedOH[20]), .toSRAM_20_array(cb_array_20),
    .toSRAM_21_addr(cb_addr[21]), .toSRAM_21_addr_rd(cb_addr_rd[21]), .toSRAM_21_wdata(cb_wdata[21]), .toSRAM_21_wmask(cb_wmask[21]), .toSRAM_21_re(cb_re[21]), .toSRAM_21_we(cb_we[21]), .toSRAM_21_rdata(mb_rl[5]), .toSRAM_21_ack(mb_ack[5][1]), .toSRAM_21_selectedOH(cb_selectedOH[21]), .toSRAM_21_array(cb_array_21),
    .toSRAM_22_addr(cb_addr[22]), .toSRAM_22_addr_rd(cb_addr_rd[22]), .toSRAM_22_wdata(cb_wdata[22]), .toSRAM_22_wmask(cb_wmask[22]), .toSRAM_22_re(cb_re[22]), .toSRAM_22_we(cb_we[22]), .toSRAM_22_rdata(mb_rl[5]), .toSRAM_22_ack(mb_ack[5][2]), .toSRAM_22_selectedOH(cb_selectedOH[22]), .toSRAM_22_array(cb_array_22),
    .toSRAM_23_addr(cb_addr[23]), .toSRAM_23_addr_rd(cb_addr_rd[23]), .toSRAM_23_wdata(cb_wdata[23]), .toSRAM_23_wmask(cb_wmask[23]), .toSRAM_23_re(cb_re[23]), .toSRAM_23_we(cb_we[23]), .toSRAM_23_rdata(mb_rl[5]), .toSRAM_23_ack(mb_ack[5][3]), .toSRAM_23_selectedOH(cb_selectedOH[23]), .toSRAM_23_array(cb_array_23),
    .toSRAM_24_addr(cb_addr[24]), .toSRAM_24_addr_rd(cb_addr_rd[24]), .toSRAM_24_wdata(cb_wdata[24]), .toSRAM_24_wmask(cb_wmask[24]), .toSRAM_24_re(cb_re[24]), .toSRAM_24_we(cb_we[24]), .toSRAM_24_rdata(mb_rl[6]), .toSRAM_24_ack(mb_ack[6][0]), .toSRAM_24_selectedOH(cb_selectedOH[24]), .toSRAM_24_array(cb_array_24),
    .toSRAM_25_addr(cb_addr[25]), .toSRAM_25_addr_rd(cb_addr_rd[25]), .toSRAM_25_wdata(cb_wdata[25]), .toSRAM_25_wmask(cb_wmask[25]), .toSRAM_25_re(cb_re[25]), .toSRAM_25_we(cb_we[25]), .toSRAM_25_rdata(mb_rl[6]), .toSRAM_25_ack(mb_ack[6][1]), .toSRAM_25_selectedOH(cb_selectedOH[25]), .toSRAM_25_array(cb_array_25),
    .toSRAM_26_addr(cb_addr[26]), .toSRAM_26_addr_rd(cb_addr_rd[26]), .toSRAM_26_wdata(cb_wdata[26]), .toSRAM_26_wmask(cb_wmask[26]), .toSRAM_26_re(cb_re[26]), .toSRAM_26_we(cb_we[26]), .toSRAM_26_rdata(mb_rl[6]), .toSRAM_26_ack(mb_ack[6][2]), .toSRAM_26_selectedOH(cb_selectedOH[26]), .toSRAM_26_array(cb_array_26),
    .toSRAM_27_addr(cb_addr[27]), .toSRAM_27_addr_rd(cb_addr_rd[27]), .toSRAM_27_wdata(cb_wdata[27]), .toSRAM_27_wmask(cb_wmask[27]), .toSRAM_27_re(cb_re[27]), .toSRAM_27_we(cb_we[27]), .toSRAM_27_rdata(mb_rl[6]), .toSRAM_27_ack(mb_ack[6][3]), .toSRAM_27_selectedOH(cb_selectedOH[27]), .toSRAM_27_array(cb_array_27),
    .toSRAM_28_addr(cb_addr[28]), .toSRAM_28_addr_rd(cb_addr_rd[28]), .toSRAM_28_wdata(cb_wdata[28]), .toSRAM_28_wmask(cb_wmask[28]), .toSRAM_28_re(cb_re[28]), .toSRAM_28_we(cb_we[28]), .toSRAM_28_rdata(mb_rl[7]), .toSRAM_28_ack(mb_ack[7][0]), .toSRAM_28_selectedOH(cb_selectedOH[28]), .toSRAM_28_array(cb_array_28),
    .toSRAM_29_addr(cb_addr[29]), .toSRAM_29_addr_rd(cb_addr_rd[29]), .toSRAM_29_wdata(cb_wdata[29]), .toSRAM_29_wmask(cb_wmask[29]), .toSRAM_29_re(cb_re[29]), .toSRAM_29_we(cb_we[29]), .toSRAM_29_rdata(mb_rl[7]), .toSRAM_29_ack(mb_ack[7][1]), .toSRAM_29_selectedOH(cb_selectedOH[29]), .toSRAM_29_array(cb_array_29),
    .toSRAM_30_addr(cb_addr[30]), .toSRAM_30_addr_rd(cb_addr_rd[30]), .toSRAM_30_wdata(cb_wdata[30]), .toSRAM_30_wmask(cb_wmask[30]), .toSRAM_30_re(cb_re[30]), .toSRAM_30_we(cb_we[30]), .toSRAM_30_rdata(mb_rl[7]), .toSRAM_30_ack(mb_ack[7][2]), .toSRAM_30_selectedOH(cb_selectedOH[30]), .toSRAM_30_array(cb_array_30),
    .toSRAM_31_addr(cb_addr[31]), .toSRAM_31_addr_rd(cb_addr_rd[31]), .toSRAM_31_wdata(cb_wdata[31]), .toSRAM_31_wmask(cb_wmask[31]), .toSRAM_31_re(cb_re[31]), .toSRAM_31_we(cb_we[31]), .toSRAM_31_rdata(mb_rl[7]), .toSRAM_31_ack(mb_ack[7][3]), .toSRAM_31_selectedOH(cb_selectedOH[31]), .toSRAM_31_array(cb_array_31)
  );
