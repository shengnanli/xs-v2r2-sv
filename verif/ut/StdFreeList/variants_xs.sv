...
// golden 同名扁平端口 → 可读核 xs_StdFreeList_core 的机械适配层
module StdFreeList_xs(
  input        clock,
  input        reset,
  input        io_redirect,
  input        io_walk,
  ...
  logic [5:0] io_commit_info_fpWen;
  ...
  assign io_commit_info_fpWen  = {io_commit_info_5_fpWen, io_commit_info_4_fpWen,
                                  io_commit_info_3_fpWen, io_commit_info_2_fpWen,
                                  io_commit_info_1_fpWen, io_commit_info_0_fpWen};
  ...
  xs_StdFreeList_core u_core (
    ...
    .io_commit_info_fpWen(io_commit_info_fpWen),
