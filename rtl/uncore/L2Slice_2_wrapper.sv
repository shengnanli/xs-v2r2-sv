// 手写：L2Slice_2 FM impl 侧顶层, 例化参数化核 xs_L2SliceN_core (BASE='h20)
// golden L2Slice_2: mbist_array 6b / child0 array 6b / child1 array 6b
module L2Slice_2(
  input clock,
  input reset,
  ...
  xs_L2SliceN_core #(
    .ARRAY_W(6), .CH0_ARRAY_W(6), .CH1_ARRAY_W(6), .BASE('h20)
  ) u_core (
    .clock(clock),
    .reset(reset),
