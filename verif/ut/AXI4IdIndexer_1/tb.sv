...
// AXI4IdIndexer_1 双例化逐拍比对: golden AXI4IdIndexer_1 vs 可读 AXI4IdIndexer_1_xs (纯组合 ID 适配器)。
`timescale 1ns/1ps
...
module tb;
  ...
  logic [1:0] auto_out_b_bits_id;
  logic [1:0] auto_out_b_bits_resp;
  logic [4:0] auto_out_b_bits_echo_extra_id;
  logic auto_out_ar_ready;
  logic auto_out_r_valid;
  logic [1:0] auto_out_r_bits_id;
  logic [63:0] auto_out_r_bits_data;
  logic [1:0] auto_out_r_bits_resp;
  logic [4:0] auto_out_r_bits_echo_extra_id;
  ...
  wire [1:0] g_auto_out_aw_bits_id;
  wire [1:0] i_auto_out_aw_bits_id;
  wire [30:0] g_auto_out_aw_bits_addr;
  wire [30:0] i_auto_out_aw_bits_addr;
  ...
  wire g_auto_out_aw_bits_lock;
  wire i_auto_out_aw_bits_lock;
  ...
  wire [4:0] g_auto_out_aw_bits_echo_extra_id;
  wire [4:0] i_auto_out_aw_bits_echo_extra_id;
  wire g_auto_out_w_valid;
  wire i_auto_out_w_valid;
  wire [63:0] g_auto_out_w_bits_data;
  wire [63:0] i_auto_out_w_bits_data;
  wire [7:0] g_auto_out_w_bits_strb;
  wire [7:0] i_auto_out_w_bits_strb;
  ...
  wire [1:0] g_auto_out_ar_bits_id;
  wire [1:0] i_auto_out_ar_bits_id;
  wire [30:0] g_auto_out_ar_bits_addr;
  wire [30:0] i_auto_out_ar_bits_addr;
  ...
  wire g_auto_out_ar_bits_lock;
  wire i_auto_out_ar_bits_lock;
  ...
  wire [4:0] g_auto_out_ar_bits_echo_extra_id;
  wire [4:0] i_auto_out_ar_bits_echo_extra_id;
  ...
  AXI4IdIndexer_1 u_g (
    ...
    .auto_out_aw_bits_lock(g_auto_out_aw_bits_lock),
    ...
    .auto_out_aw_bits_echo_extra_id(g_auto_out_aw_bits_echo_extra_id),
    ...
    .auto_out_ar_bits_lock(g_auto_out_ar_bits_lock),
    ...
    .auto_out_ar_bits_echo_extra_id(g_auto_out_ar_bits_echo_extra_id),
  ...
  AXI4IdIndexer_1_xs u_i (
    ...
    .auto_out_aw_bits_lock(i_auto_out_aw_bits_lock),
    ...
    .auto_out_aw_bits_echo_extra_id(i_auto_out_aw_bits_echo_extra_id),
    .auto_out_w_ready(auto_out_w_ready),
    ...
    .auto_out_ar_bits_lock(i_auto_out_ar_bits_lock),
    ...
    .auto_out_ar_bits_echo_extra_id(i_auto_out_ar_bits_echo_extra_id),
  ...
  task automatic drive_random_inputs();
    ...
    auto_in_aw_bits_addr <= 31'({$urandom});
    ...
    auto_in_ar_bits_addr <= 31'({$urandom});
    ...
    auto_out_b_bits_id <= 2'({$urandom});
    auto_out_b_bits_resp <= 2'({$urandom});
    auto_out_b_bits_echo_extra_id <= 5'({$urandom});
    auto_out_ar_ready <= $urandom_range(0, 1);
    auto_out_r_valid <= $urandom_range(0, 1);
    auto_out_r_bits_id <= 2'({$urandom});
    auto_out_r_bits_data <= 64'({$urandom, $urandom});
    auto_out_r_bits_resp <= 2'({$urandom});
    auto_out_r_bits_echo_extra_id <= 5'({$urandom});
  ...
  initial begin
    ...
    auto_out_b_bits_resp = '0;
    auto_out_b_bits_echo_extra_id = '0;
    auto_out_ar_ready = '0;
    auto_out_r_valid = '0;
    auto_out_r_bits_id = '0;
    auto_out_r_bits_data = '0;
    auto_out_r_bits_resp = '0;
    auto_out_r_bits_echo_extra_id = '0;
    ...
    $display("AXI4IdIndexer_1 checks=%0d errors=%0d", checks, errors);
