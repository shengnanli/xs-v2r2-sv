...
module ICacheCtrlUnit_xs(
  ...
  xs_ICacheCtrlUnit_core #(
    ...
    .clock                          (clock),
    .reset                          (reset),
    .req_valid                      (q_deq_valid),
    .req_is_read                    (q_deq_bits_read),
    .req_index                      (q_deq_bits_index),
    .req_wdata                      (q_deq_bits_data),
    .req_byte_mask                  (q_deq_bits_mask),
    .resp_ready                     (auto_in_d_ready),
    .resp_rdata                     (auto_in_d_bits_data),
