...
module tb;
  ...
  logic [63:0] io_in_2_0_bits_src_2;
  ...
  logic io_in_2_0_bits_fpWen;
  logic io_in_2_0_bits_fpu_wflags;
  logic [1:0] io_in_2_0_bits_fpu_fmt;
  logic [2:0] io_in_2_0_bits_fpu_rm;
  ...
  logic [1:0] io_in_1_1_bits_fpu_fmt;
  logic [2:0] io_in_1_1_bits_fpu_rm;
  ...
  logic [63:0] io_in_1_0_bits_src_2;
  ...
  logic io_in_1_0_bits_fpWen;
  logic io_in_1_0_bits_fpu_wflags;
  logic [1:0] io_in_1_0_bits_fpu_fmt;
  logic [2:0] io_in_1_0_bits_fpu_rm;
  ...
  logic [1:0] io_in_0_1_bits_fpu_fmt;
  logic [2:0] io_in_0_1_bits_fpu_rm;
  ...
  logic [63:0] io_in_0_0_bits_src_2;
  ...
  logic io_in_0_0_bits_fpWen;
  logic io_in_0_0_bits_vecWen;
  logic io_in_0_0_bits_v0Wen;
  logic io_in_0_0_bits_fpu_wflags;
  logic [1:0] io_in_0_0_bits_fpu_fmt;
  logic [2:0] io_in_0_0_bits_fpu_rm;
  ...
  logic io_out_1_1_ready;
  logic io_out_0_1_ready;
  logic [2:0] io_frm;
  logic cg_bore_cgen;
  ...
  wire g_io_in_1_1_ready;
  wire i_io_in_1_1_ready;
  wire g_io_in_0_1_ready;
  wire i_io_in_0_1_ready;
  ...
  wire [63:0] g_io_out_2_0_bits_data_2;
  wire [63:0] i_io_out_2_0_bits_data_2;
  ...
  wire g_io_out_2_0_bits_fpWen;
  wire i_io_out_2_0_bits_fpWen;
  ...
  wire [63:0] g_io_out_1_0_bits_data_2;
  wire [63:0] i_io_out_1_0_bits_data_2;
  ...
  wire g_io_out_1_0_bits_fpWen;
  wire i_io_out_1_0_bits_fpWen;
  ...
  wire [127:0] g_io_out_0_0_bits_data_0;
  wire [127:0] i_io_out_0_0_bits_data_0;
  ...
  wire [127:0] g_io_out_0_0_bits_data_3;
  wire [127:0] i_io_out_0_0_bits_data_3;
  wire [127:0] g_io_out_0_0_bits_data_4;
  wire [127:0] i_io_out_0_0_bits_data_4;
  ...
  wire g_io_out_0_0_bits_fpWen;
  wire i_io_out_0_0_bits_fpWen;
  ...
  ExuBlock_1 u_g (
    ...
    .io_in_1_1_ready(g_io_in_1_1_ready),
    ...
    .io_in_0_1_ready(g_io_in_0_1_ready),
    ...
    .io_out_2_0_bits_fpWen(g_io_out_2_0_bits_fpWen),
    ...
    .io_out_1_0_bits_fpWen(g_io_out_1_0_bits_fpWen),
    ...
    .io_out_0_0_bits_data_3(g_io_out_0_0_bits_data_3),
    .io_out_0_0_bits_data_4(g_io_out_0_0_bits_data_4),
    ...
    .io_out_0_0_bits_fpWen(g_io_out_0_0_bits_fpWen),
  ...
  ExuBlock_1_xs u_i (
    ...
    .io_in_2_0_bits_perfDebugInfo_selectTime(io_in_2_0_bits_perfDebugInfo_selectTime),
    .io_in_2_0_bits_perfDebugInfo_issueTime(io_in_2_0_bits_perfDebugInfo_issueTime),
    .io_in_1_1_ready(i_io_in_1_1_ready),
    .io_in_1_1_valid(io_in_1_1_valid),
    .io_in_1_1_bits_fuType(io_in_1_1_bits_fuType),
    .io_in_1_1_bits_fuOpType(io_in_1_1_bits_fuOpType),
    .io_in_1_1_bits_src_0(io_in_1_1_bits_src_0),
    ...
    .io_in_1_0_bits_perfDebugInfo_selectTime(io_in_1_0_bits_perfDebugInfo_selectTime),
    .io_in_1_0_bits_perfDebugInfo_issueTime(io_in_1_0_bits_perfDebugInfo_issueTime),
    .io_in_0_1_ready(i_io_in_0_1_ready),
    .io_in_0_1_valid(io_in_0_1_valid),
    .io_in_0_1_bits_fuType(io_in_0_1_bits_fuType),
    .io_in_0_1_bits_fuOpType(io_in_0_1_bits_fuOpType),
    .io_in_0_1_bits_src_0(io_in_0_1_bits_src_0),
    ...
    .io_out_2_0_bits_fpWen(i_io_out_2_0_bits_fpWen),
    ...
    .io_out_1_0_bits_fpWen(i_io_out_1_0_bits_fpWen),
    ...
    .io_out_0_0_bits_data_3(i_io_out_0_0_bits_data_3),
    .io_out_0_0_bits_data_4(i_io_out_0_0_bits_data_4),
    ...
    .io_out_0_0_bits_fpWen(i_io_out_0_0_bits_fpWen),
  ...
  always @(posedge clk) if (!rst) begin
    ...
    io_in_2_0_bits_src_2 <= 64'($urandom);
    ...
    io_in_2_0_bits_fpWen <= $urandom_range(0,1);
    io_in_2_0_bits_fpu_wflags <= $urandom_range(0,1);
    io_in_2_0_bits_fpu_fmt <= 2'($urandom);
    io_in_2_0_bits_fpu_rm <= 3'($urandom);
    ...
    io_in_1_1_bits_fpu_fmt <= 2'($urandom);
    io_in_1_1_bits_fpu_rm <= 3'($urandom);
    ...
    io_in_1_0_bits_src_2 <= 64'($urandom);
    ...
    io_in_1_0_bits_fpWen <= $urandom_range(0,1);
    io_in_1_0_bits_fpu_wflags <= $urandom_range(0,1);
    io_in_1_0_bits_fpu_fmt <= 2'($urandom);
    io_in_1_0_bits_fpu_rm <= 3'($urandom);
    ...
    io_in_0_1_bits_fpu_fmt <= 2'($urandom);
    io_in_0_1_bits_fpu_rm <= 3'($urandom);
    ...
    io_in_0_0_bits_src_2 <= 64'($urandom);
    ...
    io_out_1_1_ready <= $urandom_range(0,1);
    io_out_0_1_ready <= $urandom_range(0,1);
    io_frm <= 3'($urandom);
  ...
  always @(negedge clk) if (!rst) begin
    #4; checks++;
    if (!$isunknown(g_io_in_1_1_ready) && g_io_in_1_1_ready !== i_io_in_1_1_ready) begin errors++;
      if(errors<=80) $display("[%0t] io_in_1_1_ready g=%h i=%h", $time, g_io_in_1_1_ready, i_io_in_1_1_ready); end
    if (!$isunknown(g_io_in_0_1_ready) && g_io_in_0_1_ready !== i_io_in_0_1_ready) begin errors++;
      if(errors<=80) $display("[%0t] io_in_0_1_ready g=%h i=%h", $time, g_io_in_0_1_ready, i_io_in_0_1_ready); end
    ...
    if (!$isunknown(g_io_out_2_0_bits_fpWen) && g_io_out_2_0_bits_fpWen !== i_io_out_2_0_bits_fpWen) begin errors++;
      if(errors<=80) $display("[%0t] io_out_2_0_bits_fpWen g=%h i=%h", $time, g_io_out_2_0_bits_fpWen, i_io_out_2_0_bits_fpWen); end
    ...
    if (!$isunknown(g_io_out_1_0_bits_fpWen) && g_io_out_1_0_bits_fpWen !== i_io_out_1_0_bits_fpWen) begin errors++;
      if(errors<=80) $display("[%0t] io_out_1_0_bits_fpWen g=%h i=%h", $time, g_io_out_1_0_bits_fpWen, i_io_out_1_0_bits_fpWen); end
    ...
    if (!$isunknown(g_io_out_0_0_bits_data_3) && g_io_out_0_0_bits_data_3 !== i_io_out_0_0_bits_data_3) begin errors++;
      if(errors<=80) $display("[%0t] io_out_0_0_bits_data_3 g=%h i=%h", $time, g_io_out_0_0_bits_data_3, i_io_out_0_0_bits_data_3); end
    if (!$isunknown(g_io_out_0_0_bits_data_4) && g_io_out_0_0_bits_data_4 !== i_io_out_0_0_bits_data_4) begin errors++;
      if(errors<=80) $display("[%0t] io_out_0_0_bits_data_4 g=%h i=%h", $time, g_io_out_0_0_bits_data_4, i_io_out_0_0_bits_data_4); end
    ...
    if (!$isunknown(g_io_out_0_0_bits_fpWen) && g_io_out_0_0_bits_fpWen !== i_io_out_0_0_bits_fpWen) begin errors++;
      if(errors<=80) $display("[%0t] io_out_0_0_bits_fpWen g=%h i=%h", $time, g_io_out_0_0_bits_fpWen, i_io_out_0_0_bits_fpWen); end
