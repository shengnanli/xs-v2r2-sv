// 变体核 xs_Slice_3_core —— 由 scripts/gen_slice_variants.py 从绿基线
// xs_Slice_core 机械派生(sliceId=3, 子模块 Directory_3/DataStorage_3/
// L2Slice_3, MBIST array-id 位宽按 golden Slice_3 收窄/加宽)。勿手改。
...
module xs_Slice_3_core (
  input clock,
  input reset,
`include "slice_3_ports.svh"
);
