...
module tb;
  ...
  logic auto_uncache_in_a_valid;
  logic [3:0] auto_uncache_in_a_bits_opcode;
  logic [1:0] auto_uncache_in_a_bits_size;
  logic [1:0] auto_uncache_in_a_bits_source;
  logic [29:0] auto_uncache_in_a_bits_address;
  logic [7:0] auto_uncache_in_a_bits_mask;
  logic [63:0] auto_uncache_in_a_bits_data;
  logic auto_uncache_in_d_ready;
  ...
  wire g_auto_uncache_in_a_ready;
  wire i_auto_uncache_in_a_ready;
  wire g_auto_uncache_in_d_valid;
  wire i_auto_uncache_in_d_valid;
  wire [3:0] g_auto_uncache_in_d_bits_opcode;
  wire [3:0] i_auto_uncache_in_d_bits_opcode;
  wire [1:0] g_auto_uncache_in_d_bits_size;
  wire [1:0] i_auto_uncache_in_d_bits_size;
  wire [1:0] g_auto_uncache_in_d_bits_source;
  wire [1:0] i_auto_uncache_in_d_bits_source;
  wire [63:0] g_auto_uncache_in_d_bits_data;
  wire [63:0] i_auto_uncache_in_d_bits_data;
  ...
  always @(negedge clk) begin
    if (rst) begin
      ...
      auto_uncache_in_a_valid <= ($urandom_range(0,2)!=0);
      auto_uncache_in_a_bits_opcode <= 4'($urandom);
      auto_uncache_in_a_bits_size <= 2'($urandom);
      auto_uncache_in_a_bits_source <= 2'($urandom);
      auto_uncache_in_a_bits_address <= {22'($urandom_range(0,3)), 8'($urandom)};
      auto_uncache_in_a_bits_mask <= 8'($urandom);
      auto_uncache_in_a_bits_data <= 64'({$urandom(), $urandom()});
      auto_uncache_in_d_ready <= ($urandom_range(0,2)!=0);
      auto_client_out_a_ready <= ($urandom_range(0,2)!=0);
      auto_client_out_b_valid <= ($urandom_range(0,2)!=0);
      auto_client_out_b_bits_opcode <= 3'($urandom);
      auto_client_out_b_bits_param <= 2'($urandom);
      auto_client_out_b_bits_address <= {40'($urandom_range(0,3)), 8'($urandom)};
      auto_client_out_b_bits_data <= 256'({$urandom(), $urandom(), $urandom(), $urandom(), $urandom(), $urandom(), $urandom(), $urandom()});
      auto_client_out_c_ready <= ($urandom_range(0,2)!=0);
      ...
      auto_client_out_e_ready <= ($urandom_range(0,2)!=0);
      io_l2_pf_store_only <= $urandom_range(0,1);
      io_lsu_load_0_req_valid <= ($urandom_range(0,2)!=0);
      io_lsu_load_0_req_bits_cmd <= 5'($urandom);
      io_lsu_load_0_req_bits_vaddr <= {42'($urandom_range(0,3)), 8'($urandom)};
      io_lsu_load_0_req_bits_vaddr_dup <= {42'($urandom_range(0,3)), 8'($urandom)};
      ...
      io_lsu_load_0_s1_kill <= ($urandom_range(0,2)!=0);
      io_lsu_load_0_s2_kill <= ($urandom_range(0,2)!=0);
      io_lsu_load_0_is128Req <= $urandom_range(0,1);
      io_lsu_load_0_pf_source <= 3'($urandom);
      io_lsu_load_0_s1_paddr_dup_lsu <= {40'($urandom_range(0,3)), 8'($urandom)};
      io_lsu_load_0_s1_paddr_dup_dcache <= {40'($urandom_range(0,3)), 8'($urandom)};
      io_lsu_load_1_req_valid <= ($urandom_range(0,2)!=0);
      io_lsu_load_1_req_bits_cmd <= 5'($urandom);
      io_lsu_load_1_req_bits_vaddr <= {42'($urandom_range(0,3)), 8'($urandom)};
      io_lsu_load_1_req_bits_vaddr_dup <= {42'($urandom_range(0,3)), 8'($urandom)};
      ...
      io_lsu_load_1_s1_kill <= ($urandom_range(0,2)!=0);
      io_lsu_load_1_s2_kill <= ($urandom_range(0,2)!=0);
      io_lsu_load_1_is128Req <= $urandom_range(0,1);
      io_lsu_load_1_pf_source <= 3'($urandom);
      io_lsu_load_1_s1_paddr_dup_lsu <= {40'($urandom_range(0,3)), 8'($urandom)};
      io_lsu_load_1_s1_paddr_dup_dcache <= {40'($urandom_range(0,3)), 8'($urandom)};
      io_lsu_load_2_req_valid <= ($urandom_range(0,2)!=0);
      io_lsu_load_2_req_bits_cmd <= 5'($urandom);
      io_lsu_load_2_req_bits_vaddr <= {42'($urandom_range(0,3)), 8'($urandom)};
      io_lsu_load_2_req_bits_vaddr_dup <= {42'($urandom_range(0,3)), 8'($urandom)};
      ...
      io_lsu_load_2_s1_kill <= ($urandom_range(0,2)!=0);
      io_lsu_load_2_s2_kill <= ($urandom_range(0,2)!=0);
      io_lsu_load_2_is128Req <= $urandom_range(0,1);
      io_lsu_load_2_pf_source <= 3'($urandom);
      io_lsu_load_2_s1_paddr_dup_lsu <= {40'($urandom_range(0,3)), 8'($urandom)};
      io_lsu_load_2_s1_paddr_dup_dcache <= {40'($urandom_range(0,3)), 8'($urandom)};
      io_lsu_sta_0_req_valid <= ($urandom_range(0,2)!=0);
      io_lsu_sta_1_req_valid <= ($urandom_range(0,2)!=0);
      io_lsu_store_req_valid <= ($urandom_range(0,2)!=0);
      io_lsu_store_req_bits_vaddr <= {42'($urandom_range(0,3)), 8'($urandom)};
      io_lsu_store_req_bits_addr <= {40'($urandom_range(0,3)), 8'($urandom)};
      ...
      io_lsu_atomics_req_valid <= ($urandom_range(0,2)!=0);
      io_lsu_atomics_req_bits_cmd <= 5'($urandom);
      io_lsu_atomics_req_bits_vaddr <= {42'($urandom_range(0,3)), 8'($urandom)};
      io_lsu_atomics_req_bits_addr <= {40'($urandom_range(0,3)), 8'($urandom)};
      ...
      io_lsu_forward_mshr_0_valid <= ($urandom_range(0,2)!=0);
      io_lsu_forward_mshr_0_mshrid <= 4'($urandom);
      io_lsu_forward_mshr_0_paddr <= {40'($urandom_range(0,3)), 8'($urandom)};
      io_lsu_forward_mshr_1_valid <= ($urandom_range(0,2)!=0);
      io_lsu_forward_mshr_1_mshrid <= 4'($urandom);
      io_lsu_forward_mshr_1_paddr <= {40'($urandom_range(0,3)), 8'($urandom)};
      io_lsu_forward_mshr_2_valid <= ($urandom_range(0,2)!=0);
      io_lsu_forward_mshr_2_mshrid <= 4'($urandom);
      io_lsu_forward_mshr_2_paddr <= {40'($urandom_range(0,3)), 8'($urandom)};
      io_lqEmpty <= $urandom_range(0,1);
      io_debugTopDown_robHeadVaddr_valid <= ($urandom_range(0,2)!=0);
      io_debugTopDown_robHeadVaddr_bits <= {42'($urandom_range(0,3)), 8'($urandom)};
      io_l2_hint_valid <= ($urandom_range(0,2)!=0);
      io_l2_hint_bits_sourceId <= 4'($urandom);
      io_cmoOpReq_valid <= ($urandom_range(0,2)!=0);
      io_cmoOpReq_bits_opcode <= 3'($urandom);
      io_cmoOpReq_bits_address <= {56'($urandom_range(0,3)), 8'($urandom)};
      io_cmoOpResp_ready <= ($urandom_range(0,2)!=0);
      ...
      boreChildrenBd_bore_addr <= {1'($urandom_range(0,3)), 8'($urandom)};
      boreChildrenBd_bore_indata <= 72'({$urandom(), $urandom(), $urandom()});
      boreChildrenBd_bore_readen <= $urandom_range(0,1);
      boreChildrenBd_bore_addr_rd <= {1'($urandom_range(0,3)), 8'($urandom)};
      ...
      boreChildrenBd_bore_1_addr <= {1'($urandom_range(0,3)), 8'($urandom)};
      boreChildrenBd_bore_1_indata <= 86'({$urandom(), $urandom(), $urandom()});
      boreChildrenBd_bore_1_readen <= $urandom_range(0,1);
      boreChildrenBd_bore_1_addr_rd <= {1'($urandom_range(0,3)), 8'($urandom)};
  ...
  initial begin
    ...
    for (int unsigned c = 0; c < NCYCLES; c++) begin
      @(posedge clk); #1;
      if (!$isunknown(g_auto_uncache_in_a_ready)) begin checks++; if (g_auto_uncache_in_a_ready !== i_auto_uncache_in_a_ready) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_uncache_in_a_ready: g=%h i=%h", $time, g_auto_uncache_in_a_ready, i_auto_uncache_in_a_ready); end end
      if (!$isunknown(g_auto_uncache_in_d_valid)) begin checks++; if (g_auto_uncache_in_d_valid !== i_auto_uncache_in_d_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_uncache_in_d_valid: g=%h i=%h", $time, g_auto_uncache_in_d_valid, i_auto_uncache_in_d_valid); end end
      if (!$isunknown(g_auto_uncache_in_d_bits_opcode)) begin checks++; if (g_auto_uncache_in_d_bits_opcode !== i_auto_uncache_in_d_bits_opcode) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_uncache_in_d_bits_opcode: g=%h i=%h", $time, g_auto_uncache_in_d_bits_opcode, i_auto_uncache_in_d_bits_opcode); end end
      if (!$isunknown(g_auto_uncache_in_d_bits_size)) begin checks++; if (g_auto_uncache_in_d_bits_size !== i_auto_uncache_in_d_bits_size) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_uncache_in_d_bits_size: g=%h i=%h", $time, g_auto_uncache_in_d_bits_size, i_auto_uncache_in_d_bits_size); end end
      if (!$isunknown(g_auto_uncache_in_d_bits_source)) begin checks++; if (g_auto_uncache_in_d_bits_source !== i_auto_uncache_in_d_bits_source) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_uncache_in_d_bits_source: g=%h i=%h", $time, g_auto_uncache_in_d_bits_source, i_auto_uncache_in_d_bits_source); end end
      if (!$isunknown(g_auto_uncache_in_d_bits_data)) begin checks++; if (g_auto_uncache_in_d_bits_data !== i_auto_uncache_in_d_bits_data) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_uncache_in_d_bits_data: g=%h i=%h", $time, g_auto_uncache_in_d_bits_data, i_auto_uncache_in_d_bits_data); end end
      if (!$isunknown(g_auto_client_out_a_valid)) begin checks++; if (g_auto_client_out_a_valid !== i_auto_client_out_a_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_a_valid: g=%h i=%h", $time, g_auto_client_out_a_valid, i_auto_client_out_a_valid); end end
      if (!$isunknown(g_auto_client_out_a_bits_opcode)) begin checks++; if (g_auto_client_out_a_bits_opcode !== i_auto_client_out_a_bits_opcode) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_a_bits_opcode: g=%h i=%h", $time, g_auto_client_out_a_bits_opcode, i_auto_client_out_a_bits_opcode); end end
      if (!$isunknown(g_auto_client_out_a_bits_param)) begin checks++; if (g_auto_client_out_a_bits_param !== i_auto_client_out_a_bits_param) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_a_bits_param: g=%h i=%h", $time, g_auto_client_out_a_bits_param, i_auto_client_out_a_bits_param); end end
      if (!$isunknown(g_auto_client_out_a_bits_size)) begin checks++; if (g_auto_client_out_a_bits_size !== i_auto_client_out_a_bits_size) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_a_bits_size: g=%h i=%h", $time, g_auto_client_out_a_bits_size, i_auto_client_out_a_bits_size); end end
      if (!$isunknown(g_auto_client_out_a_bits_source)) begin checks++; if (g_auto_client_out_a_bits_source !== i_auto_client_out_a_bits_source) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_a_bits_source: g=%h i=%h", $time, g_auto_client_out_a_bits_source, i_auto_client_out_a_bits_source); end end
      if (!$isunknown(g_auto_client_out_a_bits_address)) begin checks++; if (g_auto_client_out_a_bits_address !== i_auto_client_out_a_bits_address) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_a_bits_address: g=%h i=%h", $time, g_auto_client_out_a_bits_address, i_auto_client_out_a_bits_address); end end
      if (!$isunknown(g_auto_client_out_a_bits_user_alias)) begin checks++; if (g_auto_client_out_a_bits_user_alias !== i_auto_client_out_a_bits_user_alias) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_a_bits_user_alias: g=%h i=%h", $time, g_auto_client_out_a_bits_user_alias, i_auto_client_out_a_bits_user_alias); end end
      if (!$isunknown(g_auto_client_out_a_bits_user_vaddr)) begin checks++; if (g_auto_client_out_a_bits_user_vaddr !== i_auto_client_out_a_bits_user_vaddr) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_a_bits_user_vaddr: g=%h i=%h", $time, g_auto_client_out_a_bits_user_vaddr, i_auto_client_out_a_bits_user_vaddr); end end
      if (!$isunknown(g_auto_client_out_a_bits_user_reqSource)) begin checks++; if (g_auto_client_out_a_bits_user_reqSource !== i_auto_client_out_a_bits_user_reqSource) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_a_bits_user_reqSource: g=%h i=%h", $time, g_auto_client_out_a_bits_user_reqSource, i_auto_client_out_a_bits_user_reqSource); end end
      if (!$isunknown(g_auto_client_out_a_bits_user_needHint)) begin checks++; if (g_auto_client_out_a_bits_user_needHint !== i_auto_client_out_a_bits_user_needHint) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_a_bits_user_needHint: g=%h i=%h", $time, g_auto_client_out_a_bits_user_needHint, i_auto_client_out_a_bits_user_needHint); end end
      if (!$isunknown(g_auto_client_out_a_bits_echo_isKeyword)) begin checks++; if (g_auto_client_out_a_bits_echo_isKeyword !== i_auto_client_out_a_bits_echo_isKeyword) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_a_bits_echo_isKeyword: g=%h i=%h", $time, g_auto_client_out_a_bits_echo_isKeyword, i_auto_client_out_a_bits_echo_isKeyword); end end
      if (!$isunknown(g_auto_client_out_a_bits_mask)) begin checks++; if (g_auto_client_out_a_bits_mask !== i_auto_client_out_a_bits_mask) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_a_bits_mask: g=%h i=%h", $time, g_auto_client_out_a_bits_mask, i_auto_client_out_a_bits_mask); end end
      if (!$isunknown(g_auto_client_out_b_ready)) begin checks++; if (g_auto_client_out_b_ready !== i_auto_client_out_b_ready) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_b_ready: g=%h i=%h", $time, g_auto_client_out_b_ready, i_auto_client_out_b_ready); end end
      if (!$isunknown(g_auto_client_out_c_valid)) begin checks++; if (g_auto_client_out_c_valid !== i_auto_client_out_c_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_c_valid: g=%h i=%h", $time, g_auto_client_out_c_valid, i_auto_client_out_c_valid); end end
      if (!$isunknown(g_auto_client_out_c_bits_opcode)) begin checks++; if (g_auto_client_out_c_bits_opcode !== i_auto_client_out_c_bits_opcode) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_c_bits_opcode: g=%h i=%h", $time, g_auto_client_out_c_bits_opcode, i_auto_client_out_c_bits_opcode); end end
      if (!$isunknown(g_auto_client_out_c_bits_param)) begin checks++; if (g_auto_client_out_c_bits_param !== i_auto_client_out_c_bits_param) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_c_bits_param: g=%h i=%h", $time, g_auto_client_out_c_bits_param, i_auto_client_out_c_bits_param); end end
      if (!$isunknown(g_auto_client_out_c_bits_size)) begin checks++; if (g_auto_client_out_c_bits_size !== i_auto_client_out_c_bits_size) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_c_bits_size: g=%h i=%h", $time, g_auto_client_out_c_bits_size, i_auto_client_out_c_bits_size); end end
      if (!$isunknown(g_auto_client_out_c_bits_source)) begin checks++; if (g_auto_client_out_c_bits_source !== i_auto_client_out_c_bits_source) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_c_bits_source: g=%h i=%h", $time, g_auto_client_out_c_bits_source, i_auto_client_out_c_bits_source); end end
      if (!$isunknown(g_auto_client_out_c_bits_address)) begin checks++; if (g_auto_client_out_c_bits_address !== i_auto_client_out_c_bits_address) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_c_bits_address: g=%h i=%h", $time, g_auto_client_out_c_bits_address, i_auto_client_out_c_bits_address); end end
      if (!$isunknown(g_auto_client_out_c_bits_data)) begin checks++; if (g_auto_client_out_c_bits_data !== i_auto_client_out_c_bits_data) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_c_bits_data: g=%h i=%h", $time, g_auto_client_out_c_bits_data, i_auto_client_out_c_bits_data); end end
      if (!$isunknown(g_auto_client_out_c_bits_corrupt)) begin checks++; if (g_auto_client_out_c_bits_corrupt !== i_auto_client_out_c_bits_corrupt) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_c_bits_corrupt: g=%h i=%h", $time, g_auto_client_out_c_bits_corrupt, i_auto_client_out_c_bits_corrupt); end end
      if (!$isunknown(g_auto_client_out_d_ready)) begin checks++; if (g_auto_client_out_d_ready !== i_auto_client_out_d_ready) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_d_ready: g=%h i=%h", $time, g_auto_client_out_d_ready, i_auto_client_out_d_ready); end end
      if (!$isunknown(g_auto_client_out_e_valid)) begin checks++; if (g_auto_client_out_e_valid !== i_auto_client_out_e_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_e_valid: g=%h i=%h", $time, g_auto_client_out_e_valid, i_auto_client_out_e_valid); end end
      if (!$isunknown(g_auto_client_out_e_bits_sink)) begin checks++; if (g_auto_client_out_e_bits_sink !== i_auto_client_out_e_bits_sink) begin errors++; if (errors<=20) $display("  MISMATCH %0t auto_client_out_e_bits_sink: g=%h i=%h", $time, g_auto_client_out_e_bits_sink, i_auto_client_out_e_bits_sink); end end
      if (!$isunknown(g_io_lsu_load_0_req_ready)) begin checks++; if (g_io_lsu_load_0_req_ready !== i_io_lsu_load_0_req_ready) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_0_req_ready: g=%h i=%h", $time, g_io_lsu_load_0_req_ready, i_io_lsu_load_0_req_ready); end end
      if (!$isunknown(g_io_lsu_load_0_resp_valid)) begin checks++; if (g_io_lsu_load_0_resp_valid !== i_io_lsu_load_0_resp_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_0_resp_valid: g=%h i=%h", $time, g_io_lsu_load_0_resp_valid, i_io_lsu_load_0_resp_valid); end end
      if (!$isunknown(g_io_lsu_load_0_resp_bits_data)) begin checks++; if (g_io_lsu_load_0_resp_bits_data !== i_io_lsu_load_0_resp_bits_data) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_0_resp_bits_data: g=%h i=%h", $time, g_io_lsu_load_0_resp_bits_data, i_io_lsu_load_0_resp_bits_data); end end
      if (!$isunknown(g_io_lsu_load_0_resp_bits_data_delayed)) begin checks++; if (g_io_lsu_load_0_resp_bits_data_delayed !== i_io_lsu_load_0_resp_bits_data_delayed) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_0_resp_bits_data_delayed: g=%h i=%h", $time, g_io_lsu_load_0_resp_bits_data_delayed, i_io_lsu_load_0_resp_bits_data_delayed); end end
      if (!$isunknown(g_io_lsu_load_0_resp_bits_miss)) begin checks++; if (g_io_lsu_load_0_resp_bits_miss !== i_io_lsu_load_0_resp_bits_miss) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_0_resp_bits_miss: g=%h i=%h", $time, g_io_lsu_load_0_resp_bits_miss, i_io_lsu_load_0_resp_bits_miss); end end
      if (!$isunknown(g_io_lsu_load_0_resp_bits_mshr_id)) begin checks++; if (g_io_lsu_load_0_resp_bits_mshr_id !== i_io_lsu_load_0_resp_bits_mshr_id) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_0_resp_bits_mshr_id: g=%h i=%h", $time, g_io_lsu_load_0_resp_bits_mshr_id, i_io_lsu_load_0_resp_bits_mshr_id); end end
      if (!$isunknown(g_io_lsu_load_0_resp_bits_meta_prefetch)) begin checks++; if (g_io_lsu_load_0_resp_bits_meta_prefetch !== i_io_lsu_load_0_resp_bits_meta_prefetch) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_0_resp_bits_meta_prefetch: g=%h i=%h", $time, g_io_lsu_load_0_resp_bits_meta_prefetch, i_io_lsu_load_0_resp_bits_meta_prefetch); end end
      if (!$isunknown(g_io_lsu_load_0_resp_bits_handled)) begin checks++; if (g_io_lsu_load_0_resp_bits_handled !== i_io_lsu_load_0_resp_bits_handled) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_0_resp_bits_handled: g=%h i=%h", $time, g_io_lsu_load_0_resp_bits_handled, i_io_lsu_load_0_resp_bits_handled); end end
      if (!$isunknown(g_io_lsu_load_0_resp_bits_error_delayed)) begin checks++; if (g_io_lsu_load_0_resp_bits_error_delayed !== i_io_lsu_load_0_resp_bits_error_delayed) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_0_resp_bits_error_delayed: g=%h i=%h", $time, g_io_lsu_load_0_resp_bits_error_delayed, i_io_lsu_load_0_resp_bits_error_delayed); end end
      if (!$isunknown(g_io_lsu_load_0_s2_bank_conflict)) begin checks++; if (g_io_lsu_load_0_s2_bank_conflict !== i_io_lsu_load_0_s2_bank_conflict) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_0_s2_bank_conflict: g=%h i=%h", $time, g_io_lsu_load_0_s2_bank_conflict, i_io_lsu_load_0_s2_bank_conflict); end end
      if (!$isunknown(g_io_lsu_load_0_s2_mq_nack)) begin checks++; if (g_io_lsu_load_0_s2_mq_nack !== i_io_lsu_load_0_s2_mq_nack) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_0_s2_mq_nack: g=%h i=%h", $time, g_io_lsu_load_0_s2_mq_nack, i_io_lsu_load_0_s2_mq_nack); end end
      if (!$isunknown(g_io_lsu_load_1_req_ready)) begin checks++; if (g_io_lsu_load_1_req_ready !== i_io_lsu_load_1_req_ready) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_1_req_ready: g=%h i=%h", $time, g_io_lsu_load_1_req_ready, i_io_lsu_load_1_req_ready); end end
      if (!$isunknown(g_io_lsu_load_1_resp_valid)) begin checks++; if (g_io_lsu_load_1_resp_valid !== i_io_lsu_load_1_resp_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_1_resp_valid: g=%h i=%h", $time, g_io_lsu_load_1_resp_valid, i_io_lsu_load_1_resp_valid); end end
      if (!$isunknown(g_io_lsu_load_1_resp_bits_data)) begin checks++; if (g_io_lsu_load_1_resp_bits_data !== i_io_lsu_load_1_resp_bits_data) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_1_resp_bits_data: g=%h i=%h", $time, g_io_lsu_load_1_resp_bits_data, i_io_lsu_load_1_resp_bits_data); end end
      if (!$isunknown(g_io_lsu_load_1_resp_bits_miss)) begin checks++; if (g_io_lsu_load_1_resp_bits_miss !== i_io_lsu_load_1_resp_bits_miss) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_1_resp_bits_miss: g=%h i=%h", $time, g_io_lsu_load_1_resp_bits_miss, i_io_lsu_load_1_resp_bits_miss); end end
      if (!$isunknown(g_io_lsu_load_1_resp_bits_mshr_id)) begin checks++; if (g_io_lsu_load_1_resp_bits_mshr_id !== i_io_lsu_load_1_resp_bits_mshr_id) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_1_resp_bits_mshr_id: g=%h i=%h", $time, g_io_lsu_load_1_resp_bits_mshr_id, i_io_lsu_load_1_resp_bits_mshr_id); end end
      if (!$isunknown(g_io_lsu_load_1_resp_bits_meta_prefetch)) begin checks++; if (g_io_lsu_load_1_resp_bits_meta_prefetch !== i_io_lsu_load_1_resp_bits_meta_prefetch) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_1_resp_bits_meta_prefetch: g=%h i=%h", $time, g_io_lsu_load_1_resp_bits_meta_prefetch, i_io_lsu_load_1_resp_bits_meta_prefetch); end end
      if (!$isunknown(g_io_lsu_load_1_resp_bits_handled)) begin checks++; if (g_io_lsu_load_1_resp_bits_handled !== i_io_lsu_load_1_resp_bits_handled) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_1_resp_bits_handled: g=%h i=%h", $time, g_io_lsu_load_1_resp_bits_handled, i_io_lsu_load_1_resp_bits_handled); end end
      if (!$isunknown(g_io_lsu_load_1_resp_bits_error_delayed)) begin checks++; if (g_io_lsu_load_1_resp_bits_error_delayed !== i_io_lsu_load_1_resp_bits_error_delayed) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_1_resp_bits_error_delayed: g=%h i=%h", $time, g_io_lsu_load_1_resp_bits_error_delayed, i_io_lsu_load_1_resp_bits_error_delayed); end end
      if (!$isunknown(g_io_lsu_load_1_s2_bank_conflict)) begin checks++; if (g_io_lsu_load_1_s2_bank_conflict !== i_io_lsu_load_1_s2_bank_conflict) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_1_s2_bank_conflict: g=%h i=%h", $time, g_io_lsu_load_1_s2_bank_conflict, i_io_lsu_load_1_s2_bank_conflict); end end
      if (!$isunknown(g_io_lsu_load_1_s2_mq_nack)) begin checks++; if (g_io_lsu_load_1_s2_mq_nack !== i_io_lsu_load_1_s2_mq_nack) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_1_s2_mq_nack: g=%h i=%h", $time, g_io_lsu_load_1_s2_mq_nack, i_io_lsu_load_1_s2_mq_nack); end end
      if (!$isunknown(g_io_lsu_load_2_req_ready)) begin checks++; if (g_io_lsu_load_2_req_ready !== i_io_lsu_load_2_req_ready) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_2_req_ready: g=%h i=%h", $time, g_io_lsu_load_2_req_ready, i_io_lsu_load_2_req_ready); end end
      if (!$isunknown(g_io_lsu_load_2_resp_valid)) begin checks++; if (g_io_lsu_load_2_resp_valid !== i_io_lsu_load_2_resp_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_2_resp_valid: g=%h i=%h", $time, g_io_lsu_load_2_resp_valid, i_io_lsu_load_2_resp_valid); end end
      if (!$isunknown(g_io_lsu_load_2_resp_bits_data)) begin checks++; if (g_io_lsu_load_2_resp_bits_data !== i_io_lsu_load_2_resp_bits_data) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_2_resp_bits_data: g=%h i=%h", $time, g_io_lsu_load_2_resp_bits_data, i_io_lsu_load_2_resp_bits_data); end end
      if (!$isunknown(g_io_lsu_load_2_resp_bits_miss)) begin checks++; if (g_io_lsu_load_2_resp_bits_miss !== i_io_lsu_load_2_resp_bits_miss) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_2_resp_bits_miss: g=%h i=%h", $time, g_io_lsu_load_2_resp_bits_miss, i_io_lsu_load_2_resp_bits_miss); end end
      if (!$isunknown(g_io_lsu_load_2_resp_bits_mshr_id)) begin checks++; if (g_io_lsu_load_2_resp_bits_mshr_id !== i_io_lsu_load_2_resp_bits_mshr_id) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_2_resp_bits_mshr_id: g=%h i=%h", $time, g_io_lsu_load_2_resp_bits_mshr_id, i_io_lsu_load_2_resp_bits_mshr_id); end end
      if (!$isunknown(g_io_lsu_load_2_resp_bits_meta_prefetch)) begin checks++; if (g_io_lsu_load_2_resp_bits_meta_prefetch !== i_io_lsu_load_2_resp_bits_meta_prefetch) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_2_resp_bits_meta_prefetch: g=%h i=%h", $time, g_io_lsu_load_2_resp_bits_meta_prefetch, i_io_lsu_load_2_resp_bits_meta_prefetch); end end
      if (!$isunknown(g_io_lsu_load_2_resp_bits_handled)) begin checks++; if (g_io_lsu_load_2_resp_bits_handled !== i_io_lsu_load_2_resp_bits_handled) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_2_resp_bits_handled: g=%h i=%h", $time, g_io_lsu_load_2_resp_bits_handled, i_io_lsu_load_2_resp_bits_handled); end end
      if (!$isunknown(g_io_lsu_load_2_resp_bits_error_delayed)) begin checks++; if (g_io_lsu_load_2_resp_bits_error_delayed !== i_io_lsu_load_2_resp_bits_error_delayed) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_2_resp_bits_error_delayed: g=%h i=%h", $time, g_io_lsu_load_2_resp_bits_error_delayed, i_io_lsu_load_2_resp_bits_error_delayed); end end
      if (!$isunknown(g_io_lsu_load_2_s2_bank_conflict)) begin checks++; if (g_io_lsu_load_2_s2_bank_conflict !== i_io_lsu_load_2_s2_bank_conflict) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_2_s2_bank_conflict: g=%h i=%h", $time, g_io_lsu_load_2_s2_bank_conflict, i_io_lsu_load_2_s2_bank_conflict); end end
      if (!$isunknown(g_io_lsu_load_2_s2_mq_nack)) begin checks++; if (g_io_lsu_load_2_s2_mq_nack !== i_io_lsu_load_2_s2_mq_nack) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_load_2_s2_mq_nack: g=%h i=%h", $time, g_io_lsu_load_2_s2_mq_nack, i_io_lsu_load_2_s2_mq_nack); end end
      if (!$isunknown(g_io_lsu_tl_d_channel_valid)) begin checks++; if (g_io_lsu_tl_d_channel_valid !== i_io_lsu_tl_d_channel_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_tl_d_channel_valid: g=%h i=%h", $time, g_io_lsu_tl_d_channel_valid, i_io_lsu_tl_d_channel_valid); end end
      if (!$isunknown(g_io_lsu_tl_d_channel_mshrid)) begin checks++; if (g_io_lsu_tl_d_channel_mshrid !== i_io_lsu_tl_d_channel_mshrid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_tl_d_channel_mshrid: g=%h i=%h", $time, g_io_lsu_tl_d_channel_mshrid, i_io_lsu_tl_d_channel_mshrid); end end
      if (!$isunknown(g_io_lsu_store_req_ready)) begin checks++; if (g_io_lsu_store_req_ready !== i_io_lsu_store_req_ready) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_store_req_ready: g=%h i=%h", $time, g_io_lsu_store_req_ready, i_io_lsu_store_req_ready); end end
      if (!$isunknown(g_io_lsu_store_main_pipe_hit_resp_valid)) begin checks++; if (g_io_lsu_store_main_pipe_hit_resp_valid !== i_io_lsu_store_main_pipe_hit_resp_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_store_main_pipe_hit_resp_valid: g=%h i=%h", $time, g_io_lsu_store_main_pipe_hit_resp_valid, i_io_lsu_store_main_pipe_hit_resp_valid); end end
      if (!$isunknown(g_io_lsu_store_main_pipe_hit_resp_bits_id)) begin checks++; if (g_io_lsu_store_main_pipe_hit_resp_bits_id !== i_io_lsu_store_main_pipe_hit_resp_bits_id) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_store_main_pipe_hit_resp_bits_id: g=%h i=%h", $time, g_io_lsu_store_main_pipe_hit_resp_bits_id, i_io_lsu_store_main_pipe_hit_resp_bits_id); end end
      if (!$isunknown(g_io_lsu_store_replay_resp_valid)) begin checks++; if (g_io_lsu_store_replay_resp_valid !== i_io_lsu_store_replay_resp_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_store_replay_resp_valid: g=%h i=%h", $time, g_io_lsu_store_replay_resp_valid, i_io_lsu_store_replay_resp_valid); end end
      if (!$isunknown(g_io_lsu_store_replay_resp_bits_id)) begin checks++; if (g_io_lsu_store_replay_resp_bits_id !== i_io_lsu_store_replay_resp_bits_id) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_store_replay_resp_bits_id: g=%h i=%h", $time, g_io_lsu_store_replay_resp_bits_id, i_io_lsu_store_replay_resp_bits_id); end end
      if (!$isunknown(g_io_lsu_atomics_req_ready)) begin checks++; if (g_io_lsu_atomics_req_ready !== i_io_lsu_atomics_req_ready) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_atomics_req_ready: g=%h i=%h", $time, g_io_lsu_atomics_req_ready, i_io_lsu_atomics_req_ready); end end
      if (!$isunknown(g_io_lsu_atomics_resp_valid)) begin checks++; if (g_io_lsu_atomics_resp_valid !== i_io_lsu_atomics_resp_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_atomics_resp_valid: g=%h i=%h", $time, g_io_lsu_atomics_resp_valid, i_io_lsu_atomics_resp_valid); end end
      if (!$isunknown(g_io_lsu_atomics_resp_bits_data)) begin checks++; if (g_io_lsu_atomics_resp_bits_data !== i_io_lsu_atomics_resp_bits_data) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_atomics_resp_bits_data: g=%h i=%h", $time, g_io_lsu_atomics_resp_bits_data, i_io_lsu_atomics_resp_bits_data); end end
      if (!$isunknown(g_io_lsu_atomics_resp_bits_miss)) begin checks++; if (g_io_lsu_atomics_resp_bits_miss !== i_io_lsu_atomics_resp_bits_miss) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_atomics_resp_bits_miss: g=%h i=%h", $time, g_io_lsu_atomics_resp_bits_miss, i_io_lsu_atomics_resp_bits_miss); end end
      if (!$isunknown(g_io_lsu_atomics_resp_bits_replay)) begin checks++; if (g_io_lsu_atomics_resp_bits_replay !== i_io_lsu_atomics_resp_bits_replay) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_atomics_resp_bits_replay: g=%h i=%h", $time, g_io_lsu_atomics_resp_bits_replay, i_io_lsu_atomics_resp_bits_replay); end end
      if (!$isunknown(g_io_lsu_atomics_resp_bits_error)) begin checks++; if (g_io_lsu_atomics_resp_bits_error !== i_io_lsu_atomics_resp_bits_error) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_atomics_resp_bits_error: g=%h i=%h", $time, g_io_lsu_atomics_resp_bits_error, i_io_lsu_atomics_resp_bits_error); end end
      if (!$isunknown(g_io_lsu_atomics_resp_bits_id)) begin checks++; if (g_io_lsu_atomics_resp_bits_id !== i_io_lsu_atomics_resp_bits_id) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_atomics_resp_bits_id: g=%h i=%h", $time, g_io_lsu_atomics_resp_bits_id, i_io_lsu_atomics_resp_bits_id); end end
      if (!$isunknown(g_io_lsu_atomics_block_lr)) begin checks++; if (g_io_lsu_atomics_block_lr !== i_io_lsu_atomics_block_lr) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_atomics_block_lr: g=%h i=%h", $time, g_io_lsu_atomics_block_lr, i_io_lsu_atomics_block_lr); end end
      if (!$isunknown(g_io_lsu_release_valid)) begin checks++; if (g_io_lsu_release_valid !== i_io_lsu_release_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_release_valid: g=%h i=%h", $time, g_io_lsu_release_valid, i_io_lsu_release_valid); end end
      if (!$isunknown(g_io_lsu_release_bits_paddr)) begin checks++; if (g_io_lsu_release_bits_paddr !== i_io_lsu_release_bits_paddr) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_release_bits_paddr: g=%h i=%h", $time, g_io_lsu_release_bits_paddr, i_io_lsu_release_bits_paddr); end end
      if (!$isunknown(g_io_lsu_forward_D_0_valid)) begin checks++; if (g_io_lsu_forward_D_0_valid !== i_io_lsu_forward_D_0_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_0_valid: g=%h i=%h", $time, g_io_lsu_forward_D_0_valid, i_io_lsu_forward_D_0_valid); end end
      if (!$isunknown(g_io_lsu_forward_D_0_data)) begin checks++; if (g_io_lsu_forward_D_0_data !== i_io_lsu_forward_D_0_data) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_0_data: g=%h i=%h", $time, g_io_lsu_forward_D_0_data, i_io_lsu_forward_D_0_data); end end
      if (!$isunknown(g_io_lsu_forward_D_0_mshrid)) begin checks++; if (g_io_lsu_forward_D_0_mshrid !== i_io_lsu_forward_D_0_mshrid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_0_mshrid: g=%h i=%h", $time, g_io_lsu_forward_D_0_mshrid, i_io_lsu_forward_D_0_mshrid); end end
      if (!$isunknown(g_io_lsu_forward_D_0_last)) begin checks++; if (g_io_lsu_forward_D_0_last !== i_io_lsu_forward_D_0_last) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_0_last: g=%h i=%h", $time, g_io_lsu_forward_D_0_last, i_io_lsu_forward_D_0_last); end end
      if (!$isunknown(g_io_lsu_forward_D_0_corrupt)) begin checks++; if (g_io_lsu_forward_D_0_corrupt !== i_io_lsu_forward_D_0_corrupt) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_0_corrupt: g=%h i=%h", $time, g_io_lsu_forward_D_0_corrupt, i_io_lsu_forward_D_0_corrupt); end end
      if (!$isunknown(g_io_lsu_forward_D_1_valid)) begin checks++; if (g_io_lsu_forward_D_1_valid !== i_io_lsu_forward_D_1_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_1_valid: g=%h i=%h", $time, g_io_lsu_forward_D_1_valid, i_io_lsu_forward_D_1_valid); end end
      if (!$isunknown(g_io_lsu_forward_D_1_data)) begin checks++; if (g_io_lsu_forward_D_1_data !== i_io_lsu_forward_D_1_data) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_1_data: g=%h i=%h", $time, g_io_lsu_forward_D_1_data, i_io_lsu_forward_D_1_data); end end
      if (!$isunknown(g_io_lsu_forward_D_1_mshrid)) begin checks++; if (g_io_lsu_forward_D_1_mshrid !== i_io_lsu_forward_D_1_mshrid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_1_mshrid: g=%h i=%h", $time, g_io_lsu_forward_D_1_mshrid, i_io_lsu_forward_D_1_mshrid); end end
      if (!$isunknown(g_io_lsu_forward_D_1_last)) begin checks++; if (g_io_lsu_forward_D_1_last !== i_io_lsu_forward_D_1_last) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_1_last: g=%h i=%h", $time, g_io_lsu_forward_D_1_last, i_io_lsu_forward_D_1_last); end end
      if (!$isunknown(g_io_lsu_forward_D_1_corrupt)) begin checks++; if (g_io_lsu_forward_D_1_corrupt !== i_io_lsu_forward_D_1_corrupt) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_1_corrupt: g=%h i=%h", $time, g_io_lsu_forward_D_1_corrupt, i_io_lsu_forward_D_1_corrupt); end end
      if (!$isunknown(g_io_lsu_forward_D_2_valid)) begin checks++; if (g_io_lsu_forward_D_2_valid !== i_io_lsu_forward_D_2_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_2_valid: g=%h i=%h", $time, g_io_lsu_forward_D_2_valid, i_io_lsu_forward_D_2_valid); end end
      if (!$isunknown(g_io_lsu_forward_D_2_data)) begin checks++; if (g_io_lsu_forward_D_2_data !== i_io_lsu_forward_D_2_data) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_2_data: g=%h i=%h", $time, g_io_lsu_forward_D_2_data, i_io_lsu_forward_D_2_data); end end
      if (!$isunknown(g_io_lsu_forward_D_2_mshrid)) begin checks++; if (g_io_lsu_forward_D_2_mshrid !== i_io_lsu_forward_D_2_mshrid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_2_mshrid: g=%h i=%h", $time, g_io_lsu_forward_D_2_mshrid, i_io_lsu_forward_D_2_mshrid); end end
      if (!$isunknown(g_io_lsu_forward_D_2_last)) begin checks++; if (g_io_lsu_forward_D_2_last !== i_io_lsu_forward_D_2_last) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_2_last: g=%h i=%h", $time, g_io_lsu_forward_D_2_last, i_io_lsu_forward_D_2_last); end end
      if (!$isunknown(g_io_lsu_forward_D_2_corrupt)) begin checks++; if (g_io_lsu_forward_D_2_corrupt !== i_io_lsu_forward_D_2_corrupt) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_D_2_corrupt: g=%h i=%h", $time, g_io_lsu_forward_D_2_corrupt, i_io_lsu_forward_D_2_corrupt); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forward_mshr)) begin checks++; if (g_io_lsu_forward_mshr_0_forward_mshr !== i_io_lsu_forward_mshr_0_forward_mshr) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forward_mshr: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forward_mshr, i_io_lsu_forward_mshr_0_forward_mshr); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_0)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_0 !== i_io_lsu_forward_mshr_0_forwardData_0) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_0: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_0, i_io_lsu_forward_mshr_0_forwardData_0); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_1)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_1 !== i_io_lsu_forward_mshr_0_forwardData_1) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_1: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_1, i_io_lsu_forward_mshr_0_forwardData_1); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_2)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_2 !== i_io_lsu_forward_mshr_0_forwardData_2) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_2: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_2, i_io_lsu_forward_mshr_0_forwardData_2); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_3)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_3 !== i_io_lsu_forward_mshr_0_forwardData_3) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_3: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_3, i_io_lsu_forward_mshr_0_forwardData_3); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_4)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_4 !== i_io_lsu_forward_mshr_0_forwardData_4) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_4: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_4, i_io_lsu_forward_mshr_0_forwardData_4); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_5)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_5 !== i_io_lsu_forward_mshr_0_forwardData_5) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_5: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_5, i_io_lsu_forward_mshr_0_forwardData_5); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_6)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_6 !== i_io_lsu_forward_mshr_0_forwardData_6) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_6: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_6, i_io_lsu_forward_mshr_0_forwardData_6); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_7)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_7 !== i_io_lsu_forward_mshr_0_forwardData_7) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_7: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_7, i_io_lsu_forward_mshr_0_forwardData_7); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_8)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_8 !== i_io_lsu_forward_mshr_0_forwardData_8) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_8: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_8, i_io_lsu_forward_mshr_0_forwardData_8); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_9)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_9 !== i_io_lsu_forward_mshr_0_forwardData_9) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_9: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_9, i_io_lsu_forward_mshr_0_forwardData_9); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_10)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_10 !== i_io_lsu_forward_mshr_0_forwardData_10) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_10: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_10, i_io_lsu_forward_mshr_0_forwardData_10); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_11)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_11 !== i_io_lsu_forward_mshr_0_forwardData_11) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_11: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_11, i_io_lsu_forward_mshr_0_forwardData_11); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_12)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_12 !== i_io_lsu_forward_mshr_0_forwardData_12) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_12: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_12, i_io_lsu_forward_mshr_0_forwardData_12); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_13)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_13 !== i_io_lsu_forward_mshr_0_forwardData_13) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_13: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_13, i_io_lsu_forward_mshr_0_forwardData_13); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_14)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_14 !== i_io_lsu_forward_mshr_0_forwardData_14) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_14: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_14, i_io_lsu_forward_mshr_0_forwardData_14); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forwardData_15)) begin checks++; if (g_io_lsu_forward_mshr_0_forwardData_15 !== i_io_lsu_forward_mshr_0_forwardData_15) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forwardData_15: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forwardData_15, i_io_lsu_forward_mshr_0_forwardData_15); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_forward_result_valid)) begin checks++; if (g_io_lsu_forward_mshr_0_forward_result_valid !== i_io_lsu_forward_mshr_0_forward_result_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_forward_result_valid: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_forward_result_valid, i_io_lsu_forward_mshr_0_forward_result_valid); end end
      if (!$isunknown(g_io_lsu_forward_mshr_0_corrupt)) begin checks++; if (g_io_lsu_forward_mshr_0_corrupt !== i_io_lsu_forward_mshr_0_corrupt) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_0_corrupt: g=%h i=%h", $time, g_io_lsu_forward_mshr_0_corrupt, i_io_lsu_forward_mshr_0_corrupt); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forward_mshr)) begin checks++; if (g_io_lsu_forward_mshr_1_forward_mshr !== i_io_lsu_forward_mshr_1_forward_mshr) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forward_mshr: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forward_mshr, i_io_lsu_forward_mshr_1_forward_mshr); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_0)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_0 !== i_io_lsu_forward_mshr_1_forwardData_0) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_0: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_0, i_io_lsu_forward_mshr_1_forwardData_0); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_1)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_1 !== i_io_lsu_forward_mshr_1_forwardData_1) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_1: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_1, i_io_lsu_forward_mshr_1_forwardData_1); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_2)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_2 !== i_io_lsu_forward_mshr_1_forwardData_2) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_2: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_2, i_io_lsu_forward_mshr_1_forwardData_2); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_3)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_3 !== i_io_lsu_forward_mshr_1_forwardData_3) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_3: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_3, i_io_lsu_forward_mshr_1_forwardData_3); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_4)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_4 !== i_io_lsu_forward_mshr_1_forwardData_4) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_4: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_4, i_io_lsu_forward_mshr_1_forwardData_4); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_5)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_5 !== i_io_lsu_forward_mshr_1_forwardData_5) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_5: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_5, i_io_lsu_forward_mshr_1_forwardData_5); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_6)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_6 !== i_io_lsu_forward_mshr_1_forwardData_6) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_6: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_6, i_io_lsu_forward_mshr_1_forwardData_6); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_7)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_7 !== i_io_lsu_forward_mshr_1_forwardData_7) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_7: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_7, i_io_lsu_forward_mshr_1_forwardData_7); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_8)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_8 !== i_io_lsu_forward_mshr_1_forwardData_8) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_8: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_8, i_io_lsu_forward_mshr_1_forwardData_8); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_9)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_9 !== i_io_lsu_forward_mshr_1_forwardData_9) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_9: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_9, i_io_lsu_forward_mshr_1_forwardData_9); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_10)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_10 !== i_io_lsu_forward_mshr_1_forwardData_10) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_10: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_10, i_io_lsu_forward_mshr_1_forwardData_10); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_11)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_11 !== i_io_lsu_forward_mshr_1_forwardData_11) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_11: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_11, i_io_lsu_forward_mshr_1_forwardData_11); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_12)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_12 !== i_io_lsu_forward_mshr_1_forwardData_12) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_12: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_12, i_io_lsu_forward_mshr_1_forwardData_12); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_13)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_13 !== i_io_lsu_forward_mshr_1_forwardData_13) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_13: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_13, i_io_lsu_forward_mshr_1_forwardData_13); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_14)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_14 !== i_io_lsu_forward_mshr_1_forwardData_14) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_14: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_14, i_io_lsu_forward_mshr_1_forwardData_14); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forwardData_15)) begin checks++; if (g_io_lsu_forward_mshr_1_forwardData_15 !== i_io_lsu_forward_mshr_1_forwardData_15) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forwardData_15: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forwardData_15, i_io_lsu_forward_mshr_1_forwardData_15); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_forward_result_valid)) begin checks++; if (g_io_lsu_forward_mshr_1_forward_result_valid !== i_io_lsu_forward_mshr_1_forward_result_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_forward_result_valid: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_forward_result_valid, i_io_lsu_forward_mshr_1_forward_result_valid); end end
      if (!$isunknown(g_io_lsu_forward_mshr_1_corrupt)) begin checks++; if (g_io_lsu_forward_mshr_1_corrupt !== i_io_lsu_forward_mshr_1_corrupt) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_1_corrupt: g=%h i=%h", $time, g_io_lsu_forward_mshr_1_corrupt, i_io_lsu_forward_mshr_1_corrupt); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forward_mshr)) begin checks++; if (g_io_lsu_forward_mshr_2_forward_mshr !== i_io_lsu_forward_mshr_2_forward_mshr) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forward_mshr: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forward_mshr, i_io_lsu_forward_mshr_2_forward_mshr); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_0)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_0 !== i_io_lsu_forward_mshr_2_forwardData_0) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_0: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_0, i_io_lsu_forward_mshr_2_forwardData_0); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_1)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_1 !== i_io_lsu_forward_mshr_2_forwardData_1) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_1: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_1, i_io_lsu_forward_mshr_2_forwardData_1); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_2)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_2 !== i_io_lsu_forward_mshr_2_forwardData_2) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_2: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_2, i_io_lsu_forward_mshr_2_forwardData_2); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_3)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_3 !== i_io_lsu_forward_mshr_2_forwardData_3) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_3: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_3, i_io_lsu_forward_mshr_2_forwardData_3); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_4)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_4 !== i_io_lsu_forward_mshr_2_forwardData_4) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_4: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_4, i_io_lsu_forward_mshr_2_forwardData_4); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_5)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_5 !== i_io_lsu_forward_mshr_2_forwardData_5) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_5: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_5, i_io_lsu_forward_mshr_2_forwardData_5); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_6)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_6 !== i_io_lsu_forward_mshr_2_forwardData_6) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_6: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_6, i_io_lsu_forward_mshr_2_forwardData_6); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_7)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_7 !== i_io_lsu_forward_mshr_2_forwardData_7) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_7: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_7, i_io_lsu_forward_mshr_2_forwardData_7); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_8)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_8 !== i_io_lsu_forward_mshr_2_forwardData_8) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_8: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_8, i_io_lsu_forward_mshr_2_forwardData_8); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_9)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_9 !== i_io_lsu_forward_mshr_2_forwardData_9) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_9: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_9, i_io_lsu_forward_mshr_2_forwardData_9); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_10)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_10 !== i_io_lsu_forward_mshr_2_forwardData_10) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_10: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_10, i_io_lsu_forward_mshr_2_forwardData_10); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_11)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_11 !== i_io_lsu_forward_mshr_2_forwardData_11) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_11: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_11, i_io_lsu_forward_mshr_2_forwardData_11); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_12)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_12 !== i_io_lsu_forward_mshr_2_forwardData_12) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_12: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_12, i_io_lsu_forward_mshr_2_forwardData_12); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_13)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_13 !== i_io_lsu_forward_mshr_2_forwardData_13) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_13: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_13, i_io_lsu_forward_mshr_2_forwardData_13); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_14)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_14 !== i_io_lsu_forward_mshr_2_forwardData_14) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_14: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_14, i_io_lsu_forward_mshr_2_forwardData_14); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forwardData_15)) begin checks++; if (g_io_lsu_forward_mshr_2_forwardData_15 !== i_io_lsu_forward_mshr_2_forwardData_15) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forwardData_15: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forwardData_15, i_io_lsu_forward_mshr_2_forwardData_15); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_forward_result_valid)) begin checks++; if (g_io_lsu_forward_mshr_2_forward_result_valid !== i_io_lsu_forward_mshr_2_forward_result_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_forward_result_valid: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_forward_result_valid, i_io_lsu_forward_mshr_2_forward_result_valid); end end
      if (!$isunknown(g_io_lsu_forward_mshr_2_corrupt)) begin checks++; if (g_io_lsu_forward_mshr_2_corrupt !== i_io_lsu_forward_mshr_2_corrupt) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_lsu_forward_mshr_2_corrupt: g=%h i=%h", $time, g_io_lsu_forward_mshr_2_corrupt, i_io_lsu_forward_mshr_2_corrupt); end end
      if (!$isunknown(g_io_error_valid)) begin checks++; if (g_io_error_valid !== i_io_error_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_error_valid: g=%h i=%h", $time, g_io_error_valid, i_io_error_valid); end end
      if (!$isunknown(g_io_error_bits_paddr)) begin checks++; if (g_io_error_bits_paddr !== i_io_error_bits_paddr) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_error_bits_paddr: g=%h i=%h", $time, g_io_error_bits_paddr, i_io_error_bits_paddr); end end
      if (!$isunknown(g_io_error_bits_report_to_beu)) begin checks++; if (g_io_error_bits_report_to_beu !== i_io_error_bits_report_to_beu) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_error_bits_report_to_beu: g=%h i=%h", $time, g_io_error_bits_report_to_beu, i_io_error_bits_report_to_beu); end end
      if (!$isunknown(g_io_pf_ctrl_enable)) begin checks++; if (g_io_pf_ctrl_enable !== i_io_pf_ctrl_enable) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_pf_ctrl_enable: g=%h i=%h", $time, g_io_pf_ctrl_enable, i_io_pf_ctrl_enable); end end
      if (!$isunknown(g_io_pf_ctrl_confidence)) begin checks++; if (g_io_pf_ctrl_confidence !== i_io_pf_ctrl_confidence) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_pf_ctrl_confidence: g=%h i=%h", $time, g_io_pf_ctrl_confidence, i_io_pf_ctrl_confidence); end end
      if (!$isunknown(g_io_sms_agt_evict_req_valid)) begin checks++; if (g_io_sms_agt_evict_req_valid !== i_io_sms_agt_evict_req_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_sms_agt_evict_req_valid: g=%h i=%h", $time, g_io_sms_agt_evict_req_valid, i_io_sms_agt_evict_req_valid); end end
      if (!$isunknown(g_io_sms_agt_evict_req_bits_vaddr)) begin checks++; if (g_io_sms_agt_evict_req_bits_vaddr !== i_io_sms_agt_evict_req_bits_vaddr) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_sms_agt_evict_req_bits_vaddr: g=%h i=%h", $time, g_io_sms_agt_evict_req_bits_vaddr, i_io_sms_agt_evict_req_bits_vaddr); end end
      if (!$isunknown(g_io_debugTopDown_robHeadMissInDCache)) begin checks++; if (g_io_debugTopDown_robHeadMissInDCache !== i_io_debugTopDown_robHeadMissInDCache) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_debugTopDown_robHeadMissInDCache: g=%h i=%h", $time, g_io_debugTopDown_robHeadMissInDCache, i_io_debugTopDown_robHeadMissInDCache); end end
      if (!$isunknown(g_io_cmoOpReq_ready)) begin checks++; if (g_io_cmoOpReq_ready !== i_io_cmoOpReq_ready) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_cmoOpReq_ready: g=%h i=%h", $time, g_io_cmoOpReq_ready, i_io_cmoOpReq_ready); end end
      if (!$isunknown(g_io_cmoOpResp_valid)) begin checks++; if (g_io_cmoOpResp_valid !== i_io_cmoOpResp_valid) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_cmoOpResp_valid: g=%h i=%h", $time, g_io_cmoOpResp_valid, i_io_cmoOpResp_valid); end end
      if (!$isunknown(g_io_cmoOpResp_bits_nderr)) begin checks++; if (g_io_cmoOpResp_bits_nderr !== i_io_cmoOpResp_bits_nderr) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_cmoOpResp_bits_nderr: g=%h i=%h", $time, g_io_cmoOpResp_bits_nderr, i_io_cmoOpResp_bits_nderr); end end
      if (!$isunknown(g_io_l1Miss)) begin checks++; if (g_io_l1Miss !== i_io_l1Miss) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_l1Miss: g=%h i=%h", $time, g_io_l1Miss, i_io_l1Miss); end end
      ...
      if (!$isunknown(g_io_perf_19_value)) begin checks++; if (g_io_perf_19_value !== i_io_perf_19_value) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_perf_19_value: g=%h i=%h", $time, g_io_perf_19_value, i_io_perf_19_value); end end
      if (!$isunknown(g_io_perf_20_value)) begin checks++; if (g_io_perf_20_value !== i_io_perf_20_value) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_perf_20_value: g=%h i=%h", $time, g_io_perf_20_value, i_io_perf_20_value); end end
      if (!$isunknown(g_io_perf_21_value)) begin checks++; if (g_io_perf_21_value !== i_io_perf_21_value) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_perf_21_value: g=%h i=%h", $time, g_io_perf_21_value, i_io_perf_21_value); end end
      if (!$isunknown(g_io_perf_22_value)) begin checks++; if (g_io_perf_22_value !== i_io_perf_22_value) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_perf_22_value: g=%h i=%h", $time, g_io_perf_22_value, i_io_perf_22_value); end end
      if (!$isunknown(g_io_perf_23_value)) begin checks++; if (g_io_perf_23_value !== i_io_perf_23_value) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_perf_23_value: g=%h i=%h", $time, g_io_perf_23_value, i_io_perf_23_value); end end
      if (!$isunknown(g_io_perf_24_value)) begin checks++; if (g_io_perf_24_value !== i_io_perf_24_value) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_perf_24_value: g=%h i=%h", $time, g_io_perf_24_value, i_io_perf_24_value); end end
      if (!$isunknown(g_io_perf_25_value)) begin checks++; if (g_io_perf_25_value !== i_io_perf_25_value) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_perf_25_value: g=%h i=%h", $time, g_io_perf_25_value, i_io_perf_25_value); end end
      if (!$isunknown(g_io_perf_26_value)) begin checks++; if (g_io_perf_26_value !== i_io_perf_26_value) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_perf_26_value: g=%h i=%h", $time, g_io_perf_26_value, i_io_perf_26_value); end end
      if (!$isunknown(g_io_perf_27_value)) begin checks++; if (g_io_perf_27_value !== i_io_perf_27_value) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_perf_27_value: g=%h i=%h", $time, g_io_perf_27_value, i_io_perf_27_value); end end
      if (!$isunknown(g_io_perf_28_value)) begin checks++; if (g_io_perf_28_value !== i_io_perf_28_value) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_perf_28_value: g=%h i=%h", $time, g_io_perf_28_value, i_io_perf_28_value); end end
      if (!$isunknown(g_io_perf_29_value)) begin checks++; if (g_io_perf_29_value !== i_io_perf_29_value) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_perf_29_value: g=%h i=%h", $time, g_io_perf_29_value, i_io_perf_29_value); end end
      if (!$isunknown(g_io_perf_30_value)) begin checks++; if (g_io_perf_30_value !== i_io_perf_30_value) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_perf_30_value: g=%h i=%h", $time, g_io_perf_30_value, i_io_perf_30_value); end end
      if (!$isunknown(g_io_perf_31_value)) begin checks++; if (g_io_perf_31_value !== i_io_perf_31_value) begin errors++; if (errors<=20) $display("  MISMATCH %0t io_perf_31_value: g=%h i=%h", $time, g_io_perf_31_value, i_io_perf_31_value); end end
