...
module tb;
  ...
  logic io_req_2_bits_vaNeedExt;
  logic [63:0] io_req_2_bits_gpaddr;
  logic io_req_2_bits_isHyper;
  logic io_req_2_bits_isForVSnonLeafPTE;
  logic io_req_3_valid;
  logic io_req_3_bits_uop_exceptionVec_3;
  logic io_req_3_bits_uop_exceptionVec_4;
  logic io_req_3_bits_uop_exceptionVec_5;
  logic io_req_3_bits_uop_exceptionVec_13;
  logic io_req_3_bits_uop_exceptionVec_19;
  logic io_req_3_bits_uop_exceptionVec_21;
  logic [6:0] io_req_3_bits_uop_uopIdx;
  logic io_req_3_bits_uop_robIdx_flag;
  logic [7:0] io_req_3_bits_uop_robIdx_value;
  logic [63:0] io_req_3_bits_fullva;
  logic io_req_3_bits_vaNeedExt;
  logic [63:0] io_req_3_bits_gpaddr;
  logic io_req_4_valid;
  logic io_req_4_bits_uop_exceptionVec_3;
  logic io_req_4_bits_uop_exceptionVec_4;
  logic io_req_4_bits_uop_exceptionVec_5;
  logic io_req_4_bits_uop_exceptionVec_13;
  logic io_req_4_bits_uop_exceptionVec_19;
  logic io_req_4_bits_uop_exceptionVec_21;
  logic [6:0] io_req_4_bits_uop_uopIdx;
  logic io_req_4_bits_uop_robIdx_flag;
  logic [7:0] io_req_4_bits_uop_robIdx_value;
  logic [63:0] io_req_4_bits_fullva;
  logic io_req_4_bits_vaNeedExt;
  logic [63:0] io_req_4_bits_gpaddr;
  logic io_req_5_valid;
  logic io_req_5_bits_uop_exceptionVec_3;
  logic io_req_5_bits_uop_exceptionVec_4;
  logic io_req_5_bits_uop_exceptionVec_5;
  logic io_req_5_bits_uop_exceptionVec_13;
  logic io_req_5_bits_uop_exceptionVec_19;
  logic io_req_5_bits_uop_exceptionVec_21;
  logic [6:0] io_req_5_bits_uop_uopIdx;
  logic io_req_5_bits_uop_robIdx_flag;
  logic [7:0] io_req_5_bits_uop_robIdx_value;
  logic [63:0] io_req_5_bits_fullva;
  logic [63:0] io_req_5_bits_gpaddr;
  logic io_req_5_bits_isHyper;
  logic io_req_5_bits_isForVSnonLeafPTE;
  ...
  LqExceptionBuffer u_g (
    ...
    .io_req_0_bits_vaNeedExt(io_req_0_bits_vaNeedExt),
    ...
    .io_req_1_bits_vaNeedExt(io_req_1_bits_vaNeedExt),
    ...
    .io_req_2_bits_vaNeedExt(io_req_2_bits_vaNeedExt),
    ...
    .io_req_3_bits_uop_exceptionVec_3(io_req_3_bits_uop_exceptionVec_3),
    .io_req_3_bits_uop_exceptionVec_4(io_req_3_bits_uop_exceptionVec_4),
    .io_req_3_bits_uop_exceptionVec_5(io_req_3_bits_uop_exceptionVec_5),
    .io_req_3_bits_uop_exceptionVec_13(io_req_3_bits_uop_exceptionVec_13),
    .io_req_3_bits_uop_exceptionVec_19(io_req_3_bits_uop_exceptionVec_19),
    .io_req_3_bits_uop_exceptionVec_21(io_req_3_bits_uop_exceptionVec_21),
    .io_req_3_bits_uop_uopIdx(io_req_3_bits_uop_uopIdx),
    .io_req_3_bits_uop_robIdx_flag(io_req_3_bits_uop_robIdx_flag),
    .io_req_3_bits_uop_robIdx_value(io_req_3_bits_uop_robIdx_value),
    .io_req_3_bits_fullva(io_req_3_bits_fullva),
    .io_req_3_bits_vaNeedExt(io_req_3_bits_vaNeedExt),
    .io_req_3_bits_gpaddr(io_req_3_bits_gpaddr),
    .io_req_4_valid(io_req_4_valid),
    .io_req_4_bits_uop_exceptionVec_3(io_req_4_bits_uop_exceptionVec_3),
    .io_req_4_bits_uop_exceptionVec_4(io_req_4_bits_uop_exceptionVec_4),
    .io_req_4_bits_uop_exceptionVec_5(io_req_4_bits_uop_exceptionVec_5),
    .io_req_4_bits_uop_exceptionVec_13(io_req_4_bits_uop_exceptionVec_13),
    .io_req_4_bits_uop_exceptionVec_19(io_req_4_bits_uop_exceptionVec_19),
    .io_req_4_bits_uop_exceptionVec_21(io_req_4_bits_uop_exceptionVec_21),
    .io_req_4_bits_uop_uopIdx(io_req_4_bits_uop_uopIdx),
    .io_req_4_bits_uop_robIdx_flag(io_req_4_bits_uop_robIdx_flag),
    .io_req_4_bits_uop_robIdx_value(io_req_4_bits_uop_robIdx_value),
    .io_req_4_bits_fullva(io_req_4_bits_fullva),
    .io_req_4_bits_vaNeedExt(io_req_4_bits_vaNeedExt),
    .io_req_4_bits_gpaddr(io_req_4_bits_gpaddr),
    .io_req_5_valid(io_req_5_valid),
    .io_req_5_bits_uop_exceptionVec_3(io_req_5_bits_uop_exceptionVec_3),
    .io_req_5_bits_uop_exceptionVec_4(io_req_5_bits_uop_exceptionVec_4),
    .io_req_5_bits_uop_exceptionVec_5(io_req_5_bits_uop_exceptionVec_5),
    .io_req_5_bits_uop_exceptionVec_13(io_req_5_bits_uop_exceptionVec_13),
    .io_req_5_bits_uop_exceptionVec_19(io_req_5_bits_uop_exceptionVec_19),
    .io_req_5_bits_uop_exceptionVec_21(io_req_5_bits_uop_exceptionVec_21),
    .io_req_5_bits_uop_uopIdx(io_req_5_bits_uop_uopIdx),
    .io_req_5_bits_uop_robIdx_flag(io_req_5_bits_uop_robIdx_flag),
    .io_req_5_bits_uop_robIdx_value(io_req_5_bits_uop_robIdx_value),
    .io_req_5_bits_fullva(io_req_5_bits_fullva),
    .io_req_5_bits_gpaddr(io_req_5_bits_gpaddr),
    .io_req_5_bits_isHyper(io_req_5_bits_isHyper),
    .io_req_5_bits_isForVSnonLeafPTE(io_req_5_bits_isForVSnonLeafPTE),
  ...
  task automatic drive();
    ...
    io_req_0_valid = ($urandom_range(0,2)!=0);
    io_req_0_bits_uop_exceptionVec_3 = ($urandom_range(0,2)==0);
    io_req_0_bits_uop_exceptionVec_4 = ($urandom_range(0,2)==0);
    io_req_0_bits_uop_exceptionVec_5 = ($urandom_range(0,2)==0);
    io_req_0_bits_uop_exceptionVec_13 = ($urandom_range(0,2)==0);
    io_req_0_bits_uop_exceptionVec_19 = ($urandom_range(0,2)==0);
    io_req_0_bits_uop_exceptionVec_21 = ($urandom_range(0,2)==0);
    io_req_0_bits_uop_uopIdx = $urandom_range(0,20);
    io_req_0_bits_uop_robIdx_flag = $urandom;
    io_req_0_bits_uop_robIdx_value = $urandom_range(0,40);
    io_req_0_bits_fullva = {$urandom,$urandom};
    io_req_0_bits_vaNeedExt = $urandom;
    io_req_0_bits_gpaddr = {$urandom,$urandom};
    io_req_0_bits_isHyper = $urandom;
    io_req_0_bits_isForVSnonLeafPTE = $urandom;
    io_req_1_valid = ($urandom_range(0,2)!=0);
    io_req_1_bits_uop_exceptionVec_3 = ($urandom_range(0,2)==0);
    io_req_1_bits_uop_exceptionVec_4 = ($urandom_range(0,2)==0);
    io_req_1_bits_uop_exceptionVec_5 = ($urandom_range(0,2)==0);
    io_req_1_bits_uop_exceptionVec_13 = ($urandom_range(0,2)==0);
    io_req_1_bits_uop_exceptionVec_19 = ($urandom_range(0,2)==0);
    io_req_1_bits_uop_exceptionVec_21 = ($urandom_range(0,2)==0);
    io_req_1_bits_uop_uopIdx = $urandom_range(0,20);
    io_req_1_bits_uop_robIdx_flag = $urandom;
    io_req_1_bits_uop_robIdx_value = $urandom_range(0,40);
    io_req_1_bits_fullva = {$urandom,$urandom};
    io_req_1_bits_vaNeedExt = $urandom;
    io_req_1_bits_gpaddr = {$urandom,$urandom};
    io_req_1_bits_isHyper = $urandom;
    io_req_1_bits_isForVSnonLeafPTE = $urandom;
    io_req_2_valid = ($urandom_range(0,2)!=0);
    io_req_2_bits_uop_exceptionVec_3 = ($urandom_range(0,2)==0);
    io_req_2_bits_uop_exceptionVec_4 = ($urandom_range(0,2)==0);
    io_req_2_bits_uop_exceptionVec_5 = ($urandom_range(0,2)==0);
    io_req_2_bits_uop_exceptionVec_13 = ($urandom_range(0,2)==0);
    io_req_2_bits_uop_exceptionVec_19 = ($urandom_range(0,2)==0);
    io_req_2_bits_uop_exceptionVec_21 = ($urandom_range(0,2)==0);
    io_req_2_bits_uop_uopIdx = $urandom_range(0,20);
    io_req_2_bits_uop_robIdx_flag = $urandom;
    io_req_2_bits_uop_robIdx_value = $urandom_range(0,40);
    io_req_2_bits_fullva = {$urandom,$urandom};
    io_req_2_bits_vaNeedExt = $urandom;
    io_req_2_bits_gpaddr = {$urandom,$urandom};
    io_req_2_bits_isHyper = $urandom;
    io_req_2_bits_isForVSnonLeafPTE = $urandom;
    io_req_3_valid = ($urandom_range(0,2)!=0);
    io_req_3_bits_uop_exceptionVec_3 = ($urandom_range(0,2)==0);
    io_req_3_bits_uop_exceptionVec_4 = ($urandom_range(0,2)==0);
    io_req_3_bits_uop_exceptionVec_5 = ($urandom_range(0,2)==0);
    io_req_3_bits_uop_exceptionVec_13 = ($urandom_range(0,2)==0);
    io_req_3_bits_uop_exceptionVec_19 = ($urandom_range(0,2)==0);
    io_req_3_bits_uop_exceptionVec_21 = ($urandom_range(0,2)==0);
    io_req_3_bits_uop_uopIdx = $urandom_range(0,20);
    io_req_3_bits_uop_robIdx_flag = $urandom;
    io_req_3_bits_uop_robIdx_value = $urandom_range(0,40);
    io_req_3_bits_fullva = {$urandom,$urandom};
    io_req_3_bits_vaNeedExt = $urandom;
    io_req_3_bits_gpaddr = {$urandom,$urandom};
    io_req_4_valid = ($urandom_range(0,2)!=0);
    io_req_4_bits_uop_exceptionVec_3 = ($urandom_range(0,2)==0);
    io_req_4_bits_uop_exceptionVec_4 = ($urandom_range(0,2)==0);
    io_req_4_bits_uop_exceptionVec_5 = ($urandom_range(0,2)==0);
    io_req_4_bits_uop_exceptionVec_13 = ($urandom_range(0,2)==0);
    io_req_4_bits_uop_exceptionVec_19 = ($urandom_range(0,2)==0);
    io_req_4_bits_uop_exceptionVec_21 = ($urandom_range(0,2)==0);
    io_req_4_bits_uop_uopIdx = $urandom_range(0,20);
    io_req_4_bits_uop_robIdx_flag = $urandom;
    io_req_4_bits_uop_robIdx_value = $urandom_range(0,40);
    io_req_4_bits_fullva = {$urandom,$urandom};
    io_req_4_bits_vaNeedExt = $urandom;
    io_req_4_bits_gpaddr = {$urandom,$urandom};
    io_req_5_valid = ($urandom_range(0,2)!=0);
    io_req_5_bits_uop_exceptionVec_3 = ($urandom_range(0,2)==0);
    io_req_5_bits_uop_exceptionVec_4 = ($urandom_range(0,2)==0);
    io_req_5_bits_uop_exceptionVec_5 = ($urandom_range(0,2)==0);
    io_req_5_bits_uop_exceptionVec_13 = ($urandom_range(0,2)==0);
    io_req_5_bits_uop_exceptionVec_19 = ($urandom_range(0,2)==0);
    io_req_5_bits_uop_exceptionVec_21 = ($urandom_range(0,2)==0);
    io_req_5_bits_uop_uopIdx = $urandom_range(0,20);
    io_req_5_bits_uop_robIdx_flag = $urandom;
    io_req_5_bits_uop_robIdx_value = $urandom_range(0,40);
    io_req_5_bits_fullva = {$urandom,$urandom};
    io_req_5_bits_gpaddr = {$urandom,$urandom};
    io_req_5_bits_isHyper = $urandom;
    io_req_5_bits_isForVSnonLeafPTE = $urandom;
  endtask
