...
module tb;
  ...
  always @(negedge clk) begin
    if (rst) begin
      ...
      io_ftqInter_fromFtq_topdown_redirect_valid <= 1'($urandom);
      ...
      io_icacheInter_resp_bits_vaddr_0 <= 50'({$urandom(), $urandom()});
      io_icacheInter_resp_bits_vaddr_1 <= 50'({$urandom(), $urandom()});
      ...
      io_rob_commits_0_valid <= 1'($urandom);
      ...
      io_rob_commits_1_valid <= 1'($urandom);
      ...
      io_rob_commits_2_valid <= 1'($urandom);
      ...
      io_rob_commits_3_valid <= 1'($urandom);
      ...
      io_rob_commits_4_valid <= 1'($urandom);
      ...
      io_rob_commits_5_valid <= 1'($urandom);
      ...
      io_rob_commits_6_valid <= 1'($urandom);
      ...
      io_rob_commits_7_valid <= 1'($urandom);
      ...
      io_mmioCommitRead_mmioLastCommit <= ($urandom_range(0,3)!=0);
      io_csr_fsIsOff <= ($urandom_range(0,7)==0);
    end
  end
  always @(negedge clk) if (!rst) begin
    #4; checks++;
    if (g_io_ftqInter_fromFtq_req_ready !== i_io_ftqInter_fromFtq_req_ready) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_valid !== i_io_ftqInter_toFtq_pdWb_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_0 !== i_io_ftqInter_toFtq_pdWb_bits_pc_0) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_1 !== i_io_ftqInter_toFtq_pdWb_bits_pc_1) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_2 !== i_io_ftqInter_toFtq_pdWb_bits_pc_2) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_3 !== i_io_ftqInter_toFtq_pdWb_bits_pc_3) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_4 !== i_io_ftqInter_toFtq_pdWb_bits_pc_4) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_5 !== i_io_ftqInter_toFtq_pdWb_bits_pc_5) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_6 !== i_io_ftqInter_toFtq_pdWb_bits_pc_6) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_7 !== i_io_ftqInter_toFtq_pdWb_bits_pc_7) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_8 !== i_io_ftqInter_toFtq_pdWb_bits_pc_8) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_9 !== i_io_ftqInter_toFtq_pdWb_bits_pc_9) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_10 !== i_io_ftqInter_toFtq_pdWb_bits_pc_10) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_11 !== i_io_ftqInter_toFtq_pdWb_bits_pc_11) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_12 !== i_io_ftqInter_toFtq_pdWb_bits_pc_12) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_13 !== i_io_ftqInter_toFtq_pdWb_bits_pc_13) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_14 !== i_io_ftqInter_toFtq_pdWb_bits_pc_14) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pc_15 !== i_io_ftqInter_toFtq_pdWb_bits_pc_15) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_0_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_0_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_0_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_0_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_0_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_0_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_0_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_0_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_0_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_0_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_1_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_1_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_1_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_1_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_1_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_1_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_1_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_1_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_1_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_1_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_2_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_2_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_2_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_2_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_2_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_2_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_2_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_2_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_2_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_2_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_3_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_3_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_3_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_3_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_3_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_3_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_3_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_3_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_3_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_3_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_4_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_4_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_4_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_4_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_4_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_4_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_4_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_4_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_4_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_4_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_5_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_5_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_5_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_5_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_5_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_5_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_5_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_5_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_5_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_5_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_6_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_6_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_6_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_6_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_6_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_6_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_6_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_6_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_6_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_6_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_7_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_7_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_7_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_7_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_7_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_7_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_7_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_7_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_7_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_7_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_8_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_8_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_8_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_8_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_8_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_8_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_8_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_8_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_8_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_8_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_9_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_9_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_9_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_9_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_9_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_9_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_9_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_9_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_9_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_9_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_10_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_10_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_10_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_10_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_10_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_10_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_10_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_10_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_10_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_10_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_11_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_11_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_11_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_11_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_11_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_11_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_11_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_11_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_11_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_11_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_12_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_12_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_12_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_12_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_12_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_12_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_12_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_12_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_12_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_12_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_13_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_13_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_13_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_13_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_13_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_13_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_13_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_13_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_13_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_13_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_14_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_14_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_14_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_14_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_14_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_14_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_14_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_14_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_14_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_14_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_15_valid !== i_io_ftqInter_toFtq_pdWb_bits_pd_15_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_15_isRVC !== i_io_ftqInter_toFtq_pdWb_bits_pd_15_isRVC) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_15_brType !== i_io_ftqInter_toFtq_pdWb_bits_pd_15_brType) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_15_isCall !== i_io_ftqInter_toFtq_pdWb_bits_pd_15_isCall) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_pd_15_isRet !== i_io_ftqInter_toFtq_pdWb_bits_pd_15_isRet) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_ftqIdx_flag !== i_io_ftqInter_toFtq_pdWb_bits_ftqIdx_flag) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_ftqIdx_value !== i_io_ftqInter_toFtq_pdWb_bits_ftqIdx_value) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_misOffset_valid !== i_io_ftqInter_toFtq_pdWb_bits_misOffset_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_misOffset_bits !== i_io_ftqInter_toFtq_pdWb_bits_misOffset_bits) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_cfiOffset_valid !== i_io_ftqInter_toFtq_pdWb_bits_cfiOffset_valid) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_target !== i_io_ftqInter_toFtq_pdWb_bits_target) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_jalTarget !== i_io_ftqInter_toFtq_pdWb_bits_jalTarget) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_0 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_0) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_1 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_1) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_2 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_2) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_3 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_3) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_4 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_4) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_5 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_5) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_6 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_6) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_7 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_7) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_8 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_8) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_9 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_9) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_10 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_10) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_11 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_11) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_12 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_12) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_13 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_13) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_14 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_14) begin errors++;
    ...
    if (g_io_ftqInter_toFtq_pdWb_bits_instrRange_15 !== i_io_ftqInter_toFtq_pdWb_bits_instrRange_15) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_1 !== i_io_toIbuffer_bits_instrs_1) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_2 !== i_io_toIbuffer_bits_instrs_2) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_3 !== i_io_toIbuffer_bits_instrs_3) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_4 !== i_io_toIbuffer_bits_instrs_4) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_5 !== i_io_toIbuffer_bits_instrs_5) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_6 !== i_io_toIbuffer_bits_instrs_6) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_7 !== i_io_toIbuffer_bits_instrs_7) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_8 !== i_io_toIbuffer_bits_instrs_8) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_9 !== i_io_toIbuffer_bits_instrs_9) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_10 !== i_io_toIbuffer_bits_instrs_10) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_11 !== i_io_toIbuffer_bits_instrs_11) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_12 !== i_io_toIbuffer_bits_instrs_12) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_13 !== i_io_toIbuffer_bits_instrs_13) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_14 !== i_io_toIbuffer_bits_instrs_14) begin errors++;
    ...
    if (g_io_toIbuffer_bits_instrs_15 !== i_io_toIbuffer_bits_instrs_15) begin errors++;
    ...
    if (g_io_toIbuffer_bits_valid !== i_io_toIbuffer_bits_valid) begin errors++;
      if(errors<=60) $display("[%0t] io_toIbuffer_bits_valid g=%h i=%h", $time, g_io_toIbuffer_bits_valid, i_io_toIbuffer_bits_valid); end
    if (g_io_toIbuffer_bits_enqEnable !== i_io_toIbuffer_bits_enqEnable) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_0_isRVC !== i_io_toIbuffer_bits_pd_0_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_0_brType !== i_io_toIbuffer_bits_pd_0_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_1_isRVC !== i_io_toIbuffer_bits_pd_1_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_1_brType !== i_io_toIbuffer_bits_pd_1_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_2_isRVC !== i_io_toIbuffer_bits_pd_2_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_2_brType !== i_io_toIbuffer_bits_pd_2_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_3_isRVC !== i_io_toIbuffer_bits_pd_3_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_3_brType !== i_io_toIbuffer_bits_pd_3_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_4_isRVC !== i_io_toIbuffer_bits_pd_4_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_4_brType !== i_io_toIbuffer_bits_pd_4_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_5_isRVC !== i_io_toIbuffer_bits_pd_5_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_5_brType !== i_io_toIbuffer_bits_pd_5_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_6_isRVC !== i_io_toIbuffer_bits_pd_6_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_6_brType !== i_io_toIbuffer_bits_pd_6_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_7_isRVC !== i_io_toIbuffer_bits_pd_7_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_7_brType !== i_io_toIbuffer_bits_pd_7_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_8_isRVC !== i_io_toIbuffer_bits_pd_8_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_8_brType !== i_io_toIbuffer_bits_pd_8_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_9_isRVC !== i_io_toIbuffer_bits_pd_9_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_9_brType !== i_io_toIbuffer_bits_pd_9_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_10_isRVC !== i_io_toIbuffer_bits_pd_10_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_10_brType !== i_io_toIbuffer_bits_pd_10_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_11_isRVC !== i_io_toIbuffer_bits_pd_11_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_11_brType !== i_io_toIbuffer_bits_pd_11_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_12_isRVC !== i_io_toIbuffer_bits_pd_12_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_12_brType !== i_io_toIbuffer_bits_pd_12_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_13_isRVC !== i_io_toIbuffer_bits_pd_13_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_13_brType !== i_io_toIbuffer_bits_pd_13_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_14_isRVC !== i_io_toIbuffer_bits_pd_14_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_14_brType !== i_io_toIbuffer_bits_pd_14_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_15_isRVC !== i_io_toIbuffer_bits_pd_15_isRVC) begin errors++;
    ...
    if (g_io_toIbuffer_bits_pd_15_brType !== i_io_toIbuffer_bits_pd_15_brType) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_0 !== i_io_toIbuffer_bits_foldpc_0) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_1 !== i_io_toIbuffer_bits_foldpc_1) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_2 !== i_io_toIbuffer_bits_foldpc_2) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_3 !== i_io_toIbuffer_bits_foldpc_3) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_4 !== i_io_toIbuffer_bits_foldpc_4) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_5 !== i_io_toIbuffer_bits_foldpc_5) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_6 !== i_io_toIbuffer_bits_foldpc_6) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_7 !== i_io_toIbuffer_bits_foldpc_7) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_8 !== i_io_toIbuffer_bits_foldpc_8) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_9 !== i_io_toIbuffer_bits_foldpc_9) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_10 !== i_io_toIbuffer_bits_foldpc_10) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_11 !== i_io_toIbuffer_bits_foldpc_11) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_12 !== i_io_toIbuffer_bits_foldpc_12) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_13 !== i_io_toIbuffer_bits_foldpc_13) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_14 !== i_io_toIbuffer_bits_foldpc_14) begin errors++;
    ...
    if (g_io_toIbuffer_bits_foldpc_15 !== i_io_toIbuffer_bits_foldpc_15) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_0_valid !== i_io_toIbuffer_bits_ftqOffset_0_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_1_valid !== i_io_toIbuffer_bits_ftqOffset_1_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_2_valid !== i_io_toIbuffer_bits_ftqOffset_2_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_3_valid !== i_io_toIbuffer_bits_ftqOffset_3_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_4_valid !== i_io_toIbuffer_bits_ftqOffset_4_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_5_valid !== i_io_toIbuffer_bits_ftqOffset_5_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_6_valid !== i_io_toIbuffer_bits_ftqOffset_6_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_7_valid !== i_io_toIbuffer_bits_ftqOffset_7_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_8_valid !== i_io_toIbuffer_bits_ftqOffset_8_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_9_valid !== i_io_toIbuffer_bits_ftqOffset_9_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_10_valid !== i_io_toIbuffer_bits_ftqOffset_10_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_11_valid !== i_io_toIbuffer_bits_ftqOffset_11_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_12_valid !== i_io_toIbuffer_bits_ftqOffset_12_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_13_valid !== i_io_toIbuffer_bits_ftqOffset_13_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_14_valid !== i_io_toIbuffer_bits_ftqOffset_14_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqOffset_15_valid !== i_io_toIbuffer_bits_ftqOffset_15_valid) begin errors++;
    ...
    if (g_io_toIbuffer_bits_backendException_0 !== i_io_toIbuffer_bits_backendException_0) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_0 !== i_io_toIbuffer_bits_exceptionType_0) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_1 !== i_io_toIbuffer_bits_exceptionType_1) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_2 !== i_io_toIbuffer_bits_exceptionType_2) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_3 !== i_io_toIbuffer_bits_exceptionType_3) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_4 !== i_io_toIbuffer_bits_exceptionType_4) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_5 !== i_io_toIbuffer_bits_exceptionType_5) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_6 !== i_io_toIbuffer_bits_exceptionType_6) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_7 !== i_io_toIbuffer_bits_exceptionType_7) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_8 !== i_io_toIbuffer_bits_exceptionType_8) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_9 !== i_io_toIbuffer_bits_exceptionType_9) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_10 !== i_io_toIbuffer_bits_exceptionType_10) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_11 !== i_io_toIbuffer_bits_exceptionType_11) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_12 !== i_io_toIbuffer_bits_exceptionType_12) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_13 !== i_io_toIbuffer_bits_exceptionType_13) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_14 !== i_io_toIbuffer_bits_exceptionType_14) begin errors++;
    ...
    if (g_io_toIbuffer_bits_exceptionType_15 !== i_io_toIbuffer_bits_exceptionType_15) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_0 !== i_io_toIbuffer_bits_crossPageIPFFix_0) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_1 !== i_io_toIbuffer_bits_crossPageIPFFix_1) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_2 !== i_io_toIbuffer_bits_crossPageIPFFix_2) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_3 !== i_io_toIbuffer_bits_crossPageIPFFix_3) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_4 !== i_io_toIbuffer_bits_crossPageIPFFix_4) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_5 !== i_io_toIbuffer_bits_crossPageIPFFix_5) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_6 !== i_io_toIbuffer_bits_crossPageIPFFix_6) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_7 !== i_io_toIbuffer_bits_crossPageIPFFix_7) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_8 !== i_io_toIbuffer_bits_crossPageIPFFix_8) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_9 !== i_io_toIbuffer_bits_crossPageIPFFix_9) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_10 !== i_io_toIbuffer_bits_crossPageIPFFix_10) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_11 !== i_io_toIbuffer_bits_crossPageIPFFix_11) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_12 !== i_io_toIbuffer_bits_crossPageIPFFix_12) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_13 !== i_io_toIbuffer_bits_crossPageIPFFix_13) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_14 !== i_io_toIbuffer_bits_crossPageIPFFix_14) begin errors++;
    ...
    if (g_io_toIbuffer_bits_crossPageIPFFix_15 !== i_io_toIbuffer_bits_crossPageIPFFix_15) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_0 !== i_io_toIbuffer_bits_illegalInstr_0) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_1 !== i_io_toIbuffer_bits_illegalInstr_1) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_2 !== i_io_toIbuffer_bits_illegalInstr_2) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_3 !== i_io_toIbuffer_bits_illegalInstr_3) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_4 !== i_io_toIbuffer_bits_illegalInstr_4) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_5 !== i_io_toIbuffer_bits_illegalInstr_5) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_6 !== i_io_toIbuffer_bits_illegalInstr_6) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_7 !== i_io_toIbuffer_bits_illegalInstr_7) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_8 !== i_io_toIbuffer_bits_illegalInstr_8) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_9 !== i_io_toIbuffer_bits_illegalInstr_9) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_10 !== i_io_toIbuffer_bits_illegalInstr_10) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_11 !== i_io_toIbuffer_bits_illegalInstr_11) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_12 !== i_io_toIbuffer_bits_illegalInstr_12) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_13 !== i_io_toIbuffer_bits_illegalInstr_13) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_14 !== i_io_toIbuffer_bits_illegalInstr_14) begin errors++;
    ...
    if (g_io_toIbuffer_bits_illegalInstr_15 !== i_io_toIbuffer_bits_illegalInstr_15) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_0 !== i_io_toIbuffer_bits_triggered_0) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_1 !== i_io_toIbuffer_bits_triggered_1) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_2 !== i_io_toIbuffer_bits_triggered_2) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_3 !== i_io_toIbuffer_bits_triggered_3) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_4 !== i_io_toIbuffer_bits_triggered_4) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_5 !== i_io_toIbuffer_bits_triggered_5) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_6 !== i_io_toIbuffer_bits_triggered_6) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_7 !== i_io_toIbuffer_bits_triggered_7) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_8 !== i_io_toIbuffer_bits_triggered_8) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_9 !== i_io_toIbuffer_bits_triggered_9) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_10 !== i_io_toIbuffer_bits_triggered_10) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_11 !== i_io_toIbuffer_bits_triggered_11) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_12 !== i_io_toIbuffer_bits_triggered_12) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_13 !== i_io_toIbuffer_bits_triggered_13) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_14 !== i_io_toIbuffer_bits_triggered_14) begin errors++;
    ...
    if (g_io_toIbuffer_bits_triggered_15 !== i_io_toIbuffer_bits_triggered_15) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_0 !== i_io_toIbuffer_bits_isLastInFtqEntry_0) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_1 !== i_io_toIbuffer_bits_isLastInFtqEntry_1) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_2 !== i_io_toIbuffer_bits_isLastInFtqEntry_2) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_3 !== i_io_toIbuffer_bits_isLastInFtqEntry_3) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_4 !== i_io_toIbuffer_bits_isLastInFtqEntry_4) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_5 !== i_io_toIbuffer_bits_isLastInFtqEntry_5) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_6 !== i_io_toIbuffer_bits_isLastInFtqEntry_6) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_7 !== i_io_toIbuffer_bits_isLastInFtqEntry_7) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_8 !== i_io_toIbuffer_bits_isLastInFtqEntry_8) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_9 !== i_io_toIbuffer_bits_isLastInFtqEntry_9) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_10 !== i_io_toIbuffer_bits_isLastInFtqEntry_10) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_11 !== i_io_toIbuffer_bits_isLastInFtqEntry_11) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_12 !== i_io_toIbuffer_bits_isLastInFtqEntry_12) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_13 !== i_io_toIbuffer_bits_isLastInFtqEntry_13) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_14 !== i_io_toIbuffer_bits_isLastInFtqEntry_14) begin errors++;
    ...
    if (g_io_toIbuffer_bits_isLastInFtqEntry_15 !== i_io_toIbuffer_bits_isLastInFtqEntry_15) begin errors++;
    ...
    if (g_io_toIbuffer_bits_ftqPtr_value !== i_io_toIbuffer_bits_ftqPtr_value) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_0 !== i_io_toIbuffer_bits_topdown_info_reasons_0) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_1 !== i_io_toIbuffer_bits_topdown_info_reasons_1) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_2 !== i_io_toIbuffer_bits_topdown_info_reasons_2) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_3 !== i_io_toIbuffer_bits_topdown_info_reasons_3) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_4 !== i_io_toIbuffer_bits_topdown_info_reasons_4) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_5 !== i_io_toIbuffer_bits_topdown_info_reasons_5) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_6 !== i_io_toIbuffer_bits_topdown_info_reasons_6) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_7 !== i_io_toIbuffer_bits_topdown_info_reasons_7) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_8 !== i_io_toIbuffer_bits_topdown_info_reasons_8) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_9 !== i_io_toIbuffer_bits_topdown_info_reasons_9) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_10 !== i_io_toIbuffer_bits_topdown_info_reasons_10) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_11 !== i_io_toIbuffer_bits_topdown_info_reasons_11) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_12 !== i_io_toIbuffer_bits_topdown_info_reasons_12) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_13 !== i_io_toIbuffer_bits_topdown_info_reasons_13) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_14 !== i_io_toIbuffer_bits_topdown_info_reasons_14) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_15 !== i_io_toIbuffer_bits_topdown_info_reasons_15) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_16 !== i_io_toIbuffer_bits_topdown_info_reasons_16) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_17 !== i_io_toIbuffer_bits_topdown_info_reasons_17) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_18 !== i_io_toIbuffer_bits_topdown_info_reasons_18) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_19 !== i_io_toIbuffer_bits_topdown_info_reasons_19) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_20 !== i_io_toIbuffer_bits_topdown_info_reasons_20) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_21 !== i_io_toIbuffer_bits_topdown_info_reasons_21) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_22 !== i_io_toIbuffer_bits_topdown_info_reasons_22) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_23 !== i_io_toIbuffer_bits_topdown_info_reasons_23) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_24 !== i_io_toIbuffer_bits_topdown_info_reasons_24) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_25 !== i_io_toIbuffer_bits_topdown_info_reasons_25) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_26 !== i_io_toIbuffer_bits_topdown_info_reasons_26) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_27 !== i_io_toIbuffer_bits_topdown_info_reasons_27) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_28 !== i_io_toIbuffer_bits_topdown_info_reasons_28) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_29 !== i_io_toIbuffer_bits_topdown_info_reasons_29) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_30 !== i_io_toIbuffer_bits_topdown_info_reasons_30) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_31 !== i_io_toIbuffer_bits_topdown_info_reasons_31) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_32 !== i_io_toIbuffer_bits_topdown_info_reasons_32) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_33 !== i_io_toIbuffer_bits_topdown_info_reasons_33) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_34 !== i_io_toIbuffer_bits_topdown_info_reasons_34) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_35 !== i_io_toIbuffer_bits_topdown_info_reasons_35) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_36 !== i_io_toIbuffer_bits_topdown_info_reasons_36) begin errors++;
    ...
    if (g_io_toIbuffer_bits_topdown_info_reasons_37 !== i_io_toIbuffer_bits_topdown_info_reasons_37) begin errors++;
    ...
    if (g_io_toBackend_gpaddrMem_wen !== i_io_toBackend_gpaddrMem_wen) begin errors++;
    ...
    if (g_io_toBackend_gpaddrMem_waddr !== i_io_toBackend_gpaddrMem_waddr) begin errors++;
    ...
    if (g_io_toBackend_gpaddrMem_wdata_gpaddr !== i_io_toBackend_gpaddrMem_wdata_gpaddr) begin errors++;
    ...
    if (g_io_toBackend_gpaddrMem_wdata_isForVSnonLeafPTE !== i_io_toBackend_gpaddrMem_wdata_isForVSnonLeafPTE) begin errors++;
    ...
    if (g_io_uncacheInter_toUncache_valid !== i_io_uncacheInter_toUncache_valid) begin errors++;
    ...
    if (g_io_uncacheInter_toUncache_bits_addr !== i_io_uncacheInter_toUncache_bits_addr) begin errors++;
    ...
    if (g_io_iTLBInter_req_valid !== i_io_iTLBInter_req_valid) begin errors++;
      if(errors<=60) $display("[%0t] io_iTLBInter_req_valid g=%h i=%h", $time, g_io_iTLBInter_req_valid, i_io_iTLBInter_req_valid); end
    if (g_io_iTLBInter_req_bits_vaddr !== i_io_iTLBInter_req_bits_vaddr) begin errors++;
    ...
    if (g_io_mmioCommitRead_mmioFtqPtr_value !== i_io_mmioCommitRead_mmioFtqPtr_value) begin errors++;
