...
`include "probe_block.svh"
  ...
  initial begin
    ...
    $display("probe_checks=%0d probe_mismatch=%0d", probe_checks, probe_mismatch);
    if (errors == 0 && probe_mismatch == 0 && checks > 1000) $display("TEST PASSED"); else $display("TEST FAILED");
    $finish;
  end
endmodule
