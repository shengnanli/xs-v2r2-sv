// 自动生成:scripts/gen_iq_abjivvi.py —— 勿手改 (顶层连线) 
  // 顶层端口与可读核完全同名, 纯穿透例化。
  xs_IssueQueueAluBrhJmpI2fVsetriwiVsetriwvfI2v_core u_core (
    ...
    .io_wbBusyTableWrite_1_fpWbBusyTable(io_wbBusyTableWrite_1_fpWbBusyTable),
    ...
    .io_deqDelay_1_bits_common_fpWen(io_deqDelay_1_bits_common_fpWen),
    .io_deqDelay_1_bits_common_vecWen(io_deqDelay_1_bits_common_vecWen),
    .io_deqDelay_1_bits_common_v0Wen(io_deqDelay_1_bits_common_v0Wen),
    .io_deqDelay_1_bits_common_vlWen(io_deqDelay_1_bits_common_vlWen),
    .io_deqDelay_1_bits_common_fpu_typeTagOut(io_deqDelay_1_bits_common_fpu_typeTagOut),
    .io_deqDelay_1_bits_common_fpu_wflags(io_deqDelay_1_bits_common_fpu_wflags),
    .io_deqDelay_1_bits_common_fpu_typ(io_deqDelay_1_bits_common_fpu_typ),
    .io_deqDelay_1_bits_common_fpu_rm(io_deqDelay_1_bits_common_fpu_rm),
