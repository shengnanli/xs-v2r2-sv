// medeleg UT variant (_xs): instantiate the readable bespoke core xs_medeleg.
module MedelegModule_xs(
  ...
  output regOut_EX_HSCALL, output regOut_EX_VSCALL, output regOut_EX_IPF,
  output regOut_EX_LPF, output regOut_EX_SPF, output regOut_EX_SWC,
  output regOut_EX_HWE, output regOut_EX_IGPF, output regOut_EX_LGPF,
  output regOut_EX_VI, output regOut_EX_SGPF
);
  xs_medeleg u_core (
