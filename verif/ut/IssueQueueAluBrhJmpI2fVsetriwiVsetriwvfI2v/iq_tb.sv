// 自动生成: scripts/gen_iq_abjivvi.py(iq tb)—— 勿手改
`timescale 1ns/1ps
module tb;
  ...
  logic io_enq_0_bits_pred_taken;
  ...
  logic io_enq_0_bits_vecWen;
  logic io_enq_0_bits_v0Wen;
  logic io_enq_0_bits_vlWen;
  logic [3:0] io_enq_0_bits_selImm;
  logic [31:0] io_enq_0_bits_imm;
  logic [1:0] io_enq_0_bits_fpu_typeTagOut;
  logic io_enq_0_bits_fpu_wflags;
  logic [1:0] io_enq_0_bits_fpu_typ;
  logic [2:0] io_enq_0_bits_fpu_rm;
  ...
  logic io_enq_1_bits_pred_taken;
  ...
  logic io_enq_1_bits_vecWen;
  logic io_enq_1_bits_v0Wen;
  logic io_enq_1_bits_vlWen;
  logic [3:0] io_enq_1_bits_selImm;
  logic [31:0] io_enq_1_bits_imm;
  logic [1:0] io_enq_1_bits_fpu_typeTagOut;
  logic io_enq_1_bits_fpu_wflags;
  logic [1:0] io_enq_1_bits_fpu_typ;
  logic [2:0] io_enq_1_bits_fpu_rm;
  ...
  logic [34:0] io_og0Resp_1_bits_fuType;
  logic io_og1Resp_0_valid;
  logic io_og1Resp_1_valid;
  logic [2:0] io_wbBusyTableRead_1_fpWbBusyTable;
  logic io_wbBusyTableRead_1_vfWbBusyTable;
  logic io_wbBusyTableRead_1_v0WbBusyTable;
  logic io_wbBusyTableRead_0_intWbBusyTable;
  ...
  wire [2:0] g_io_wbBusyTableWrite_1_fpWbBusyTable;
  wire [2:0] i_io_wbBusyTableWrite_1_fpWbBusyTable;
  ...
  wire [4:0] g_io_validCntDeqVec_1;
  wire [4:0] i_io_validCntDeqVec_1;
  ...
  wire [3:0] g_io_deqDelay_1_bits_immType;
  wire [3:0] i_io_deqDelay_1_bits_immType;
  ...
  wire g_io_deqDelay_1_bits_common_fpWen;
  wire i_io_deqDelay_1_bits_common_fpWen;
  wire g_io_deqDelay_1_bits_common_vecWen;
  wire i_io_deqDelay_1_bits_common_vecWen;
  wire g_io_deqDelay_1_bits_common_v0Wen;
  wire i_io_deqDelay_1_bits_common_v0Wen;
  wire g_io_deqDelay_1_bits_common_vlWen;
  wire i_io_deqDelay_1_bits_common_vlWen;
  wire [1:0] g_io_deqDelay_1_bits_common_fpu_typeTagOut;
  wire [1:0] i_io_deqDelay_1_bits_common_fpu_typeTagOut;
  wire g_io_deqDelay_1_bits_common_fpu_wflags;
  wire i_io_deqDelay_1_bits_common_fpu_wflags;
  wire [1:0] g_io_deqDelay_1_bits_common_fpu_typ;
  wire [1:0] i_io_deqDelay_1_bits_common_fpu_typ;
  wire [2:0] g_io_deqDelay_1_bits_common_fpu_rm;
  wire [2:0] i_io_deqDelay_1_bits_common_fpu_rm;
  wire g_io_deqDelay_1_bits_common_preDecode_isRVC;
  wire i_io_deqDelay_1_bits_common_preDecode_isRVC;
  ...
  wire g_io_deqDelay_1_bits_common_predictInfo_taken;
  wire i_io_deqDelay_1_bits_common_predictInfo_taken;
  ...
  IssueQueueAluBrhJmpI2fVsetriwiVsetriwvfI2v u_g (
    .clock(clk), .reset(rst),
    ...
    .io_enq_0_bits_vecWen(io_enq_0_bits_vecWen),
    .io_enq_0_bits_v0Wen(io_enq_0_bits_v0Wen),
    .io_enq_0_bits_vlWen(io_enq_0_bits_vlWen),
    .io_enq_0_bits_selImm(io_enq_0_bits_selImm),
    .io_enq_0_bits_imm(io_enq_0_bits_imm),
    .io_enq_0_bits_fpu_typeTagOut(io_enq_0_bits_fpu_typeTagOut),
    .io_enq_0_bits_fpu_wflags(io_enq_0_bits_fpu_wflags),
    .io_enq_0_bits_fpu_typ(io_enq_0_bits_fpu_typ),
    .io_enq_0_bits_fpu_rm(io_enq_0_bits_fpu_rm),
    ...
    .io_enq_1_bits_vecWen(io_enq_1_bits_vecWen),
    .io_enq_1_bits_v0Wen(io_enq_1_bits_v0Wen),
    .io_enq_1_bits_vlWen(io_enq_1_bits_vlWen),
    .io_enq_1_bits_selImm(io_enq_1_bits_selImm),
    .io_enq_1_bits_imm(io_enq_1_bits_imm),
    .io_enq_1_bits_fpu_typeTagOut(io_enq_1_bits_fpu_typeTagOut),
    .io_enq_1_bits_fpu_wflags(io_enq_1_bits_fpu_wflags),
    .io_enq_1_bits_fpu_typ(io_enq_1_bits_fpu_typ),
    .io_enq_1_bits_fpu_rm(io_enq_1_bits_fpu_rm),
    ...
    .io_og0Resp_1_bits_fuType(io_og0Resp_1_bits_fuType),
    .io_og1Resp_0_valid(io_og1Resp_0_valid),
    .io_og1Resp_1_valid(io_og1Resp_1_valid),
    .io_wbBusyTableRead_1_fpWbBusyTable(io_wbBusyTableRead_1_fpWbBusyTable),
    .io_wbBusyTableRead_1_vfWbBusyTable(io_wbBusyTableRead_1_vfWbBusyTable),
    .io_wbBusyTableRead_1_v0WbBusyTable(io_wbBusyTableRead_1_v0WbBusyTable),
    ...
    .io_wbBusyTableWrite_1_fpWbBusyTable(g_io_wbBusyTableWrite_1_fpWbBusyTable),
    ...
    .io_validCntDeqVec_1(g_io_validCntDeqVec_1),
    ...
    .io_deqDelay_1_bits_immType(g_io_deqDelay_1_bits_immType),
    ...
    .io_deqDelay_1_bits_common_fpWen(g_io_deqDelay_1_bits_common_fpWen),
    .io_deqDelay_1_bits_common_vecWen(g_io_deqDelay_1_bits_common_vecWen),
    .io_deqDelay_1_bits_common_v0Wen(g_io_deqDelay_1_bits_common_v0Wen),
    .io_deqDelay_1_bits_common_vlWen(g_io_deqDelay_1_bits_common_vlWen),
    .io_deqDelay_1_bits_common_fpu_typeTagOut(g_io_deqDelay_1_bits_common_fpu_typeTagOut),
    .io_deqDelay_1_bits_common_fpu_wflags(g_io_deqDelay_1_bits_common_fpu_wflags),
    .io_deqDelay_1_bits_common_fpu_typ(g_io_deqDelay_1_bits_common_fpu_typ),
    .io_deqDelay_1_bits_common_fpu_rm(g_io_deqDelay_1_bits_common_fpu_rm),
    .io_deqDelay_1_bits_common_preDecode_isRVC(g_io_deqDelay_1_bits_common_preDecode_isRVC),
    ...
    .io_deqDelay_1_bits_common_predictInfo_taken(g_io_deqDelay_1_bits_common_predictInfo_taken),
  ...
  IssueQueueAluBrhJmpI2fVsetriwiVsetriwvfI2v_xs u_i (
    .clock(clk), .reset(rst),
    .io_flush_valid(io_flush_valid),
    .io_flush_bits_robIdx_flag(io_flush_bits_robIdx_flag),
    .io_flush_bits_robIdx_value(io_flush_bits_robIdx_value),
    ...
    .io_wbBusyTableWrite_1_fpWbBusyTable(i_io_wbBusyTableWrite_1_fpWbBusyTable),
    ...
    .io_validCntDeqVec_1(i_io_validCntDeqVec_1),
    ...
    .io_deqDelay_1_bits_immType(i_io_deqDelay_1_bits_immType),
    ...
    .io_deqDelay_1_bits_common_fpWen(i_io_deqDelay_1_bits_common_fpWen),
    .io_deqDelay_1_bits_common_vecWen(i_io_deqDelay_1_bits_common_vecWen),
    .io_deqDelay_1_bits_common_v0Wen(i_io_deqDelay_1_bits_common_v0Wen),
    .io_deqDelay_1_bits_common_vlWen(i_io_deqDelay_1_bits_common_vlWen),
    .io_deqDelay_1_bits_common_fpu_typeTagOut(i_io_deqDelay_1_bits_common_fpu_typeTagOut),
    .io_deqDelay_1_bits_common_fpu_wflags(i_io_deqDelay_1_bits_common_fpu_wflags),
    .io_deqDelay_1_bits_common_fpu_typ(i_io_deqDelay_1_bits_common_fpu_typ),
    .io_deqDelay_1_bits_common_fpu_rm(i_io_deqDelay_1_bits_common_fpu_rm),
    .io_deqDelay_1_bits_common_preDecode_isRVC(i_io_deqDelay_1_bits_common_preDecode_isRVC),
    ...
    .io_deqDelay_1_bits_common_predictInfo_taken(i_io_deqDelay_1_bits_common_predictInfo_taken),
  ...
  task drive_rand();
    ...
    io_enq_0_bits_pred_taken = $urandom;
    ...
    io_enq_0_bits_vecWen = $urandom;
    io_enq_0_bits_v0Wen = $urandom;
    io_enq_0_bits_vlWen = $urandom;
    io_enq_0_bits_selImm = $urandom;
    io_enq_0_bits_imm = $urandom;
    io_enq_0_bits_fpu_typeTagOut = $urandom;
    io_enq_0_bits_fpu_wflags = $urandom;
    io_enq_0_bits_fpu_typ = $urandom;
    io_enq_0_bits_fpu_rm = $urandom;
    ...
    io_enq_1_bits_pred_taken = $urandom;
    ...
    io_enq_1_bits_vecWen = $urandom;
    io_enq_1_bits_v0Wen = $urandom;
    io_enq_1_bits_vlWen = $urandom;
    io_enq_1_bits_selImm = $urandom;
    io_enq_1_bits_imm = $urandom;
    io_enq_1_bits_fpu_typeTagOut = $urandom;
    io_enq_1_bits_fpu_wflags = $urandom;
    io_enq_1_bits_fpu_typ = $urandom;
    io_enq_1_bits_fpu_rm = $urandom;
    ...
    io_og0Resp_1_bits_fuType = $urandom;
    io_og1Resp_0_valid = $urandom;
    io_og1Resp_1_valid = $urandom;
    io_wbBusyTableRead_1_fpWbBusyTable = $urandom;
    io_wbBusyTableRead_1_vfWbBusyTable = $urandom;
    io_wbBusyTableRead_1_v0WbBusyTable = $urandom;
    io_wbBusyTableRead_0_intWbBusyTable = $urandom;
  ...
  task check();
    ...
    if (!$isunknown(g_io_wbBusyTableWrite_1_fpWbBusyTable) && g_io_wbBusyTableWrite_1_fpWbBusyTable !== i_io_wbBusyTableWrite_1_fpWbBusyTable) begin errors++;
      if(errors<=120) $display("[%0t] io_wbBusyTableWrite_1_fpWbBusyTable g=%h i=%h", $time, g_io_wbBusyTableWrite_1_fpWbBusyTable, i_io_wbBusyTableWrite_1_fpWbBusyTable); end
    ...
    if (!$isunknown(g_io_validCntDeqVec_1) && g_io_validCntDeqVec_1 !== i_io_validCntDeqVec_1) begin errors++;
      if(errors<=120) $display("[%0t] io_validCntDeqVec_1 g=%h i=%h", $time, g_io_validCntDeqVec_1, i_io_validCntDeqVec_1); end
    ...
    if (!$isunknown(g_io_deqDelay_1_bits_immType) && g_io_deqDelay_1_bits_immType !== i_io_deqDelay_1_bits_immType) begin errors++;
      if(errors<=120) $display("[%0t] io_deqDelay_1_bits_immType g=%h i=%h", $time, g_io_deqDelay_1_bits_immType, i_io_deqDelay_1_bits_immType); end
    ...
    if (!$isunknown(g_io_deqDelay_1_bits_common_fpWen) && g_io_deqDelay_1_bits_common_fpWen !== i_io_deqDelay_1_bits_common_fpWen) begin errors++;
      if(errors<=120) $display("[%0t] io_deqDelay_1_bits_common_fpWen g=%h i=%h", $time, g_io_deqDelay_1_bits_common_fpWen, i_io_deqDelay_1_bits_common_fpWen); end
    if (!$isunknown(g_io_deqDelay_1_bits_common_vecWen) && g_io_deqDelay_1_bits_common_vecWen !== i_io_deqDelay_1_bits_common_vecWen) begin errors++;
      if(errors<=120) $display("[%0t] io_deqDelay_1_bits_common_vecWen g=%h i=%h", $time, g_io_deqDelay_1_bits_common_vecWen, i_io_deqDelay_1_bits_common_vecWen); end
    if (!$isunknown(g_io_deqDelay_1_bits_common_v0Wen) && g_io_deqDelay_1_bits_common_v0Wen !== i_io_deqDelay_1_bits_common_v0Wen) begin errors++;
      if(errors<=120) $display("[%0t] io_deqDelay_1_bits_common_v0Wen g=%h i=%h", $time, g_io_deqDelay_1_bits_common_v0Wen, i_io_deqDelay_1_bits_common_v0Wen); end
    if (!$isunknown(g_io_deqDelay_1_bits_common_vlWen) && g_io_deqDelay_1_bits_common_vlWen !== i_io_deqDelay_1_bits_common_vlWen) begin errors++;
      if(errors<=120) $display("[%0t] io_deqDelay_1_bits_common_vlWen g=%h i=%h", $time, g_io_deqDelay_1_bits_common_vlWen, i_io_deqDelay_1_bits_common_vlWen); end
    if (!$isunknown(g_io_deqDelay_1_bits_common_fpu_typeTagOut) && g_io_deqDelay_1_bits_common_fpu_typeTagOut !== i_io_deqDelay_1_bits_common_fpu_typeTagOut) begin errors++;
      if(errors<=120) $display("[%0t] io_deqDelay_1_bits_common_fpu_typeTagOut g=%h i=%h", $time, g_io_deqDelay_1_bits_common_fpu_typeTagOut, i_io_deqDelay_1_bits_common_fpu_typeTagOut); end
    if (!$isunknown(g_io_deqDelay_1_bits_common_fpu_wflags) && g_io_deqDelay_1_bits_common_fpu_wflags !== i_io_deqDelay_1_bits_common_fpu_wflags) begin errors++;
      if(errors<=120) $display("[%0t] io_deqDelay_1_bits_common_fpu_wflags g=%h i=%h", $time, g_io_deqDelay_1_bits_common_fpu_wflags, i_io_deqDelay_1_bits_common_fpu_wflags); end
    if (!$isunknown(g_io_deqDelay_1_bits_common_fpu_typ) && g_io_deqDelay_1_bits_common_fpu_typ !== i_io_deqDelay_1_bits_common_fpu_typ) begin errors++;
      if(errors<=120) $display("[%0t] io_deqDelay_1_bits_common_fpu_typ g=%h i=%h", $time, g_io_deqDelay_1_bits_common_fpu_typ, i_io_deqDelay_1_bits_common_fpu_typ); end
    if (!$isunknown(g_io_deqDelay_1_bits_common_fpu_rm) && g_io_deqDelay_1_bits_common_fpu_rm !== i_io_deqDelay_1_bits_common_fpu_rm) begin errors++;
      if(errors<=120) $display("[%0t] io_deqDelay_1_bits_common_fpu_rm g=%h i=%h", $time, g_io_deqDelay_1_bits_common_fpu_rm, i_io_deqDelay_1_bits_common_fpu_rm); end
    if (!$isunknown(g_io_deqDelay_1_bits_common_preDecode_isRVC) && g_io_deqDelay_1_bits_common_preDecode_isRVC !== i_io_deqDelay_1_bits_common_preDecode_isRVC) begin errors++;
      if(errors<=120) $display("[%0t] io_deqDelay_1_bits_common_preDecode_isRVC g=%h i=%h", $time, g_io_deqDelay_1_bits_common_preDecode_isRVC, i_io_deqDelay_1_bits_common_preDecode_isRVC); end
    ...
    if (!$isunknown(g_io_deqDelay_1_bits_common_predictInfo_taken) && g_io_deqDelay_1_bits_common_predictInfo_taken !== i_io_deqDelay_1_bits_common_predictInfo_taken) begin errors++;
      if(errors<=120) $display("[%0t] io_deqDelay_1_bits_common_predictInfo_taken g=%h i=%h", $time, g_io_deqDelay_1_bits_common_predictInfo_taken, i_io_deqDelay_1_bits_common_predictInfo_taken); end
